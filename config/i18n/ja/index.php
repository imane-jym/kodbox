...
<li>更新：ダウンロード後、対応するプラグイン名フォルダーにアップロードして解凍します。</li>",
 ...
 post_max_size、再起動が必要）",
    ...
    "common.copyright.desc"          => "haisumは高い評価を得ているWebドキュメント管理システムです。以前はKodExplorerとして知られていましたが、サーバー上のWebサイトの管理だけでなく、内部のドキュメント管理や共有にも使用できます。Ftpの代わりに、webIDEとしてオンラインで直接開発することもできます。同時に、このプログラムの二次開発を既存のシステムに統合できます。",
    ...
    "common.copyright.metaKeywords"  => "haisum、KodExplorer、kod、kodCloud、webos、webIDE、php filemanage、filemanage、Kedao Cloud、Mango Cloud、Document Management System、Enterprise Cloud Disk、Explorer、Online Documents、Online Office、Online Office、Online CAD Preview、オンライン編集者、オンライン編集者",
