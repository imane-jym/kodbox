...
return array(
    ...
    "admin.menu.server"              => "सेवाएँ और उपकरण",
    ...
    "admin.server.base"              => "सेवा स्थिति",
    "admin.server.server"            => "सिस्टम सेवाएँ",
    "admin.server.file"              => "फ़ाइल सेवाएँ",
    "admin.server.net"               => "नेटवर्क और कनेक्टिविटी",
    ...
    "admin.setting.passwordRuleStrongDesc" => "लंबाई 6 से कम नहीं होनी चाहिए; इसमें संख्याएं और अंग्रेजी अक्षर होने चाहिए",
    "admin.setting.passwordRuleStrongMoreDesc" => "इसकी लंबाई कम से कम 8 अक्षर होनी चाहिए; इसमें कम से कम 3 प्रकार के संख्याओं, बड़े अक्षरों, छोटे अक्षरों और विशेष वर्णों के संयोजन होने चाहिए।",
...
<li> आईपी रेंज: आईपी सीमा के भीतर मेल खाती है; उदाहरण के लिए: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.emailType"        => "मेलबॉक्स प्रकार",
    ...
    "admin.setting.recDescInfo21"    => "बैकअप डेटा को नए डेटाबेस में लिखकर और उसे सिस्टम डिफ़ॉल्ट के रूप में सेट करके सिस्टम डेटा को पुनर्स्थापित किया जा सकता है।",
    "admin.setting.recDescInfo22"    => "नए डेटाबेस कॉन्फ़िगरेशन पैरामीटर सिस्टम कॉन्फ़िगरेशन फ़ाइल config/setting_user.php में जोड़ दिए जाएँगे। यदि सिस्टम पुनर्स्थापना के बाद किसी अपवाद का सामना करता है, तो आप पिछले सिस्टम डेटा को प्रभावित किए बिना फ़ाइल के जोड़े गए भाग को हटा सकते हैं।",
    ...
    "admin.setting.recDescInfo32"    => "उदाहरण के लिए, यदि वर्तमान डेटाबेस कॉन्फ़िगरेशन है: उपयोगकर्ता: परीक्षण; पासवर्ड: test123, रूट खाते का उपयोग करके डेटाबेस में लॉग इन करें और अनुमतियाँ सेट करने के लिए संबंधित SQL कथन निष्पादित करें (परीक्षण पास होने और पुनर्स्थापना सफल होने के बाद अनुमतियाँ रद्द की जा सकती हैं)।",
    ...
    "ERROR_USER_PASSWORD_MISSING"    => "पासवर्ड गुम",
    ...
    "admin.authFrom.setUser"         => "उपयोगकर्ता अनुमतियाँ निर्दिष्ट करना",
...
<li> अपडेट: डाउनलोड करने के बाद, अपलोड करें और संबंधित प्लग-इन नाम फ़ोल्डर में अनज़िप करें;</li>",
    ...
    "admin.plugin.closedError"       => "प्लग-इन सक्षम नहीं किया गया है, कृपया व्यवस्थापक से संपर्क करें!",
    ...
    "admin.storage.errNoCnt"         => "%s भौतिक फ़ाइलें मौजूद नहीं हैं या पहुंच योग्य नहीं हैं",
    ...
    "admin.storage.errTimeout"       => "सेवा अनुरोध का समय समाप्त!",
    "admin.storage.tryOrRmNow"       => "आप पुनः प्रयास रद्द कर सकते हैं, या सीधे अनइंस्टॉल कर सकते हैं (फ़ाइलें हटा दी जाएंगी, कृपया सावधानी से आगे बढ़ें!)।",
    ...
    "admin.storage.oosKeyDesc"       => "एक्सेस कुंजी आईडी, कृपया इसे [कंसोल-एक्सेस कुंजी प्रबंधन] में बनाएं",
    ...
    "admin.storage.ftpBsPathErr"     => "भंडारण निर्देशिका के रूप में [0] का उपयोग करने का प्रयास करें।",
    ...
    "admin.storage.s3SignVer"        => "हस्ताक्षरित संस्करण",
    "admin.storage.s3SignVerDesc"    => "प्रमाणीकरण हस्ताक्षरित संस्करण",
    "admin.storage.s3FormUpload"     => "फॉर्म अपलोड",
    "admin.storage.s3FormUploadDesc" => "कुछ भंडारण सेवाएँ इस फ़ंक्शन का समर्थन नहीं करती हैं। 10 एमबी से कम की फ़ाइलें फ्रंट-एंड डायरेक्ट ट्रांसमिशन के दौरान अपलोड होने में विफल रहेंगी।",
    "admin.storage.ioReset"          => "भंडारण स्थान निर्दिष्ट करें",
    "admin.storage.ioResetDesc"      => "यदि यह रिक्त है, तो वर्तमान डिफ़ॉल्ट संग्रहण स्थान का उपयोग किया जाता है, जो केवल संशोधन के बाद अपलोड की गई फ़ाइलों के डिफ़ॉल्ट संग्रहण स्थान को प्रभावित करता है।",
    "admin.storage.groupDef"         => "डिफ़ॉल्ट संग्रहण",
    "admin.storage.groupLoc"         => "स्थानीय भंडारण",
    "admin.storage.groupObj"         => "ऑब्जेक्ट संग्रहण",
    "admin.storage.groupNet"         => "नेटवर्क संग्रहण",
    "admin.storage.groupOth"         => "अन्य भंडारण",
    ...
    "admin.backup.open"              => "बैकअप सक्षम करें",
    "admin.backup.openDesc"          => "सिस्टम डेटाबेस और फ़ाइलों का बैकअप लें",
    ...
    "admin.backup.ifSave"            => "क्या आप वाकई बैकअप बनाना चाहते हैं?",
    ...
    "admin.backup.optionTime"        => "डेटा परिवर्तनों के प्रभाव से बचने के लिए, कृपया गैर-कार्य घंटों के दौरान ऑपरेशन करने का विकल्प चुनें।",
    "admin.backup.optionLocation"    => "कृपया फ़ाइल बैकअप के लिए विशेष रूप से एक नया स्वतंत्र संग्रहण बनाएँ",
    "admin.backup.optionTips1"       => "बैकअप दो भागों में विभाजित है: डेटाबेस और फ़ाइल बैकअप। दोनों का बैकअप लेने की सलाह दी जाती है।",
    "admin.backup.optionTips2"       => "डेटाबेस बैकअप: डेटाबेस सामग्री से एक SQL फ़ाइल बनाएं और उसे लक्ष्य संग्रहण (केवल डेटाबेस के लिए सिस्टम डिफ़ॉल्ट संग्रहण) में बैकअप करें।",
    ...
    "admin.backup.needNoDefault"     => "फ़ाइल बैकअप स्थान के रूप में सिस्टम डिफ़ॉल्ट संग्रहण का चयन न करें!",
    ...
    "admin.backup.freeBakDesc"       => "निःशुल्क संस्करण केवल डेटाबेस बैकअप का समर्थन करता है",
    ...
    "admin.backup.taskDbDesc"        => "सिस्टम डेटाबेस का स्वचालित रूप से बैकअप लें",
    "admin.backup.taskFileDesc"      => "सिस्टम फ़ाइलों का स्वचालित रूप से बैकअप लें",
    "admin.backup.addStoreHasFile"   => "इस संग्रहण में सिस्टम डेटा है, कृपया पहले माइग्रेट करें या नया संग्रहण जोड़ें!",
    "admin.backup.title"             => "फ़ाइल बैकअप निर्देश",
    "admin.backup.bakFileTip1"       => "फ़ाइल बैकअप एक स्वतंत्र कार्य है। इसकी निष्पादन आवृत्ति, प्रगति और अन्य जानकारी डेटाबेस बैकअप में शामिल नहीं होती। कार्य विवरण के लिए, %s देखें।",
    "admin.backup.bakFileTip2"       => "फ़ाइल बैकअप (कॉपी) की वास्तविक समय प्रगति %s में देखी जा सकती है;",
    "admin.backup.bakFileTip3"       => "यदि बैकअप विफल हो जाता है, तो आप लॉग %s में विवरण देख सकते हैं;",
    "admin.backup.bakFileTip4"       => "बैकअप विफलताएँ आमतौर पर असामान्य स्टोरेज कनेक्शन (फ़ाइलों को पढ़ने या लिखने में असमर्थता) के कारण होती हैं। सामान्य बैकअप निष्पादन सुनिश्चित करने के लिए, कृपया सुनिश्चित करें कि सभी स्टोरेज डिवाइस ठीक से कनेक्टेड हैं।",
    "admin.backup.bakFileTask"       => "निर्धारित कार्य - डेटा बैकअप (फ़ाइल)",
    "admin.backup.full"              => "पूर्ण बैकअप",
    "admin.backup.fullDesc"          => "पहली फ़ाइल से बैकअप लेना शुरू करें",
    "admin.backup.increment"         => "वृध्दिशील बैकअप",
    "admin.backup.incrementDesc"     => "अंतिम कार्य के आधार पर बैकअप जारी रखें",
    "admin.backup.sameSkip"          => "(समान नाम वाली फ़ाइलों को अनदेखा कर दिया जाएगा)",
    "admin.backup.clickDtl"          => "विवरण देखने के लिए क्लिक करें",
    "admin.backup.ifBakFile"         => "क्या आप वाकई अपनी फ़ाइलों का बैकअप लेना चाहते हैं?",
    "admin.restore.ifRecDb"          => "डेटाबेस पुनर्स्थापना से वर्तमान सिस्टम डेटा बदल जाएगा। क्या आप वाकई इसे निष्पादित करना चाहते हैं?",
    "admin.restore.ifRecFile"        => "फ़ाइल पुनर्स्थापना से वर्तमान सिस्टम डेटा बदल जाएगा। क्या आप वाकई इसे निष्पादित करना चाहते हैं?",
    "admin.restore.fileRec"          => "फ़ाइल पुनर्स्थापना",
    "admin.restore.importTips"       => "महत्वपूर्ण अनुस्मारक",
    "admin.restore.recType"          => "सामग्री पुनर्स्थापित करें",
    "admin.restore.recTypeDb"        => "डेटाबेस पुनर्स्थापना",
    "admin.restore.recTypeFile"      => "फ़ाइल पुनर्स्थापना",
    "admin.restore.recFileDesc1"     => "फ़ाइल पुनर्स्थापना का अर्थ है सिस्टम की भौतिक फ़ाइलों को पुनर्स्थापित करने के लिए वर्तमान सिस्टम के फ़ाइल रिकॉर्ड के आधार पर बैकअप स्टोरेज से फ़ाइलों को डिफ़ॉल्ट स्टोरेज में कॉपी करना।",
    "admin.restore.recFileDesc2"     => "नोट: पुनर्स्थापना प्रक्रिया के दौरान प्रतिलिपि बनाना वर्तमान डेटाबेस के फ़ाइल रिकॉर्ड पर निर्भर करता है। यदि इसमें सिस्टम पुनः स्थापित करना शामिल है, तो आपको पहले डेटाबेस को पुनर्स्थापित करना होगा।",
    "admin.restore.recFileDesc3"     => "फ़ाइल पुनर्स्थापना एक समय लेने वाला कार्य है, खासकर जब डेटा वॉल्यूम बड़ा हो या क्रॉस-स्टोरेज हो। कृपया निष्पादन के दौरान धैर्य रखें।",
    "admin.restore.bakPath"          => "बैकअप निर्देशिका",
    "admin.restore.bakDbPath"        => "डेटाबेस बैकअप निर्देशिका",
    "admin.restore.bakFilePath"      => "फ़ाइल बैकअप निर्देशिका",
    "admin.restore.full"             => "पूर्ण पुनर्स्थापना",
    "admin.restore.fullDesc"         => "पूर्ण पुनर्स्थापना पहली फ़ाइल से शुरू होती है, अन्यथा यह अंतिम कार्य के आधार पर जारी रहेगी। मौजूदा फ़ाइलों को अनदेखा कर दिया जाएगा।",
    "admin.restore.needVipDesc"      => "निःशुल्क संस्करण केवल डेटाबेस पुनर्स्थापना का समर्थन करता है",
    "admin.restore.needVipTips"      => "वर्तमान संस्करण इस ऑपरेशन का समर्थन नहीं करता है, कृपया एंटरप्राइज़ संस्करण में अपग्रेड करें",
    "admin.restore.bakEmpty"         => "चयनित बैकअप निर्देशिका रिक्त है",
    "admin.restore.noFileNeed"       => "सिस्टम में ऐसी कोई फ़ाइल नहीं है जिसे पुनर्स्थापित करने की आवश्यकता हो",
    "admin.restore.taskRepeat"       => "कार्य प्रगति पर है, कृपया ऑपरेशन न दोहराएँ",
 ...
 post_max_size, पुनरारंभ करने की आवश्यकता है)",
    ...
    "common.isOpen"                  => "क्या यह सक्षम है?",
    ...
    "common.readWrite"               => "पठनीय और लिखने योग्य",
    "common.noAuth"                  => "कोई अनुमति नहीं",
    "common.site"                    => "साइट",
    ...
    "common.phyFileNotExists"        => "भौतिक फ़ाइलें गुम हैं या पहुंच योग्य नहीं हैं!",
    ...
    "common.date.tomorrow"           => "कल",
    "common.date.week"               => "इस सप्ताह",
    "common.date.weekNext"           => "अगले सप्ताह",
    "common.date.weekPrev"           => "पिछले सप्ताह",
    "common.date.month"              => "इस महीने",
    "common.date.monthNext"          => "अगले महीने",
    "common.date.monthPrev"          => "पिछला महीना",
    "common.date.day7"               => "पिछले 7 दिन",
    "common.date.day30"              => "पिछले 30 दिन",
    "common.date.day90"              => "पिछले 90 दिन",
    "common.date.day180"             => "पिछले 180 दिन",
    ...
    "explorer.complete"              => "ऑपरेशन पूरा हुआ!",
    ...
    "explorer.wrtSetUserError"       => "सिस्टम कॉन्फ़िगरेशन फ़ाइल (config/setting_user.php) में लिखने की अनुमति नहीं है!",
    ...
    "explorer.groupAuthFrom"         => "प्राधिकरण स्रोत",
    "explorer.groupAuthCopy"         => "संयोजन की प्रतिलिपि बनाएँ",
    "explorer.groupAuthCopyDesc"     => "संयोजन की प्रतिलिपि बनाएँ",
    ...
    "explorer.folderPass.add"        => "फ़ोल्डर पासवर्ड सेट करें",
    "explorer.folderPass.edit"       => "फ़ोल्डर पासवर्ड संपादित करें",
    "explorer.folderPass.clearAsk"   => "क्या आप वाकई फ़ोल्डर पासवर्ड साफ़ करना चाहते हैं?",
    "explorer.folderPass.hasDesc"    => "फ़ोल्डर पासवर्ड सेट",
    "explorer.folderPass.pass"       => "एक्सेस पासवर्ड",
    "explorer.folderPass.passRepeat" => "पासवर्ड की पुष्टि कीजिये",
    "explorer.folderPass.desc"       => "विवरण",
    "explorer.folderPass.timeOutDesc" => "पासवर्ड समाप्ति समय, यदि सेट नहीं है, तो इसका मतलब है कि यह हमेशा वैध रहेगा।",
    "explorer.folderPass.timeOut"    => "समाप्ति समय",
    "explorer.folderPass.btnReset"   => "पासवर्ड रीसेट",
    "explorer.folderPass.btnClear"   => "पासवर्ड हटाएँ",
    "explorer.folderPass.tips"       => "फ़ोल्डर तक पहुंचने के लिए पासवर्ड की आवश्यकता है, जारी रखने के लिए कृपया पासवर्ड दर्ज करें।",
    "explorer.folderPass.tipsHas"    => "उप-सामग्री में ऐसे फ़ोल्डर हैं जिनके लिए पासवर्ड एक्सेस की आवश्यकता है। कृपया जारी रखने के लिए पासवर्ड दर्ज करें।",
 ...
 समर्थन पिनयिन, पहले अक्षर का फजी मिलान",
    ...
    "explorer.upload.fopenError"     => "लिखना विफल, निर्देशिका पढ़ने और लिखने की अनुमतियाँ जाँचें",
    ...
    "explorer.search.path"           => "कैटलॉग खोजें",
    "explorer.search.rootPath"       => "मूल निर्देशिका",
    ...
    "explorer.search.optionDesc"     => "फ़ाइल विवरण",
    "explorer.search.optionTag"      => "उपयोगकर्ता/विभाग लेबल",
    ...
    "explorer.history.action"        => "ऐतिहासिक संस्करणसंचालन",
    "explorer.history.remove"        => "ऐतिहासिक संस्करण हटाएँ",
    ...
    "explorer.share.linkToFast"      => "त्वरित बाह्य लिंक साझाकरण",
    "explorer.share.shareSystem"     => "सिस्टम साझाकरण",
    "explorer.share.shareSystemDesc" => "अन्य ऐप्स या प्लगइन्स द्वारा निर्मित सहयोगात्मक साझाकरण",
    ...
    "explorer.share.selfExit"        => "इस सहयोग से बाहर निकलें",
    "explorer.share.selfExitConfirm" => "क्या आप वाकई सहयोग से बाहर निकलना चाहते हैं? बाहर निकलने के बाद आप सहयोग सामग्री तक नहीं पहुँच पाएँगे।",
    "explorer.shareOut.title"        => "बाहरी संयुक्त साझाकरण",
    "explorer.shareOut.desc"         => "विभिन्न नेटवर्क डिस्क साइटों के बीच सामग्री साझा करना",
    "explorer.shareOut.titlePath"    => "बाहरी संयुक्त साझाकरण",
    "explorer.shareOut.titlePathDesc" => "बाहरी साइटों द्वारा मेरे साथ साझा की गई सामग्री",
    "explorer.shareOut.sendDesc1"    => "प्राप्तकर्ता अंतिम उपयोगकर्ता अधिकार निर्धारित अधिकार हैं और वे बाह्य लिंक साझाकरण अधिकारों से प्रभावित नहीं होते हैं।",
    "explorer.shareOut.sendDesc2"    => "नेटवर्क डिस्क का मुख्य प्रोग्राम संस्करण सुसंगत होना चाहिए, तथा अन्य साइट पर बाह्य संयुक्त साझाकरण फ़ंक्शन सक्षम होना चाहिए।",
    "explorer.shareOut.targetAdd"    => "साझा करने के लिए लोगों को जोड़ें",
    "explorer.shareOut.targetDel"    => "इस साइट ऑब्जेक्ट का साझाकरण रद्द करने की पुष्टि करें",
    "explorer.shareOut.targetEdit"   => "साझा ऑब्जेक्ट संपादित करें",
    "explorer.shareOut.targetUrl"    => "साइट साझा करें",
    "explorer.shareOut.targetUrlDesc" => "साझा साइट सर्वर को वर्तमान साइट तक पहुँचने में सक्षम होना चाहिए",
    "explorer.shareOut.targetName"   => "प्रदर्शित होने वाला नाम",
    "explorer.shareOut.targetNameDesc" => "साझा ऑब्जेक्ट प्रदर्शित करने के लिए प्रयुक्त उपनाम",
    "explorer.shareOut.targetAuth"   => "पहुँच अधिकार",
    "explorer.shareOut.targetUser"   => "के साथ शेयर करें",
    "explorer.shareOut.targetUserDesc1" => "उपयोगकर्ता खाता/उपनाम/ईमेल पता/मोबाइल फ़ोन नंबर",
    "explorer.shareOut.targetUserDesc2" => "उदाहरण के लिए, उपयोगकर्ता आईडी विनिर्देश का समर्थन करता है",
    "explorer.shareOut.targetUserDesc3" => "उदाहरण के लिए, सहायता विभाग आईडी विनिर्देश",
    "explorer.shareOut.siteAdd"      => "त्वरित जोड़ें",
    "explorer.shareOut.configSend"   => "बाहरी साइटों पर साझा करने की अनुमति दें",
    "explorer.shareOut.configSendDesc" => "इसे चालू करने के बाद, यह बाहरी लिंक साझा करते समय अन्य नेटवर्क डिस्क साइटों पर निर्दिष्ट खातों को साझा करने का समर्थन करता है, और स्वतंत्र अनुमतियाँ सेट करने का समर्थन करता है",
    "explorer.shareOut.configReceive" => "बाहरी साइटों से साझा करने की अनुमति दें",
    "explorer.shareOut.configReceiveDesc" => "खोलने के बाद, बाहरी साइटें इसे वर्तमान साइट पर भेज और साझा कर सकती हैं। बंद करने के बाद, यह प्राप्त नहीं होगा।",
    "explorer.shareOut.siteSafe"     => "विश्वसनीय साइट",
    "explorer.shareOut.siteSafeDesc1" => "बाहरी संयुक्त साझाकरण के लिए उपयोग किए जाने पर, आप विश्वसनीय साइट की संगठनात्मक संरचना प्राप्त कर सकते हैं और उपयोगकर्ताओं और विभागों का शीघ्रता से चयन कर सकते हैं",
    "explorer.shareOut.siteSafeDesc2" => "नेटवर्क डिस्क प्रोग्राम संस्करण सुसंगत होना चाहिए, और अन्य साइट पर बाह्य संयुक्त साझाकरण फ़ंक्शन सक्षम होना चाहिए।",
    "explorer.shareOut.siteSafeDel"  => "विश्वसनीय साइट को हटाने की पुष्टि करें",
    "explorer.shareOut.siteSafeAdd"  => "एक विश्वसनीय साइट जोड़ें",
    "explorer.shareOut.siteSafeEdit" => "विश्वसनीय साइट संपादित करें",
    "explorer.shareOut.siteUrl"      => "साइट URL",
    "explorer.shareOut.siteUrlDesc"  => "दूसरे पक्ष के नेटवर्क डिस्क साइट URL के लिए वर्तमान नेटवर्क डिस्क साइट सर्वर को एक दूसरे तक पहुँचने में सक्षम होना आवश्यक है",
    "explorer.shareOut.siteName"     => "जगह का नाम",
    "explorer.shareOut.siteApiKey"   => "साइट एपीआई कुंजी",
    "explorer.shareOut.siteApiKeyDesc" => "दूसरे पक्ष की साइट की apiKey विश्वसनीय साइट की पृष्ठभूमि में प्राप्त की जा सकती है: मूल सेटिंग्स--बाहरी लिंक साझाकरण--मेरी apiKey",
    "explorer.shareOut.siteApiKeySelf" => "वर्तमान साइट की apiKey",
    "explorer.shareOut.siteApiKeySelfDesc1" => "इस apiKey का उपयोग केवल संयुक्त क्लाउड साझाकरण और विश्वसनीय साइट एक्सेस के लिए किया जाता है",
    "explorer.shareOut.errorNetwork" => "अनुरोध विफल रहा। कृपया पुष्टि करें कि लक्ष्य नेटवर्क डिस्क URL सही है और नवीनतम संस्करण है।",
    "explorer.shareOut.errorTitle"   => "बाहरी संयुक्त साझाकरण त्रुटि",
    "explorer.shareOut.errorDisableShare" => "बाहरी लिंक साझाकरण फ़ंक्शन बंद कर दिया गया है, कृपया व्यवस्थापक से संपर्क करें!",
    "explorer.shareOut.errorDisableSend" => "बाह्य लिंक साझाकरण-बाह्य संयुक्त साझाकरण फ़ंक्शन सक्षम नहीं है!",
    "explorer.shareOut.errorDisableReceive" => "बाह्य लिंक साझाकरण-बाह्य संयुक्त साझाकरण फ़ंक्शन सक्षम नहीं है!",
    "explorer.shareOut.errorApiKey"  => "साइट apiKey गलत है, कृपया पुनः दर्ज करें!",
    "explorer.shareOut.errorTarget"  => "लक्ष्य ऑब्जेक्ट मौजूद नहीं है। कृपया पुष्टि करें और पुनः प्रयास करें!",
    "explorer.shareOut.errorCallLimit" => "अनुरोध बहुत बार आया है, कृपया बाद में पुनः प्रयास करें!",
    "explorer.shareOut.errorShareNotExist" => "शेयर मौजूद नहीं है या बाहरी शेयर हटा दिया गया है",
    "explorer.shareOut.errorShareAuth" => "आपको इस बाहरी शेयर तक पहुँचने की अनुमति नहीं है! कृपया उस साइट के व्यवस्थापक से संपर्क करें जहाँ से यह शेयर किया गया है।",
    ...
    "explorer.auth.tabParentTips"    => "वह उपयोगकर्ता या विभाग जिसके पास इस फ़ोल्डर के लिए अनुमतियाँ हैं (सभी उच्च-स्तरीय अनुमतियों से विरासत में मिली)",
    ...
    "explorer.rename.title"          => "आप कई बार जोड़ सकते हैं, खींच सकते हैं और छोड़ सकते हैं (स्वचालित डिडुप्लीकेशन), और त्वरित बैच प्रसंस्करण के लिए एक नामकरण विधि चुन सकते हैं।",
    ...
    "explorer.rename.typeReplaceReg" => "नियमित प्रतिस्थापन",
    ...
    "explorer.rename.allowExt"       => "एक्सटेंशन को बदलना है या नहीं",
    ...
    "explorer.tag.default2"          => "कार्य जानकारी",
    "explorer.tag.default3"          => "व्यक्तिगत डेटा",
    ...
    "explorer.secret.setUserDesc"    => "उस उपयोगकर्ता को निर्दिष्ट करें जो गोपनीयता स्तर निर्धारित कर सकता है (यह संबन्धित विभाग का स्वामी होने की अनुशंसा की जाती है)",
    ...
    "explorer.secret.tips1"          => "विभाग नेटवर्क डिस्क में केवल सामग्री को उपर्युक्त निर्दिष्ट उपयोगकर्ताओं द्वारा सेट किया जा सकता है (इसे फ़ोल्डर स्वामी होने की अनुशंसा की जाती है)",
    ...
    "user.registNotAllow"            => "सिस्टम पंजीकरण के लिए खुला नहीं है, कृपया व्यवस्थापक से संपर्क करें!",
    "user.deregistNotAllow"          => "सिस्टम ने पंजीकरण सक्षम नहीं किया है और लॉगआउट संचालन का समर्थन नहीं करता है। कृपया व्यवस्थापक से संपर्क करें!",
    ...
    "log-event-history-remove"       => "[1] का ऐतिहासिक संस्करण [2] हटा दिया गया",
    "log-event-history-rollback"     => "[1] के ऐतिहासिक संस्करण [2] को वर्तमान संस्करण के रूप में सेट करें",
    "log-event-history-clear"        => "[1] के सभी ऐतिहासिक संस्करण हटा दिए गए",
