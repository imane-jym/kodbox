...
return array(
    ...
    "admin.menu.server"              => "Послуги та обладнання",
    ...
    "admin.server.base"              => "Стан послуги",
    "admin.server.server"            => "Системні служби",
    "admin.server.file"              => "Файлові служби",
    "admin.server.net"               => "Мережа та підключення",
    ...
    "admin.setting.passwordRuleStrongDesc" => "Довжина не повинна бути менше 6; вона повинна містити цифри та англійські літери",
    "admin.setting.passwordRuleStrongMoreDesc" => "Довжина має бути щонайменше 8 символів; вона повинна містити щонайменше 3 типи комбінацій цифр, великих літер, малих літер та спеціальних символів.",
...
<li> Діапазон IP: ip відповідає діапазону; наприклад: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.emailType"        => "Тип поштової скриньки",
    ...
    "admin.setting.recDescInfo21"    => "Системні дані можна відновити, записавши резервні дані в нову базу даних і встановивши її як систему за замовчуванням.",
    "admin.setting.recDescInfo22"    => "Нові параметри конфігурації бази даних будуть додані до файлу конфігурації системи config/setting_user.php. Якщо після відновлення система зіткнеться з винятком, ви можете видалити додану частину файлу, не впливаючи на попередні системні дані.",
    ...
    "admin.setting.recDescInfo32"    => "Наприклад, якщо поточна конфігурація бази даних: Користувач: test; Пароль: test123, увійдіть до бази даних, використовуючи обліковий запис root, та виконайте відповідний SQL-запит, щоб встановити дозволи (дозволи можна скасувати після успішного проходження тесту та відновлення).",
    ...
    "ERROR_USER_PASSWORD_MISSING"    => "Відсутній пароль",
    ...
    "admin.authFrom.setUser"         => "Визначення дозволів користувача",
...
<li> Оновлення: Після завантаження завантажте та розпакуйте у відповідну папку імен плагіна;</li>",
    ...
    "admin.plugin.closedError"       => "Плагін не ввімкнено, зверніться до адміністратора!",
    ...
    "admin.storage.s3"               => "Зберігання S3",
    ...
    "admin.storage.errNoCnt"         => "Фізичні файли %s не існують або недоступні",
    "admin.storage.errMoveCnt"       => "Не вдалося перемістити файли %s",
    "admin.storage.errViewLog"       => "Усього %s. Подробиці перевірте в журналі:",
    "admin.storage.errTimeout"       => "Час очікування запиту на обслуговування минув!",
    "admin.storage.tryOrRmNow"       => "Ви можете скасувати повторну спробу або безпосередньо видалити (файли буде видалено, будь ласка, будьте обережні!).",
    ...
    "admin.storage.oosKeyDesc"       => "Ідентифікатор ключа доступу, створіть його в [Console-Access Key Management]",
    ...
    "admin.storage.ftpBsPathErr"     => "Спробуйте використовувати [0] як каталог зберігання.",
    ...
    "admin.storage.s3SignVer"        => "Версія з підписом",
    "admin.storage.s3SignVerDesc"    => "Підписана версія автентифікації",
    "admin.storage.s3FormUpload"     => "завантаження форми",
    "admin.storage.s3FormUploadDesc" => "Деякі служби зберігання не підтримують цю функцію. Ви можете вимкнути цю функцію.",
    "admin.storage.ioReset"          => "Вкажіть місце зберігання",
    "admin.storage.ioResetDesc"      => "Якщо він порожній, використовується поточне сховище за замовчуванням, яке впливає лише на місце зберігання за замовчуванням завантажених файлів після зміни.",
    "admin.storage.groupDef"         => "Сховище за замовчуванням",
    "admin.storage.groupLoc"         => "Локальне сховище",
    "admin.storage.groupObj"         => "Зберігання об'єктів",
    "admin.storage.groupNet"         => "Мережеве сховище",
    "admin.storage.groupOth"         => "Інше сховище",
    ...
    "admin.backup.open"              => "Увімкнути резервне копіювання",
    "admin.backup.openDesc"          => "Резервне копіювання системних баз даних і файлів",
    ...
    "admin.backup.ifSave"            => "Ви впевнені, що хочете зробити резервну копію?",
    ...
    "admin.backup.optionTime"        => "Щоб уникнути впливу змін даних, будь ласка, вирішіть виконувати операцію у неробочий час.",
    "admin.backup.optionLocation"    => "Будь ласка, створіть нове незалежне сховище спеціально для резервного копіювання файлів",
    "admin.backup.optionTips1"       => "Резервна копія поділена на дві частини: резервна копія бази даних та резервна копія файлів. Рекомендується створити резервну копію обох.",
    "admin.backup.optionTips2"       => "Резервне копіювання бази даних: Згенеруйте SQL-файл із вмісту бази даних та створіть його резервну копію на цільове сховище (системне сховище за замовчуванням лише для бази даних).",
    ...
    "admin.backup.needNoDefault"     => "Не вибирайте системне сховище за замовчуванням як місце резервного копіювання файлів!",
    ...
    "admin.backup.freeBakDesc"       => "Безкоштовна версія підтримує лише резервне копіювання бази даних",
    ...
    "admin.backup.taskDbDesc"        => "Автоматичне резервне копіювання системної бази даних",
    "admin.backup.taskFileDesc"      => "Автоматичне резервне копіювання системних файлів",
    "admin.backup.addStoreHasFile"   => "Це сховище містить системні дані, будь ласка, спочатку перенесіть дані або додайте нове сховище!",
    "admin.backup.title"             => "Інструкції щодо резервного копіювання файлів",
    "admin.backup.bakFileTip1"       => "Резервне копіювання файлів – це незалежне завдання. Його частота виконання, прогрес та інша інформація не враховуються в резервному копіюванні бази даних. Докладнішу інформацію про завдання див. у %s.",
    "admin.backup.bakFileTip2"       => "Хід резервного копіювання файлів у режимі реального часу можна переглядати у %s;",
    "admin.backup.bakFileTip3"       => "Якщо резервне копіювання не вдається, ви можете переглянути деталі в журналі %s;",
    "admin.backup.bakFileTip4"       => "Збої резервного копіювання зазвичай спричинені ненормальним підключенням до сховища (неможливість читати або записувати файли). Щоб забезпечити нормальне виконання резервного копіювання, переконайтеся, що всі пристрої зберігання даних підключені належним чином.",
    "admin.backup.bakFileTask"       => "Заплановані завдання – резервне копіювання даних (файл)",
    "admin.backup.full"              => "Повне резервне копіювання",
    "admin.backup.fullDesc"          => "Почати резервне копіювання з першого файлу",
    "admin.backup.increment"         => "Інкрементне резервне копіювання",
    "admin.backup.incrementDesc"     => "Продовжити резервне копіювання на основі останнього завдання",
    "admin.backup.sameSkip"          => "(Файли з однаковою назвою будуть ігноруватися)",
    "admin.backup.clickDtl"          => "Натисніть, щоб переглянути деталі",
    "admin.backup.ifBakFile"         => "Ви впевнені, що хочете створити резервну копію своїх файлів?",
    "admin.restore.ifRecDb"          => "Відновлення бази даних змінить поточні системні дані. Ви впевнені, що хочете його виконати?",
    "admin.restore.ifRecFile"        => "Відновлення файлів змінить поточні системні дані. Ви впевнені, що хочете його виконати?",
    "admin.restore.fileRec"          => "Відновлення файлів",
    "admin.restore.importTips"       => "Важливе нагадування",
    "admin.restore.recType"          => "Відновити вміст",
    "admin.restore.recTypeDb"        => "Відновлення бази даних",
    "admin.restore.recTypeFile"      => "Відновлення файлів",
    "admin.restore.recFileDesc1"     => "Відновлення файлів полягає в копіюванні файлів із резервного сховища до сховища за замовчуванням на основі поточних файлових записів системи для відновлення фізичних файлів системи.",
    "admin.restore.recFileDesc2"     => "Примітка: Копіювання під час процесу відновлення залежить від файлових записів поточної бази даних. Якщо це передбачає перевстановлення системи, спочатку потрібно відновити базу даних.",
    "admin.restore.recFileDesc3"     => "Відновлення файлів – це трудомістка операція, особливо коли обсяг даних великий або вони зберігаються на різних накопичувачах. Будь ласка, будьте терплячими під час виконання.",
    "admin.restore.bakPath"          => "Резервний каталог",
    "admin.restore.bakDbPath"        => "Каталог резервного копіювання бази даних",
    "admin.restore.bakFilePath"      => "Каталог резервного копіювання файлів",
    "admin.restore.full"             => "Повне відновлення",
    "admin.restore.fullDesc"         => "Повне відновлення починається з першого файлу, інакше воно продовжиться з останнього завдання. Існуючі файли будуть проігноровані.",
    "admin.restore.needVipDesc"      => "Безкоштовна версія підтримує лише відновлення бази даних.",
    "admin.restore.needVipTips"      => "Поточна версія не підтримує цю операцію, будь ласка, оновіть її до Enterprise Edition.",
    "admin.restore.bakEmpty"         => "Вибраний каталог резервної копії порожній",
    "admin.restore.noFileNeed"       => "У системі немає файлів, які потребують відновлення",
    "admin.restore.taskRepeat"       => "Завдання виконується, будь ласка, не повторюйте операцію",
 ...
 post_max_size, потрібно перезапустити)",
    ...
    "common.readWrite"               => "Читабельний та записуваний",
    "common.noAuth"                  => "Без дозволів",
    "common.site"                    => "Сайт",
    "common.ifDel"                   => "Справді видалити?",
    "common.pageNotExists"           => "Сторінки не існує!",
    "common.pathNotExists"           => "Документу не існує!",
    "common.phyFileNotExists"        => "Фізичні файли відсутні або недоступні!",
    ...
    "common.ready"                   => "Очікує на розгляд",
    ...
    "common.copyright.desc"          => "haisum - це дуже відома система управління веб-документами, раніше відома як KodExplorer, ви можете використовувати її для внутрішнього управління документами або спільного використання, а також для управління веб-сайтами на сервері. Замість Ftp ви навіть можете розвивати онлайн як веб-сайт безпосередньо. Одночасно ви можете інтегрувати вторинну розробку цієї програми у вашу існуючу систему.",
    ...
    "common.copyright.metaKeywords"  => "haisum, KodExplorer, kod, kodCloud, webos, webIDE, php управління файлами, управління файлами, Kedao Cloud, Mango Cloud, система управління документами, Enterprise Cloud Disk, Explorer, Інтернет-документи, Інтернет-офіс, Інтернет-офіс, Інтернет-перегляд CAD, Інтернет-редактор, онлайн-редактор",
    ...
    "common.date.week"               => "цього тижня",
    "common.date.weekNext"           => "наступного тижня",
    "common.date.weekPrev"           => "минулого тижня",
    "common.date.month"              => "цього місяця",
    "common.date.monthNext"          => "наступного місяця",
    "common.date.monthPrev"          => "минулого місяця",
    "common.date.day7"               => "останні 7 днів",
    "common.date.day30"              => "Останні 30 днів",
    "common.date.day90"              => "Останні 90 днів",
    "common.date.day180"             => "Останні 180 днів",
    ...
    "explorer.complete"              => "Операція завершена!",
    ...
    "explorer.wrtSetUserError"       => "Файл конфігурації системи (config/setting_user.php) не має прав на запис!",
    ...
    "explorer.groupAuthFrom"         => "Джерело авторизації",
    "explorer.groupAuthCopy"         => "Копіювати комбінацію",
    "explorer.groupAuthCopyDesc"     => "Копіювати комбінацію",
    ...
    "explorer.folderPass.add"        => "Встановити пароль папки",
    "explorer.folderPass.edit"       => "Змінити пароль папки",
    "explorer.folderPass.clearAsk"   => "Ви впевнені, що хочете очистити пароль папки?",
    "explorer.folderPass.hasDesc"    => "Встановлено пароль папки",
    "explorer.folderPass.pass"       => "пароль доступу",
    "explorer.folderPass.passRepeat" => "Підтвердьте пароль",
    "explorer.folderPass.desc"       => "опис",
    "explorer.folderPass.timeOutDesc" => "Термін дії пароля, якщо не встановлено, це означає, що він завжди буде дійсним.",
    "explorer.folderPass.timeOut"    => "Термін придатності",
 ...
 Підтримка піньїнь, нечітка відповідність першої літери",
    ...
    "explorer.upload.fopenError"     => "Помилка запису, перевірте дозволи на читання та запис каталогу",
    ...
    "explorer.search.path"           => "Пошук по каталогу",
    "explorer.search.rootPath"       => "кореневий каталог",
    ...
    "explorer.search.optionDesc"     => "Опис файлу",
    "explorer.search.optionTag"      => "Ярлики користувача/відділу",
    ...
    "explorer.history.action"        => "Операції історичної версії",
    "explorer.history.remove"        => "Видалити історичну версію",
    ...
    "explorer.share.linkToFast"      => "Швидкий обмін зовнішніми посиланнями",
    "explorer.share.shareSystem"     => "Спільний доступ до системи",
    "explorer.share.shareSystemDesc" => "Спільний доступ, створений іншими програмами або плагінами",
    ...
    "explorer.share.selfExit"        => "Вийти з цієї співпраці",
    "explorer.share.selfExitConfirm" => "Ви впевнені, що хочете вийти зі співпраці? Після виходу ви більше не матимете доступу до вмісту для співпраці.",
    "explorer.shareOut.title"        => "Зовнішнє спільне використання",
    "explorer.shareOut.desc"         => "Спільний доступ до контенту між різними сайтами мережевих дисків",
    "explorer.shareOut.titlePath"    => "Зовнішнє спільне використання",
    "explorer.shareOut.titlePathDesc" => "Контент, наданий мені зовнішніми сайтами",
    "explorer.shareOut.sendDesc1"    => "Права кінцевого користувача-отримувача – це встановлені права, на які не впливають права спільного доступу до зовнішнього посилання.",
    "explorer.shareOut.sendDesc2"    => "Основна версія програми мережевого диска має бути узгодженою, а на іншому сайті має бути ввімкнено функцію спільного доступу до зовнішніх ресурсів.",
    "explorer.shareOut.targetAdd"    => "Додати людей, з якими потрібно поділитися",
    "explorer.shareOut.targetDel"    => "Підтвердіть скасування спільного доступу до цього об'єкта сайту",
    "explorer.shareOut.targetEdit"   => "Редагувати спільні об'єкти",
    "explorer.shareOut.targetUrl"    => "Поділитися сайтом",
    "explorer.shareOut.targetUrlDesc" => "Сервер спільного сайту повинен мати доступ до поточного сайту.",
    "explorer.shareOut.targetName"   => "відображуване ім'я",
    "explorer.shareOut.targetNameDesc" => "Псевдоніми, що використовуються для відображення спільних об'єктів",
    "explorer.shareOut.targetAuth"   => "Права доступу",
    "explorer.shareOut.targetUser"   => "Поділитися з",
    "explorer.shareOut.targetUserDesc1" => "Обліковий запис користувача/нікнейм/адреса електронної пошти/номер мобільного телефону",
    "explorer.shareOut.targetUserDesc2" => "Підтримує специфікацію ідентифікатора користувача, наприклад",
    "explorer.shareOut.targetUserDesc3" => "Наприклад, специфікація ідентифікатора відділу підтримки",
    "explorer.shareOut.siteAdd"      => "Швидке додавання",
    "explorer.shareOut.configSend"   => "Дозволити спільний доступ до зовнішніх сайтів",
    "explorer.shareOut.configSendDesc" => "Після ввімкнення зовнішні посилання можна буде передавати визначеним обліковим записам на інших мережевих дисках, а також встановлювати незалежні дозволи.",
    "explorer.shareOut.configReceive" => "Дозволити спільний доступ із зовнішніх сайтів",
    "explorer.shareOut.configReceiveDesc" => "Після відкриття зовнішні сайти можуть надсилати дані та ділитися ними на поточний сайт. Після закриття вони більше не прийматимуться.",
    "explorer.shareOut.siteSafe"     => "Надійний сайт",
    "explorer.shareOut.siteSafeDesc1" => "Під час використання для спільного зовнішнього доступу можна отримати організаційну структуру надійного сайту та швидко вибрати користувачів і відділи.",
    "explorer.shareOut.siteSafeDesc2" => "Версія програми мережевого диска має бути узгодженою, а на іншому сайті має бути ввімкнено функцію спільного доступу до зовнішніх ресурсів.",
    "explorer.shareOut.siteSafeDel"  => "Підтвердіть видалення надійного сайту",
    "explorer.shareOut.siteSafeAdd"  => "Додати надійний сайт",
    "explorer.shareOut.siteSafeEdit" => "Редагувати надійний сайт",
    "explorer.shareOut.siteUrl"      => "URL-адреса сайту",
    "explorer.shareOut.siteUrlDesc"  => "URL-адреса мережевого дискового сайту іншої сторони вимагає, щоб поточний сервер мережевого дискового сайту мав доступ один до одного.",
    "explorer.shareOut.siteName"     => "Назва сайту",
    "explorer.shareOut.siteApiKey"   => "API-ключ сайту",
    "explorer.shareOut.siteApiKeyDesc" => "Ключ API сайту іншої сторони можна отримати у фоновому режимі на довіреному сайті: Основні налаштування – Зовнішній спільний доступ до посилань – Мій ключ API",
    "explorer.shareOut.siteApiKeySelf" => "API-ключ поточного сайту",
    "explorer.shareOut.siteApiKeySelfDesc1" => "Цей API-ключ використовується лише для спільного використання хмарних ресурсів та доступу до надійних сайтів.",
    "explorer.shareOut.errorNetwork" => "Запит не вдався. Будь ласка, підтвердьте, чи URL-адреса цільового мережевого диска правильна та чи використовується остання версія.",
    "explorer.shareOut.errorTitle"   => "Помилка спільного доступу до зовнішнього суглоба",
    "explorer.shareOut.errorDisableShare" => "Функцію обміну зовнішніми посиланнями закрито, будь ласка, зверніться до адміністратора!",
    "explorer.shareOut.errorDisableSend" => "Зовнішній спільний доступ до посилань – функція спільного зовнішнього доступу не ввімкнена!",
    "explorer.shareOut.errorDisableReceive" => "Зовнішній спільний доступ до посилань – функція спільного зовнішнього доступу не ввімкнена!",
    "explorer.shareOut.errorApiKey"  => "API-ключ сайту неправильний, будь ласка, введіть його ще раз!",
    "explorer.shareOut.errorTarget"  => "Цільовий об'єкт не існує. Будь ласка, підтвердіть та спробуйте ще раз!",
    "explorer.shareOut.errorCallLimit" => "Запит надто частий, спробуйте ще раз пізніше!",
    "explorer.shareOut.errorShareNotExist" => "Спільного ресурсу не існує, або зовнішній спільний ресурс було видалено",
    "explorer.shareOut.errorShareAuth" => "У вас немає дозволу на доступ до цієї зовнішньої папки! Зверніться до адміністратора сайту, з якого було створено папку.",
    ...
    "explorer.auth.tabParentTips"    => "Користувач або відділ, який має дозволи для цієї папки (успадковані від усіх дозволів вищого рівня)",
    ...
    "explorer.rename.title"          => "Ви можете додавати кілька разів, перетягувати (автоматична дедуплікація) і вибирати метод іменування для швидкої пакетної обробки.",
    ...
    "explorer.rename.typeReplaceReg" => "Регулярна заміна",
    ...
    "explorer.rename.allowExt"       => "Чи замінити розширення",
    ...
    "explorer.tag.default2"          => "Інформація про роботу",
    "explorer.tag.default3"          => "Персональні дані",
    ...
    "explorer.secret.setUserDesc"    => "Вкажіть користувача, який може встановити рівень конфіденційності (бажано бути власником відповідного відділу)",
    ...
    "explorer.secret.tips1"          => "Лише вміст на мережевому диску відділу може бути встановлений вищезазначеними призначеними користувачами (рекомендовано бути власником папки)",
    ...
    "user.registNotAllow"            => "Система не відкрита для реєстрації, будь ласка, зверніться до адміністратора!",
    "user.deregistNotAllow"          => "Система не ввімкнула реєстрацію та не підтримує операції виходу з системи. Зверніться до адміністратора!",
    ...
    "log-event-history-remove"       => "Видалено історичну версію [2] з [1]",
    "log-event-history-rollback"     => "Установити історичну версію [2] з [1] як поточну версію",
    "log-event-history-clear"        => "Видалено всі історичні версії [1]",
