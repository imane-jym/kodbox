...
return array(
    ...
    "admin.menu.server"              => "Usługi i wyposażenie",
    ...
    "admin.server.base"              => "Status usługi",
    "admin.server.server"            => "Usługi systemowe",
    "admin.server.file"              => "Usługi plików",
    "admin.server.net"               => "Sieć i łączność",
    ...
    "admin.setting.passwordRuleStrongDesc" => "Długość nie powinna być mniejsza niż 6; musi zawierać cyfry i litery angielskie",
    "admin.setting.passwordRuleStrongMoreDesc" => "Długość powinna wynosić co najmniej 8 znaków; musi zawierać co najmniej 3 rodzaje kombinacji cyfr, wielkich liter, małych liter i znaków specjalnych.",
...
<li> Zakres adresów IP: ip pasuje do zakresu; na przykład: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.emailType"        => "Typ skrzynki pocztowej",
    ...
    "admin.setting.recDescInfo21"    => "Dane systemowe można przywrócić, zapisując dane zapasowe w nowej bazie danych i ustawiając ją jako domyślną bazę danych w systemie.",
    "admin.setting.recDescInfo22"    => "Nowe parametry konfiguracji bazy danych zostaną dodane do pliku konfiguracyjnego systemu config/setting_user.php. Jeśli system napotka wyjątek po przywróceniu, można usunąć dodaną część pliku bez wpływu na poprzednie dane systemowe.",
    ...
    "admin.setting.recDescInfo32"    => "Na przykład, jeśli bieżąca konfiguracja bazy danych wygląda następująco: Użytkownik: test; Hasło: test123, zaloguj się do bazy danych przy użyciu konta root i wykonaj odpowiednie polecenie SQL, aby ustawić uprawnienia (uprawnienia mogą zostać cofnięte po pomyślnym zakończeniu testu i przywróceniu danych).",
    ...
    "ERROR_USER_PASSWORD_MISSING"    => "Brak hasła",
    ...
    "admin.authFrom.setUser"         => "Określanie uprawnień użytkownika",
...
<li> Aktualizacja: po pobraniu prześlij i rozpakuj do odpowiedniego folderu z nazwą wtyczki;</li>",
    ...
    "admin.plugin.closedError"       => "Wtyczka nie została włączona, prosimy o kontakt z administratorem!",
    ...
    "admin.storage.errNoCnt"         => "Pliki fizyczne %s nie istnieją lub są niedostępne",
    ...
    "admin.storage.errTimeout"       => "Upłynął limit czasu żądania usługi!",
    "admin.storage.tryOrRmNow"       => "Możesz anulować ponowną próbę lub bezpośrednio odinstalować (pliki zostaną usunięte, zachowaj ostrożność!).",
    ...
    "admin.storage.oosKeyDesc"       => "Identyfikator klucza dostępu, utwórz go w [Zarządzanie kluczami dostępu do konsoli]",
    ...
    "admin.storage.ftpBsPathErr"     => "Spróbuj użyć [0] jako katalogu przechowywania.",
    ...
    "admin.storage.s3SignVer"        => "Wersja podpisana",
    "admin.storage.s3SignVerDesc"    => "Wersja z podpisem uwierzytelniającym",
    "admin.storage.s3FormUpload"     => "przesłanie formularza",
    "admin.storage.s3FormUploadDesc" => "Niektóre usługi przechowywania nie obsługują tej funkcji. Pliki o rozmiarze mniejszym niż 10 MB nie zostaną przesłane podczas bezpośredniej transmisji z przodu. Można to wyłączyć.",
    "admin.storage.ioReset"          => "Określ lokalizację przechowywania",
    "admin.storage.ioResetDesc"      => "Jeżeli jest pusty, używany jest bieżący domyślny magazyn, który ma wpływ jedynie na domyślną lokalizację magazynu przesłanych plików po modyfikacji.",
    "admin.storage.groupDef"         => "Domyślne przechowywanie",
    "admin.storage.groupLoc"         => "Pamięć lokalna",
    "admin.storage.groupObj"         => "Przechowywanie obiektów",
    "admin.storage.groupNet"         => "Pamięć masowa sieciowa",
    "admin.storage.groupOth"         => "Inne przechowywanie",
    ...
    "admin.backup.open"              => "Włącz tworzenie kopii zapasowej",
    "admin.backup.openDesc"          => "Tworzenie kopii zapasowych baz danych i plików systemowych",
    ...
    "admin.backup.ifSave"            => "Czy na pewno chcesz wykonać kopię zapasową?",
    ...
    "admin.backup.optionTime"        => "Aby uniknąć wpływu zmian danych, prosimy o przeprowadzenie operacji poza godzinami pracy.",
    "admin.backup.optionLocation"    => "Proszę utworzyć nowe, niezależne miejsce przechowywania przeznaczone specjalnie do tworzenia kopii zapasowych plików",
    "admin.backup.optionTips1"       => "Kopia zapasowa składa się z dwóch części: bazy danych i pliku. Zaleca się wykonanie kopii zapasowej obu.",
    "admin.backup.optionTips2"       => "Kopia zapasowa bazy danych: Generowanie pliku SQL z zawartości bazy danych i tworzenie jego kopii zapasowej w docelowym magazynie (domyślnym magazynie systemu przeznaczonym wyłącznie dla bazy danych).",
    ...
    "admin.backup.needNoDefault"     => "Nie wybieraj domyślnego miejsca przechowywania danych systemu jako lokalizacji kopii zapasowej pliku!",
    ...
    "admin.backup.freeBakDesc"       => "Wersja bezpłatna obsługuje wyłącznie tworzenie kopii zapasowych bazy danych",
    ...
    "admin.backup.taskDbDesc"        => "Automatyczne tworzenie kopii zapasowej bazy danych systemu",
    "admin.backup.taskFileDesc"      => "Automatyczne tworzenie kopii zapasowych plików systemowych",
    "admin.backup.addStoreHasFile"   => "Ta pamięć masowa zawiera dane systemowe. Najpierw należy ją przenieść lub dodać nową pamięć masową!",
    "admin.backup.title"             => "Instrukcje tworzenia kopii zapasowej plików",
    "admin.backup.bakFileTip1"       => "Kopia zapasowa pliku to niezależne zadanie. Częstotliwość wykonywania, postęp i inne informacje nie są uwzględniane w kopii zapasowej bazy danych. Szczegóły zadania można znaleźć w sekcji %s.",
    "admin.backup.bakFileTip2"       => "Postęp tworzenia kopii zapasowej pliku (kopiowania) w czasie rzeczywistym można przeglądać w %s;",
    "admin.backup.bakFileTip3"       => "Jeśli kopia zapasowa się nie powiedzie, szczegóły możesz zobaczyć w dzienniku %s;",
    "admin.backup.bakFileTip4"       => "Błędy tworzenia kopii zapasowych są zazwyczaj spowodowane nieprawidłowym połączeniem z pamięcią masową (brak możliwości odczytu lub zapisu plików). Aby zapewnić prawidłowe wykonywanie kopii zapasowych, należy upewnić się, że wszystkie urządzenia pamięci masowej są prawidłowo podłączone.",
    "admin.backup.bakFileTask"       => "Zadania zaplanowane – Kopia zapasowa danych (plik)",
    "admin.backup.full"              => "Pełna kopia zapasowa",
    "admin.backup.fullDesc"          => "Rozpocznij tworzenie kopii zapasowej od pierwszego pliku",
    "admin.backup.increment"         => "Przyrostowa kopia zapasowa",
    "admin.backup.incrementDesc"     => "Kontynuuj tworzenie kopii zapasowej na podstawie ostatniego zadania",
    "admin.backup.sameSkip"          => "(Pliki o tej samej nazwie zostaną zignorowane)",
    "admin.backup.clickDtl"          => "Kliknij, aby zobaczyć szczegóły",
    "admin.backup.ifBakFile"         => "Czy na pewno chcesz wykonać kopię zapasową swoich plików?",
    "admin.restore.ifRecDb"          => "Przywrócenie bazy danych zmieni bieżące dane systemowe. Czy na pewno chcesz to wykonać?",
    "admin.restore.ifRecFile"        => "Przywrócenie pliku zmieni bieżące dane systemowe. Czy na pewno chcesz to wykonać?",
    "admin.restore.fileRec"          => "Przywracanie plików",
    "admin.restore.importTips"       => "Ważne przypomnienie",
    "admin.restore.recType"          => "Przywróć zawartość",
    "admin.restore.recTypeDb"        => "Przywracanie bazy danych",
    "admin.restore.recTypeFile"      => "Przywracanie plików",
    "admin.restore.recFileDesc1"     => "Przywracanie plików polega na skopiowaniu plików z pamięci masowej kopii zapasowej do pamięci domyślnej na podstawie bieżących rekordów plików systemu w celu przywrócenia fizycznych plików systemu.",
    "admin.restore.recFileDesc2"     => "Uwaga: Kopiowanie podczas procesu przywracania zależy od rekordów plików w bieżącej bazie danych. Jeśli wiąże się to z ponowną instalacją systemu, należy najpierw przywrócić bazę danych.",
    "admin.restore.recFileDesc3"     => "Przywracanie plików jest operacją czasochłonną, zwłaszcza gdy wolumen danych jest duży lub dane są przechowywane w różnych magazynach. Prosimy o cierpliwość podczas wykonywania operacji.",
    "admin.restore.bakPath"          => "Katalog kopii zapasowych",
    "admin.restore.bakDbPath"        => "Katalog kopii zapasowej bazy danych",
    "admin.restore.bakFilePath"      => "Katalog kopii zapasowej plików",
    "admin.restore.full"             => "Pełne przywrócenie",
    "admin.restore.fullDesc"         => "Pełne przywracanie rozpocznie się od pierwszego pliku. W przeciwnym razie będzie kontynuowane od ostatniego zadania. Istniejące pliki zostaną zignorowane.",
    "admin.restore.needVipDesc"      => "Wersja bezpłatna obsługuje wyłącznie przywracanie bazy danych",
    "admin.restore.needVipTips"      => "Obecna wersja nie obsługuje tej operacji. Prosimy o uaktualnienie do wersji Enterprise Edition.",
    "admin.restore.bakEmpty"         => "Wybrany katalog kopii zapasowej jest pusty",
    "admin.restore.noFileNeed"       => "W systemie nie ma plików, które trzeba przywrócić",
    "admin.restore.taskRepeat"       => "Zadanie jest w trakcie realizacji, proszę nie powtarzać operacji",
 ...
 post_max_size, trzeba zrestartować)",
    ...
    "common.isOpen"                  => "Czy jest włączony?",
    ...
    "common.readWrite"               => "Czytelne i zapisywalne",
    "common.noAuth"                  => "Brak uprawnień",
    "common.site"                    => "Strona",
    ...
    "common.phyFileNotExists"        => "Brakuje plików fizycznych lub są one niedostępne!",
    ...
    "common.copyright.desc"          => "haisum to bardzo ceniony system zarządzania dokumentami sieciowymi, znany wcześniej jako KodExplorer, można go używać do wewnętrznego zarządzania dokumentami lub ich udostępniania, a także do zarządzania stronami internetowymi na serwerze. Jednocześnie możesz zintegrować wtórne opracowanie tego programu z istniejącym systemem.",
    ...
    "common.copyright.metaKeywords"  => "haisum, KodExplorer, kod, kodCloud, webos, webIDE, php filemanage, filemanage, Kedao Cloud, Mango Cloud, System zarządzania dokumentami, Enterprise Cloud Disk, Explorer, Dokumenty online, Biuro online, Biuro online, Podgląd CAD online, Edytor online, edytor online",
    ...
    "common.date.tomorrow"           => "jutro",
    "common.date.week"               => "w tym tygodniu",
    "common.date.weekNext"           => "przyszły tydzień",
    "common.date.weekPrev"           => "w zeszłym tygodniu",
    "common.date.month"              => "w tym miesiącu",
    "common.date.monthNext"          => "przyszły miesiąc",
    "common.date.monthPrev"          => "ostatni miesiąc",
    "common.date.day7"               => "ostatnie 7 dni",
    "common.date.day30"              => "Ostatnie 30 dni",
    "common.date.day90"              => "Ostatnie 90 dni",
    "common.date.day180"             => "Ostatnie 180 dni",
    ...
    "explorer.complete"              => "Operacja zakończona!",
    ...
    "explorer.wrtSetUserError"       => "Plik konfiguracyjny systemu (config/setting_user.php) nie ma uprawnień do zapisu!",
    ...
    "explorer.groupAuthFrom"         => "Źródło autoryzacji",
    "explorer.groupAuthCopy"         => "Kopiuj kombinację",
    "explorer.groupAuthCopyDesc"     => "Kopiuj kombinację",
    ...
    "explorer.folderPass.add"        => "Ustaw hasło do folderu",
    "explorer.folderPass.edit"       => "Edytuj hasło folderu",
    "explorer.folderPass.clearAsk"   => "Czy na pewno chcesz wyczyścić hasło do folderu?",
    "explorer.folderPass.hasDesc"    => "Ustawiono hasło folderu",
    "explorer.folderPass.pass"       => "hasło dostępu",
    "explorer.folderPass.passRepeat" => "Potwierdź hasło",
    "explorer.folderPass.desc"       => "Opis",
    "explorer.folderPass.timeOutDesc" => "Czas ważności hasła, jeśli nie jest ustawiony, oznacza, że będzie ono zawsze ważne.",
    "explorer.folderPass.timeOut"    => "Czas ważności",
 ...
 Wsparcie pinyin, rozmyte dopasowanie pierwszej litery",
    ...
    "explorer.upload.fopenError"     => "Zapis nie powiódł się. Sprawdź uprawnienia do odczytu i zapisu katalogu",
    ...
    "explorer.search.path"           => "Przeszukaj katalog",
    "explorer.search.rootPath"       => "katalog główny",
    ...
    "explorer.search.optionDesc"     => "Opis pliku",
    "explorer.search.optionTag"      => "Etykiety użytkownika/działu",
    ...
    "explorer.history.action"        => "Operacje w wersji historycznej",
    "explorer.history.remove"        => "Usuń wersję historyczną",
    ...
    "explorer.share.linkToFast"      => "Szybkie udostępnianie linków zewnętrznych",
    "explorer.share.shareSystem"     => "Udostępnianie systemu",
    "explorer.share.shareSystemDesc" => "Wspólne udostępnianie utworzone przez inne aplikacje lub wtyczki",
    ...
    "explorer.share.selfExit"        => "Wyjdź z tej współpracy",
    "explorer.share.selfExitConfirm" => "Czy na pewno chcesz zakończyć współpracę? Po jej zakończeniu nie będziesz mieć dostępu do treści objętych współpracą.",
    "explorer.shareOut.title"        => "Zewnętrzne dzielenie stawów",
    "explorer.shareOut.desc"         => "Udostępnianie treści pomiędzy różnymi lokalizacjami dysków sieciowych",
    "explorer.shareOut.titlePath"    => "Zewnętrzne dzielenie stawów",
    "explorer.shareOut.titlePathDesc" => "Treści udostępnione mi przez witryny zewnętrzne",
    "explorer.shareOut.sendDesc1"    => "Uprawnienia użytkownika końcowego odbierającego dane są uprawnieniami ustalonymi i nie są ograniczane przez prawa do udostępniania łączy zewnętrznych.",
    "explorer.shareOut.sendDesc2"    => "Główna wersja programu na dysku sieciowym musi być spójna, a druga strona musi mieć włączoną funkcję zewnętrznego wspólnego udostępniania i odbierania.",
    "explorer.shareOut.targetAdd"    => "Dodaj osoby, z którymi chcesz się podzielić",
    "explorer.shareOut.targetDel"    => "Potwierdź anulowanie udostępniania tego obiektu witryny",
    "explorer.shareOut.targetEdit"   => "Edytuj obiekty współdzielone",
    "explorer.shareOut.targetUrl"    => "Udostępnij witrynę",
    "explorer.shareOut.targetUrlDesc" => "Serwer witryny współdzielonej musi mieć możliwość dostępu do bieżącej witryny",
    "explorer.shareOut.targetName"   => "nazwa wyświetlana",
    "explorer.shareOut.targetNameDesc" => "Aliasy używane do wyświetlania obiektów współdzielonych",
    "explorer.shareOut.targetAuth"   => "Prawa dostępu",
    "explorer.shareOut.targetUser"   => "Podziel się z",
    "explorer.shareOut.targetUserDesc1" => "Konto użytkownika/pseudonim/adres e-mail/numer telefonu komórkowego",
    "explorer.shareOut.targetUserDesc2" => "Obsługuje specyfikację identyfikatora użytkownika, na przykład",
    "explorer.shareOut.targetUserDesc3" => "Na przykład specyfikacja identyfikatora działu wsparcia",
    "explorer.shareOut.siteAdd"      => "Szybkie dodawanie",
    "explorer.shareOut.configSend"   => "Zezwól na udostępnianie w witrynach zewnętrznych",
    "explorer.shareOut.configSendDesc" => "Po włączeniu obsługuje udostępnianie wyznaczonym kontom w innych witrynach dysków sieciowych podczas udostępniania łączy zewnętrznych i obsługuje ustawianie niezależnych uprawnień",
    "explorer.shareOut.configReceive" => "Zezwalaj na udostępnianie z witryn zewnętrznych",
    "explorer.shareOut.configReceiveDesc" => "Po otwarciu witryny zewnętrzne mogą przesyłać dane i udostępniać je bieżącej witrynie. Po zamknięciu dane nie będą już odbierane.",
    "explorer.shareOut.siteSafe"     => "Zaufana witryna",
    "explorer.shareOut.siteSafeDesc1" => "W przypadku korzystania z funkcji udostępniania zewnętrznego można uzyskać strukturę organizacyjną zaufanej witryny i szybko wybierać użytkowników i działy",
    "explorer.shareOut.siteSafeDesc2" => "Wersja programu dysku sieciowego musi być spójna, a druga witryna musi mieć włączoną funkcję zewnętrznego udostępniania wspólnego.",
    "explorer.shareOut.siteSafeDel"  => "Potwierdź usunięcie zaufanej witryny",
    "explorer.shareOut.siteSafeAdd"  => "Dodaj zaufaną witrynę",
    "explorer.shareOut.siteSafeEdit" => "Edytuj zaufaną witrynę",
    "explorer.shareOut.siteUrl"      => "Adres URL witryny",
    "explorer.shareOut.siteUrlDesc"  => "Adres URL witryny dysku sieciowego drugiej strony wymaga, aby bieżący serwer witryny dysku sieciowego mógł uzyskać do siebie dostęp",
    "explorer.shareOut.siteName"     => "Nazwa witryny",
    "explorer.shareOut.siteApiKey"   => "Klucz API witryny",
    "explorer.shareOut.siteApiKeyDesc" => "Klucz API witryny drugiej strony można uzyskać w tle witryny zaufanej: Ustawienia podstawowe – Udostępnianie linków zewnętrznych – Mój klucz API",
    "explorer.shareOut.siteApiKeySelf" => "Klucz API bieżącej witryny",
    "explorer.shareOut.siteApiKeySelfDesc1" => "Ten klucz API służy wyłącznie do wspólnego udostępniania w chmurze i dostępu do zaufanych witryn",
    "explorer.shareOut.errorNetwork" => "Żądanie nie powiodło się. Sprawdź, czy adres URL docelowego dysku sieciowego jest poprawny i czy jest dostępna najnowsza wersja.",
    "explorer.shareOut.errorTitle"   => "Błąd współdzielenia stawu zewnętrznego",
    "explorer.shareOut.errorDisableShare" => "Funkcja udostępniania linków zewnętrznych została zamknięta, skontaktuj się z administratorem!",
    "explorer.shareOut.errorDisableSend" => "Udostępnianie linków zewnętrznych — funkcja wspólnego udostępniania zewnętrznego nie jest włączona!",
    "explorer.shareOut.errorDisableReceive" => "Udostępnianie linków zewnętrznych — funkcja wspólnego udostępniania zewnętrznego nie jest włączona!",
    "explorer.shareOut.errorApiKey"  => "Klucz API witryny jest nieprawidłowy, wprowadź go ponownie!",
    "explorer.shareOut.errorTarget"  => "Obiekt docelowy nie istnieje. Potwierdź i spróbuj ponownie!",
    "explorer.shareOut.errorCallLimit" => "To żądanie jest zbyt częste, spróbuj ponownie później!",
    "explorer.shareOut.errorShareNotExist" => "Udział nie istnieje lub udział zewnętrzny został usunięty",
    "explorer.shareOut.errorShareAuth" => "Nie masz uprawnień dostępu do tego udostępnionego zasobu zewnętrznego! Skontaktuj się z administratorem witryny, z której pochodzi udostępniony zasob.",
    ...
    "explorer.auth.tabParentTips"    => "Użytkownik lub dział, który ma uprawnienia do tego folderu (odziedziczone ze wszystkich uprawnień wyższego poziomu)",
    ...
    "explorer.rename.title"          => "Możesz dodawać wiele razy, przeciągać i upuszczać (automatyczna deduplikacja) oraz wybierać metodę nazewnictwa w celu szybkiego przetwarzania wsadowego.",
    ...
    "explorer.rename.typeReplaceReg" => "Regularna wymiana",
    ...
    "explorer.rename.allowExt"       => "Czy wymienić rozszerzenie",
    ...
    "explorer.tag.default2"          => "Informacje o pracy",
    "explorer.tag.default3"          => "Dane osobowe",
    ...
    "explorer.secret.setUserDesc"    => "Określ użytkownika, który może ustawić poziom poufności (zaleca się, aby był to właściciel odpowiedniego działu)",
    ...
    "user.registNotAllow"            => "System nie jest otwarty na rejestrację, prosimy o kontakt z administratorem!",
    "user.deregistNotAllow"          => "System nie umożliwia rejestracji i nie obsługuje operacji wylogowania. Prosimy o kontakt z administratorem!",
    ...
    "log-event-history-remove"       => "Usunięto wersję historyczną [2] z [1]",
    "log-event-history-rollback"     => "Ustaw wersję historyczną [2] z [1] jako wersję bieżącą",
    "log-event-history-clear"        => "Usunięto wszystkie historyczne wersje [1]",
