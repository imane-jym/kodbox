...
<li> Intervallo IP: l'ip corrisponde all'intervallo; ad esempio: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.registNotSync"    => "Per evitare conflitti nei dati, la registrazione utente tramite haisum e quella tramite servizi di terze parti non possono essere abilitate contemporaneamente",
...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
 ...
 post_max_size, è necessario riavviare)",
    ...
    "common.copyright.desc"          => "haisum è un acclamato sistema di gestione online di file, precedentemente noto come KodExplorer. Con haisum è possibile gestire la condivisione interna ed esterna di qualsiasi tipo di file, nonché per la modifica di siti web direttamente online utilizzando un comodissimo quando funzionale web file editor. Questa è solo la punta dell'iceberg delle potenzialità di haisum!",
    ...
    "common.copyright.metaKeywords"  => "haisum, KodExplorer, kod, kodCloud, webos, webIDE, php filemanage, filemanage, Kedao Cloud, Mango Cloud, Sistema di gestione dei file, Enterprise Cloud Disk, Explorer, File online, Ufficio online, Ufficio online, Anteprima CAD online Editor online, editor online",
