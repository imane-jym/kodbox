...
return array(
    ...
    "admin.menu.server"              => "Layanan dan Peralatan",
    ...
    "admin.server.base"              => "Status Layanan",
    "admin.server.server"            => "Layanan Sistem",
    "admin.server.file"              => "Layanan Berkas",
    "admin.server.net"               => "Jaringan &amp; Konektivitas",
    ...
    "admin.setting.passwordRuleStrongDesc" => "Panjangnya tidak boleh kurang dari 6; harus mengandung angka dan huruf bahasa Inggris",
    "admin.setting.passwordRuleStrongMoreDesc" => "Panjangnya harus minimal 8 karakter; harus mengandung setidaknya 3 jenis kombinasi angka, huruf besar, huruf kecil, dan karakter khusus.",
...
<li> Rentang IP: kecocokan ip dalam rentang tersebut; misalnya: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo21"    => "Data sistem dapat dipulihkan dengan menulis data cadangan ke basis data baru dan menetapkannya sebagai default sistem.",
    "admin.setting.recDescInfo22"    => "Parameter konfigurasi basis data baru akan ditambahkan ke berkas konfigurasi sistem config/setting_user.php. Jika sistem mengalami pengecualian setelah pemulihan, Anda dapat menghapus bagian berkas yang ditambahkan tanpa memengaruhi data sistem sebelumnya.",
    ...
    "admin.setting.recDescInfo32"    => "Misalnya, jika konfigurasi basis data saat ini adalah: Pengguna: uji; Kata sandi: uji123, masuklah ke basis data menggunakan akun root dan jalankan pernyataan SQL yang sesuai untuk menetapkan izin (izin dapat dicabut setelah pengujian berhasil dan pemulihan berhasil).",
    ...
    "ERROR_USER_PASSWORD_MISSING"    => "Kata sandi hilang",
    ...
    "admin.authFrom.setUser"         => "Menentukan Izin Pengguna",
...
<li> Perbarui: Setelah mengunduh, unggah dan unzip ke folder nama plug-in yang sesuai;</li>",
    ...
    "admin.storage.errTimeout"       => "Permintaan layanan habis waktunya!",
    ...
    "admin.storage.groupDef"         => "Penyimpanan default",
    "admin.storage.groupLoc"         => "Penyimpanan Lokal",
    "admin.storage.groupObj"         => "Penyimpanan Objek",
    "admin.storage.groupNet"         => "Penyimpanan jaringan",
    "admin.storage.groupOth"         => "Penyimpanan lainnya",
    ...
    "admin.backup.open"              => "Aktifkan pencadangan",
    "admin.backup.openDesc"          => "Cadangkan database dan file sistem",
    ...
    "admin.backup.ifSave"            => "Apakah Anda yakin ingin membuat cadangan?",
    ...
    "admin.backup.optionTime"        => "Untuk menghindari dampak perubahan data, harap memilih untuk melakukan operasi di luar jam kerja.",
    "admin.backup.optionLocation"    => "Silakan buat penyimpanan independen baru khusus untuk pencadangan file",
    "admin.backup.optionTips1"       => "Pencadangan dibagi menjadi dua bagian: pencadangan basis data dan pencadangan berkas. Disarankan untuk mencadangkan keduanya.",
    "admin.backup.optionTips2"       => "Pencadangan basis data: Hasilkan file SQL dari konten basis data dan cadangkan ke penyimpanan target (penyimpanan default sistem hanya untuk basis data).",
    ...
    "admin.backup.needNoDefault"     => "Jangan pilih penyimpanan default sistem sebagai lokasi pencadangan file!",
    ...
    "admin.backup.freeBakDesc"       => "Versi gratis hanya mendukung pencadangan basis data",
    ...
    "admin.backup.taskDbDesc"        => "Cadangkan database sistem secara otomatis",
    "admin.backup.taskFileDesc"      => "Cadangkan file sistem secara otomatis",
    "admin.backup.addStoreHasFile"   => "Penyimpanan ini berisi data sistem, silakan migrasikan atau tambahkan penyimpanan baru terlebih dahulu!",
    "admin.backup.title"             => "Petunjuk pencadangan file",
    "admin.backup.bakFileTip1"       => "Pencadangan berkas merupakan tugas independen. Frekuensi eksekusi, progres, dan informasi lainnya tidak disertakan dalam pencadangan basis data. Untuk detail tugas, lihat %s.",
    "admin.backup.bakFileTip2"       => "Kemajuan pencadangan file (salinan) secara real-time dapat dilihat dalam %s;",
    "admin.backup.bakFileTip3"       => "Jika pencadangan gagal, Anda dapat melihat detailnya di log %s;",
    "admin.backup.bakFileTip4"       => "Kegagalan pencadangan biasanya disebabkan oleh koneksi penyimpanan yang tidak normal (tidak dapat membaca atau menulis berkas). Untuk memastikan pencadangan berjalan normal, pastikan semua perangkat penyimpanan terhubung dengan benar.",
    "admin.backup.bakFileTask"       => "Tugas Terjadwal - Pencadangan Data (File)",
    "admin.backup.full"              => "Cadangan penuh",
    "admin.backup.fullDesc"          => "Mulai mencadangkan dari file pertama",
    "admin.backup.increment"         => "Pencadangan tambahan",
    "admin.backup.incrementDesc"     => "Lanjutkan pencadangan berdasarkan tugas terakhir",
    "admin.backup.sameSkip"          => "(File dengan nama yang sama akan diabaikan)",
    "admin.backup.clickDtl"          => "Klik untuk melihat detailnya",
    "admin.backup.ifBakFile"         => "Apakah Anda yakin ingin mencadangkan berkas Anda?",
    "admin.restore.ifRecDb"          => "Pemulihan basis data akan mengubah data sistem saat ini. Apakah Anda yakin ingin menjalankannya?",
    "admin.restore.ifRecFile"        => "Pemulihan berkas akan mengubah data sistem saat ini. Apakah Anda yakin ingin menjalankannya?",
    "admin.restore.fileRec"          => "Pemulihan Berkas",
    "admin.restore.importTips"       => "Pengingat Penting",
    "admin.restore.recType"          => "Pulihkan konten",
    "admin.restore.recTypeDb"        => "Pemulihan basis data",
    "admin.restore.recTypeFile"      => "Pemulihan Berkas",
    "admin.restore.recFileDesc1"     => "Pemulihan berkas adalah menyalin berkas dari penyimpanan cadangan ke penyimpanan default berdasarkan catatan berkas sistem saat ini untuk memulihkan berkas fisik sistem.",
    "admin.restore.recFileDesc2"     => "Catatan: Penyalinan selama proses pemulihan bergantung pada rekaman berkas basis data saat ini. Jika melibatkan instalasi ulang sistem, Anda perlu memulihkan basis data terlebih dahulu.",
    "admin.restore.recFileDesc3"     => "Pemulihan berkas merupakan proses yang memakan waktu, terutama jika volume datanya besar atau terdapat banyak penyimpanan. Harap bersabar selama proses pemulihan.",
    "admin.restore.bakPath"          => "Direktori Cadangan",
    "admin.restore.bakDbPath"        => "Direktori cadangan basis data",
    "admin.restore.bakFilePath"      => "Direktori cadangan file",
    "admin.restore.full"             => "Pemulihan penuh",
    "admin.restore.fullDesc"         => "Pemulihan penuh dimulai dari berkas pertama, jika tidak, pemulihan akan dilanjutkan berdasarkan tugas terakhir. Berkas yang sudah ada akan diabaikan.",
    "admin.restore.needVipDesc"      => "Versi gratis hanya mendukung pemulihan basis data",
    "admin.restore.needVipTips"      => "Versi saat ini tidak mendukung operasi ini, silakan tingkatkan ke Edisi Perusahaan",
    "admin.restore.bakEmpty"         => "Direktori cadangan yang dipilih kosong",
    "admin.restore.noFileNeed"       => "Sistem tidak memiliki file yang perlu dipulihkan",
    "admin.restore.taskRepeat"       => "Tugas sedang berlangsung, mohon jangan mengulangi operasinya",
 ...
 post_max_size, perlu memulai ulang)",
    ...
    "common.isOpen"                  => "Apakah sudah diaktifkan?",
    ...
    "common.readWrite"               => "Dapat dibaca dan ditulis",
    "common.noAuth"                  => "Tidak ada izin",
    "common.site"                    => "Lokasi",
    ...
    "common.copyright.metaKeywords"  => "haisum, KodExplorer, kod, kodCloud, webos, webIDE, php filemanage, filemanage, Kedao Cloud, Mango Cloud, Sistem Manajemen Dokumen, Enterprise Cloud Disk, Explorer, Dokumen Online, Kantor Online, Kantor Online, Pratinjau CAD Online Editor online, editor online",
    ...
    "explorer.wrtSetUserError"       => "Berkas konfigurasi sistem (config/setting_user.php) tidak memiliki izin menulis!",
    ...
    "explorer.groupAuthFrom"         => "Sumber Otorisasi",
    "explorer.groupAuthCopy"         => "Salin kombinasi",
    "explorer.groupAuthCopyDesc"     => "Salin kombinasi",
 ...
 Mendukung pinyin, pencocokan fuzzy dari huruf pertama",
    ...
    "explorer.share.linkToFast"      => "Berbagi tautan eksternal dengan cepat",
    "explorer.share.shareSystem"     => "Berbagi Sistem",
    "explorer.share.shareSystemDesc" => "Berbagi kolaboratif yang dibuat oleh aplikasi atau plugin lain",
    ...
    "explorer.share.selfExit"        => "Keluar dari kolaborasi ini",
    "explorer.share.selfExitConfirm" => "Yakin ingin keluar dari kolaborasi? Anda tidak akan dapat lagi mengakses konten kolaborasi setelah keluar.",
    "explorer.shareOut.title"        => "Pembagian bersama eksternal",
    "explorer.shareOut.desc"         => "Berbagi konten antara situs disk jaringan yang berbeda",
    "explorer.shareOut.titlePath"    => "Pembagian bersama eksternal",
    "explorer.shareOut.titlePathDesc" => "Konten yang dibagikan kepada saya oleh situs eksternal",
    "explorer.shareOut.sendDesc1"    => "Hak pengguna akhir penerima adalah hak yang ditetapkan dan tidak terpengaruh oleh hak berbagi tautan eksternal.",
    "explorer.shareOut.sendDesc2"    => "Versi program utama dari disk jaringan harus konsisten, dan situs lainnya harus mengaktifkan fungsi berbagi bersama eksternal.",
    "explorer.shareOut.targetAdd"    => "Tambahkan orang untuk berbagi",
    "explorer.shareOut.targetDel"    => "Konfirmasi untuk membatalkan pembagian objek situs ini",
    "explorer.shareOut.targetEdit"   => "Edit Objek Bersama",
    "explorer.shareOut.targetUrl"    => "Bagikan Situs",
    "explorer.shareOut.targetUrlDesc" => "Server situs bersama harus dapat mengakses situs saat ini",
    "explorer.shareOut.targetName"   => "nama tampilan",
    "explorer.shareOut.targetNameDesc" => "Alias yang digunakan untuk menampilkan objek yang dibagikan",
    "explorer.shareOut.targetAuth"   => "Hak Akses",
    "explorer.shareOut.targetUser"   => "Bagikan dengan",
    "explorer.shareOut.targetUserDesc1" => "Akun pengguna/nama panggilan/alamat email/nomor ponsel",
    "explorer.shareOut.targetUserDesc2" => "Mendukung spesifikasi id pengguna, misalnya",
    "explorer.shareOut.targetUserDesc3" => "Spesifikasi id departemen dukungan, misalnya",
    "explorer.shareOut.siteAdd"      => "Tambah Cepat",
    "explorer.shareOut.configSend"   => "Izinkan berbagi ke situs eksternal",
    "explorer.shareOut.configSendDesc" => "Setelah diaktifkan, ini mendukung berbagi ke akun yang ditunjuk di situs disk jaringan lain saat berbagi tautan eksternal, dan mendukung pengaturan izin independen",
    "explorer.shareOut.configReceive" => "Izinkan berbagi dari situs eksternal",
    "explorer.shareOut.configReceiveDesc" => "Setelah dibuka, situs eksternal dapat mengirim dan membagikan ke situs saat ini. Setelah ditutup, situs tersebut tidak akan diterima lagi.",
    "explorer.shareOut.siteSafe"     => "Situs Tepercaya",
    "explorer.shareOut.siteSafeDesc1" => "Saat digunakan untuk berbagi bersama eksternal, Anda dapat memperoleh struktur organisasi situs tepercaya dan dengan cepat memilih pengguna dan departemen",
    "explorer.shareOut.siteSafeDesc2" => "Versi program disk jaringan harus konsisten, dan situs lainnya harus mengaktifkan fungsi berbagi dan penerimaan gabungan eksternal.",
    "explorer.shareOut.siteSafeDel"  => "Konfirmasi untuk menghapus situs tepercaya",
    "explorer.shareOut.siteSafeAdd"  => "Tambahkan situs tepercaya",
    "explorer.shareOut.siteSafeEdit" => "Edit Situs Tepercaya",
    "explorer.shareOut.siteUrl"      => "URL Situs",
    "explorer.shareOut.siteUrlDesc"  => "URL situs disk jaringan pihak lain memerlukan server situs disk jaringan saat ini agar dapat saling mengakses",
    "explorer.shareOut.siteName"     => "Nama Situs",
    "explorer.shareOut.siteApiKey"   => "Situs apiKey",
    "explorer.shareOut.siteApiKeyDesc" => "ApiKey situs pihak lain dapat diperoleh di latar belakang situs tepercaya: Pengaturan Dasar--Berbagi Tautan Eksternal--ApiKey Saya",
    "explorer.shareOut.siteApiKeySelf" => "apiKey situs saat ini",
    "explorer.shareOut.siteApiKeySelfDesc1" => "ApiKey ini hanya digunakan untuk berbagi cloud bersama dan akses situs tepercaya",
    "explorer.shareOut.errorNetwork" => "Permintaan gagal. Harap konfirmasi apakah URL disk jaringan target sudah benar dan versi terbaru.",
    "explorer.shareOut.errorTitle"   => "Kesalahan pembagian bersama eksternal",
    "explorer.shareOut.errorDisableShare" => "Fungsi berbagi tautan eksternal telah ditutup, silakan hubungi administrator!",
    "explorer.shareOut.errorDisableSend" => "Berbagi tautan eksternal-fungsi berbagi bersama eksternal tidak diaktifkan!",
    "explorer.shareOut.errorDisableReceive" => "Berbagi tautan eksternal-fungsi berbagi bersama eksternal tidak diaktifkan!",
    "explorer.shareOut.errorApiKey"  => "apiKey situs salah, silakan masukkan kembali!",
    "explorer.shareOut.errorTarget"  => "Objek target tidak ada. Harap konfirmasi dan coba lagi!",
    "explorer.shareOut.errorCallLimit" => "Permintaan terlalu sering, coba lagi nanti!",
    "explorer.shareOut.errorShareNotExist" => "Bagian tidak ada atau bagian eksternal telah dihapus",
    "explorer.shareOut.errorShareAuth" => "Anda tidak memiliki izin untuk mengakses share eksternal ini! Silakan hubungi administrator situs tempat share tersebut berasal.",
    ...
    "explorer.auth.tabParentTips"    => "Pengguna atau departemen yang memiliki izin untuk folder ini (diwarisi dari semua izin tingkat atas)",
    ...
    "explorer.tag.default2"          => "Informasi Pekerjaan",
    "explorer.tag.default3"          => "Data pribadi",
    ...
    "user.registNotAllow"            => "Sistem tidak terbuka untuk pendaftaran, silakan hubungi administrator!",
    "user.deregistNotAllow"          => "Sistem belum mengaktifkan registrasi dan tidak mendukung operasi logout. Silakan hubungi administrator!",
