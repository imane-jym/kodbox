...
return array(
    ...
    "admin.menu.server"              => "Dịch vụ và Thiết bị",
    ...
    "admin.server.base"              => "Trạng thái dịch vụ",
    "admin.server.server"            => "Dịch vụ hệ thống",
    "admin.server.file"              => "Dịch vụ tập tin",
    "admin.server.net"               => "Mạng &amp; Kết nối",
    ...
    "admin.setting.passwordRuleStrongDesc" => "Chiều dài không được nhỏ hơn 6; phải chứa số và chữ cái tiếng Anh",
    "admin.setting.passwordRuleStrongMoreDesc" => "Độ dài phải ít nhất là 8 ký tự; phải chứa ít nhất 3 loại kết hợp của số, chữ hoa, chữ thường và ký tự đặc biệt.",
...
<li> Dải IP: ip khớp trong dải; ví dụ: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo21"    => "Dữ liệu hệ thống có thể được khôi phục bằng cách ghi dữ liệu sao lưu vào cơ sở dữ liệu mới và đặt làm cơ sở dữ liệu mặc định của hệ thống.",
    "admin.setting.recDescInfo22"    => "Các tham số cấu hình cơ sở dữ liệu mới sẽ được thêm vào tệp cấu hình hệ thống config/setting_user.php. Nếu hệ thống gặp lỗi sau khi khôi phục, bạn có thể xóa phần đã thêm vào của tệp mà không ảnh hưởng đến dữ liệu hệ thống trước đó.",
    ...
    "admin.setting.recDescInfo32"    => "Ví dụ, nếu cấu hình cơ sở dữ liệu hiện tại là: Người dùng: test; Mật khẩu: test123, hãy đăng nhập vào cơ sở dữ liệu bằng tài khoản root và thực thi câu lệnh SQL tương ứng để thiết lập quyền (có thể thu hồi quyền sau khi thử nghiệm thành công và khôi phục thành công).",
    ...
    "ERROR_USER_PASSWORD_MISSING"    => "Thiếu mật khẩu",
    ...
    "admin.authFrom.setUser"         => "Chỉ định Quyền của Người dùng",
...
<li> Cập nhật: Sau khi tải xuống, tải lên và giải nén vào thư mục tên trình cắm tương ứng;</li>",
    ...
    "admin.storage.errTimeout"       => "Yêu cầu dịch vụ đã hết thời gian!",
    ...
    "admin.storage.groupDef"         => "Lưu trữ mặc định",
    "admin.storage.groupLoc"         => "Lưu trữ cục bộ",
    "admin.storage.groupObj"         => "Lưu trữ đối tượng",
    "admin.storage.groupNet"         => "Lưu trữ mạng",
    "admin.storage.groupOth"         => "Lưu trữ khác",
    ...
    "admin.backup.openDesc"          => "Sao lưu cơ sở dữ liệu và tệp hệ thống",
    ...
    "admin.backup.ifSave"            => "Bạn có chắc chắn muốn sao lưu không?",
    ...
    "admin.backup.optionTime"        => "Để tránh tác động của việc thay đổi dữ liệu, vui lòng chọn thực hiện thao tác ngoài giờ làm việc.",
    "admin.backup.optionLocation"    => "Vui lòng tạo một bộ lưu trữ độc lập mới dành riêng cho việc sao lưu tệp",
    "admin.backup.optionTips1"       => "Bản sao lưu được chia thành hai phần: sao lưu cơ sở dữ liệu và sao lưu tệp. Khuyến nghị nên sao lưu cả hai.",
    "admin.backup.optionTips2"       => "Sao lưu cơ sở dữ liệu: Tạo tệp SQL từ nội dung cơ sở dữ liệu và sao lưu vào bộ lưu trữ đích (bộ lưu trữ mặc định của hệ thống chỉ dành cho cơ sở dữ liệu).",
    ...
    "admin.backup.needNoDefault"     => "Không chọn bộ nhớ mặc định của hệ thống làm vị trí sao lưu tệp!",
    ...
    "admin.backup.freeBakDesc"       => "Phiên bản miễn phí chỉ hỗ trợ sao lưu cơ sở dữ liệu",
    ...
    "admin.backup.taskDbDesc"        => "Tự động sao lưu cơ sở dữ liệu hệ thống",
    "admin.backup.taskFileDesc"      => "Tự động sao lưu các tập tin hệ thống",
    "admin.backup.addStoreHasFile"   => "Bộ lưu trữ này chứa dữ liệu hệ thống, vui lòng di chuyển hoặc thêm bộ lưu trữ mới trước!",
    "admin.backup.title"             => "Hướng dẫn sao lưu tập tin",
    "admin.backup.bakFileTip1"       => "Sao lưu tệp là một tác vụ độc lập. Tần suất thực hiện, tiến độ và các thông tin khác của tác vụ này không được bao gồm trong sao lưu cơ sở dữ liệu. Để biết chi tiết về tác vụ, hãy xem %s.",
    "admin.backup.bakFileTip2"       => "Tiến trình sao lưu tệp (sao chép) theo thời gian thực có thể được xem trong %s;",
    "admin.backup.bakFileTip3"       => "Nếu sao lưu không thành công, bạn có thể xem thông tin chi tiết trong nhật ký %s;",
    "admin.backup.bakFileTip4"       => "Lỗi sao lưu thường do kết nối lưu trữ bất thường (không thể đọc hoặc ghi tệp). Để đảm bảo quá trình sao lưu diễn ra bình thường, vui lòng đảm bảo tất cả các thiết bị lưu trữ được kết nối đúng cách.",
    "admin.backup.bakFileTask"       => "Nhiệm vụ theo lịch trình - Sao lưu dữ liệu (Tệp)",
    "admin.backup.full"              => "Sao lưu đầy đủ",
    "admin.backup.fullDesc"          => "Bắt đầu sao lưu từ tệp đầu tiên",
    "admin.backup.increment"         => "Sao lưu gia tăng",
    "admin.backup.incrementDesc"     => "Tiếp tục sao lưu dựa trên tác vụ cuối cùng",
    "admin.backup.sameSkip"          => "(Các tập tin có cùng tên sẽ bị bỏ qua)",
    "admin.backup.clickDtl"          => "Nhấp để xem chi tiết",
    "admin.backup.ifBakFile"         => "Bạn có chắc chắn muốn sao lưu các tập tin của mình không?",
    "admin.restore.ifRecDb"          => "Khôi phục cơ sở dữ liệu sẽ thay đổi dữ liệu hệ thống hiện tại. Bạn có chắc chắn muốn thực hiện không?",
    "admin.restore.ifRecFile"        => "Khôi phục tệp sẽ thay đổi dữ liệu hệ thống hiện tại. Bạn có chắc chắn muốn thực hiện không?",
    "admin.restore.fileRec"          => "Khôi phục tập tin",
    "admin.restore.importTips"       => "Lời nhắc nhở quan trọng",
    "admin.restore.recType"          => "Khôi phục nội dung",
    "admin.restore.recTypeDb"        => "Khôi phục cơ sở dữ liệu",
    "admin.restore.recTypeFile"      => "Khôi phục tập tin",
    "admin.restore.recFileDesc1"     => "Khôi phục tệp là sao chép tệp từ bộ lưu trữ sao lưu sang bộ lưu trữ mặc định dựa trên các bản ghi tệp của hệ thống hiện tại để khôi phục các tệp vật lý của hệ thống.",
    "admin.restore.recFileDesc2"     => "Lưu ý: Việc sao chép trong quá trình khôi phục phụ thuộc vào các bản ghi tệp của cơ sở dữ liệu hiện tại. Nếu cần cài đặt lại hệ thống, bạn cần khôi phục cơ sở dữ liệu trước.",
    "admin.restore.recFileDesc3"     => "Khôi phục tập tin là một thao tác tốn thời gian, đặc biệt khi khối lượng dữ liệu lớn hoặc lưu trữ chéo. Vui lòng kiên nhẫn trong quá trình thực hiện.",
    "admin.restore.bakPath"          => "Thư mục sao lưu",
    "admin.restore.bakDbPath"        => "Thư mục sao lưu cơ sở dữ liệu",
    "admin.restore.bakFilePath"      => "Thư mục sao lưu tập tin",
    "admin.restore.full"             => "Khôi phục hoàn toàn",
    "admin.restore.fullDesc"         => "Khôi phục hoàn toàn sẽ bắt đầu từ tệp đầu tiên, nếu không, nó sẽ tiếp tục dựa trên tác vụ cuối cùng. Các tệp hiện có sẽ bị bỏ qua.",
    "admin.restore.needVipDesc"      => "Phiên bản miễn phí chỉ hỗ trợ khôi phục cơ sở dữ liệu",
    "admin.restore.needVipTips"      => "Phiên bản hiện tại không hỗ trợ thao tác này, vui lòng nâng cấp lên Phiên bản Doanh nghiệp",
    "admin.restore.bakEmpty"         => "Thư mục sao lưu đã chọn đang trống",
    "admin.restore.noFileNeed"       => "Hệ thống không có tập tin nào cần được khôi phục",
    "admin.restore.taskRepeat"       => "Nhiệm vụ đang được tiến hành, vui lòng không lặp lại thao tác",
 ...
 post_max_size, cần khởi động lại)",
    ...
    "common.isOpen"                  => "Có được kích hoạt không?",
    ...
    "common.readWrite"               => "Có thể đọc và ghi được",
    "common.noAuth"                  => "Không có quyền",
    "common.site"                    => "Địa điểm",
    ...
    "common.copyright.desc"          => "haisum là một hệ thống quản lý tài liệu web rất được hoan nghênh, trước đây gọi là KodExplorer, bạn có thể sử dụng nó để quản lý hoặc chia sẻ tài liệu nội bộ, cũng như để quản lý các trang web trên máy chủ. Thay vì Ftp, bạn thậm chí có thể phát triển trực tiếp dưới dạng webIDE. Đồng thời, bạn có thể tích hợp sự phát triển thứ cấp của chương trình này vào hệ thống hiện tại của bạn.",
    ...
    "common.copyright.metaKeywords"  => "haisum, KodExplorer, kod, kodCloud, webos, webIDE, php filemanage, filemanage, Kedao Cloud, Mango Cloud, Document Management System, Enterprise Cloud Disk, Explorer, Online Documents, Online Office, Online Office, Online CAD Preview, Biên tập trực tuyến, biên tập trực tuyến",
    ...
    "explorer.wrtSetUserError"       => "Tệp cấu hình hệ thống (config/setting_user.php) không có quyền ghi!",
    ...
    "explorer.groupAuthFrom"         => "Nguồn ủy quyền",
    "explorer.groupAuthCopy"         => "Sao chép kết hợp",
    "explorer.groupAuthCopyDesc"     => "Sao chép kết hợp",
 ...
 Hỗ trợ bính âm, so khớp mờ của chữ cái đầu tiên",
    ...
    "explorer.share.linkToFast"      => "Chia sẻ liên kết ngoài nhanh chóng",
    "explorer.share.shareSystem"     => "Chia sẻ hệ thống",
    "explorer.share.shareSystemDesc" => "Chia sẻ cộng tác được tạo bởi các ứng dụng hoặc plugin khác",
    ...
    "explorer.share.selfExit"        => "Thoát khỏi sự hợp tác này",
    "explorer.share.selfExitConfirm" => "Bạn có chắc chắn muốn thoát khỏi chế độ cộng tác không? Bạn sẽ không thể truy cập nội dung cộng tác sau khi thoát.",
    "explorer.shareOut.title"        => "Chia sẻ chung bên ngoài",
    "explorer.shareOut.desc"         => "Chia sẻ nội dung giữa các trang đĩa mạng khác nhau",
    "explorer.shareOut.titlePath"    => "Chia sẻ chung bên ngoài",
    "explorer.shareOut.titlePathDesc" => "Nội dung được chia sẻ với tôi bởi các trang web bên ngoài",
    "explorer.shareOut.sendDesc1"    => "Quyền của người dùng cuối nhận được là quyền đã thiết lập và không bị ảnh hưởng bởi quyền chia sẻ liên kết bên ngoài.",
    "explorer.shareOut.sendDesc2"    => "Phiên bản chương trình chính của đĩa mạng phải nhất quán và trang web khác phải bật chức năng chia sẻ và nhận kết nối bên ngoài.",
    "explorer.shareOut.targetAdd"    => "Thêm người để chia sẻ cùng",
    "explorer.shareOut.targetDel"    => "Xác nhận hủy chia sẻ đối tượng trang web này",
    "explorer.shareOut.targetEdit"   => "Chỉnh sửa Đối tượng được chia sẻ",
    "explorer.shareOut.targetUrl"    => "Chia sẻ trang web",
    "explorer.shareOut.targetUrlDesc" => "Máy chủ trang web chia sẻ cần có khả năng truy cập vào trang web hiện tại",
    "explorer.shareOut.targetName"   => "tên hiển thị",
    "explorer.shareOut.targetNameDesc" => "Bí danh được sử dụng để hiển thị các đối tượng được chia sẻ",
    "explorer.shareOut.targetAuth"   => "Quyền truy cập",
    "explorer.shareOut.targetUser"   => "Chia sẻ với",
    "explorer.shareOut.targetUserDesc1" => "Tài khoản người dùng/biệt danh/địa chỉ email/số điện thoại di động",
    "explorer.shareOut.targetUserDesc2" => "Hỗ trợ thông số ID người dùng, ví dụ",
    "explorer.shareOut.targetUserDesc3" => "Ví dụ, thông số kỹ thuật của bộ phận hỗ trợ",
    "explorer.shareOut.siteAdd"      => "Thêm nhanh",
    "explorer.shareOut.configSend"   => "Cho phép chia sẻ tới các trang web bên ngoài",
    "explorer.shareOut.configSendDesc" => "Sau khi bật, nó hỗ trợ chia sẻ tới các tài khoản được chỉ định trên các trang đĩa mạng khác khi chia sẻ liên kết bên ngoài và hỗ trợ thiết lập các quyền độc lập",
    "explorer.shareOut.configReceive" => "Cho phép chia sẻ từ các trang web bên ngoài",
    "explorer.shareOut.configReceiveDesc" => "Sau khi mở, các trang web bên ngoài có thể đẩy và chia sẻ lên trang web hiện tại. Sau khi đóng, sẽ không còn nhận được nữa.",
    "explorer.shareOut.siteSafe"     => "Trang web đáng tin cậy",
    "explorer.shareOut.siteSafeDesc1" => "Khi được sử dụng để chia sẻ chung bên ngoài, bạn có thể có được cấu trúc tổ chức của trang web đáng tin cậy và nhanh chóng chọn người dùng và phòng ban",
    "explorer.shareOut.siteSafeDesc2" => "Phiên bản chương trình đĩa mạng phải nhất quán và trang web kia phải bật chức năng chia sẻ chung bên ngoài.",
    "explorer.shareOut.siteSafeDel"  => "Xác nhận xóa trang web đáng tin cậy",
    "explorer.shareOut.siteSafeAdd"  => "Thêm một trang web đáng tin cậy",
    "explorer.shareOut.siteSafeEdit" => "Chỉnh sửa trang web đáng tin cậy",
    "explorer.shareOut.siteUrl"      => "URL trang web",
    "explorer.shareOut.siteUrlDesc"  => "URL trang web đĩa mạng của bên kia yêu cầu máy chủ trang web đĩa mạng hiện tại có thể truy cập lẫn nhau",
    "explorer.shareOut.siteName"     => "Tên trang web",
    "explorer.shareOut.siteApiKey"   => "Khóa api trang web",
    "explorer.shareOut.siteApiKeyDesc" => "Có thể lấy apiKey của trang web bên kia trong nền của trang web đáng tin cậy: Cài đặt cơ bản--Chia sẻ liên kết ngoài--ApiKey của tôi",
    "explorer.shareOut.siteApiKeySelf" => "apiKey của trang web hiện tại",
    "explorer.shareOut.siteApiKeySelfDesc1" => "ApiKey này chỉ được sử dụng để chia sẻ đám mây chung và truy cập trang web đáng tin cậy",
    "explorer.shareOut.errorNetwork" => "Yêu cầu không thành công. Vui lòng xác nhận xem URL đĩa mạng đích có chính xác và phiên bản mới nhất không.",
    "explorer.shareOut.errorTitle"   => "Lỗi chia sẻ khớp nối bên ngoài",
    "explorer.shareOut.errorDisableShare" => "Chức năng chia sẻ liên kết bên ngoài đã bị đóng, vui lòng liên hệ với quản trị viên!",
    "explorer.shareOut.errorDisableSend" => "Chia sẻ liên kết ngoài - chức năng chia sẻ liên kết ngoài không được bật!",
    "explorer.shareOut.errorDisableReceive" => "Chia sẻ liên kết ngoài - chức năng chia sẻ liên kết ngoài không được bật!",
    "explorer.shareOut.errorApiKey"  => "Khóa apiKey của trang web không chính xác, vui lòng nhập lại!",
    "explorer.shareOut.errorTarget"  => "Đối tượng mục tiêu không tồn tại. Vui lòng xác nhận và thử lại!",
    "explorer.shareOut.errorCallLimit" => "Yêu cầu quá thường xuyên, vui lòng thử lại sau!",
    "explorer.shareOut.errorShareNotExist" => "Chia sẻ không tồn tại hoặc chia sẻ bên ngoài đã bị xóa",
    "explorer.shareOut.errorShareAuth" => "Bạn không có quyền truy cập vào chia sẻ bên ngoài này! Vui lòng liên hệ với quản trị viên của trang web nơi chia sẻ này được tạo ra.",
    ...
    "explorer.auth.tabParentTips"    => "Người dùng hoặc phòng ban có quyền đối với thư mục này (thừa hưởng từ tất cả các quyền cấp cao hơn)",
    ...
    "explorer.tag.default2"          => "Thông tin công việc",
    "explorer.tag.default3"          => "Dữ liệu cá nhân",
    ...
    "user.registNotAllow"            => "Hệ thống không mở để đăng ký, vui lòng liên hệ với quản trị viên!",
    "user.deregistNotAllow"          => "Hệ thống chưa bật tính năng đăng ký và không hỗ trợ thao tác đăng xuất. Vui lòng liên hệ với quản trị viên!",
