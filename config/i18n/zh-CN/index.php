...
return array(
    ...
    "admin.menu.server"              => "服务与设备",
    "admin.menu.backup"              => "备份管理",
    "admin.menu.share"               => "分享管理",
    "admin.menu.loginLog"            => "登录日志",
    "admin.menu.log"                 => "操作日志",
    "admin.server.base"              => "服务状态",
    "admin.server.server"            => "系统服务",
    "admin.server.file"              => "文件服务",
    "admin.server.net"               => "网络与连接",
    ...
    "admin.index.scoreDesc"          => "下列因素将影响系统评分，可自行优化，以保证系统良好运行：<br/>1.系统磁盘、网盘存储的剩余空间；<br/>2.数据缓存方式（推荐redis）;<br/>3.php平台版本（推荐64位php8+）。",
    ...
    "admin.setting.passwordRuleStrongDesc" => "长度不小于6；必须包含数字、英文字母",
    "admin.setting.passwordRuleStrongMoreDesc" => "长度不小于8；必须包含数字、大写字母、小写字母、特殊字符中的至少3类组合",
...
<li>IP区间段: ip在区间内则匹配;例如:192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo21"    => "通过将备份数据写入至新的数据库，并将其设为系统默认，实现系统数据的还原。",
    "admin.setting.recDescInfo22"    => "新的数据库配置参数，将追加到系统配置文件 config/setting_user.php 中，如果执行还原后系统出现异常，可去掉文件中追加的部分，不影响此前的系统数据。",
    ...
    "admin.setting.recDescInfo32"    => "如当前数据库配置信息为：用户:test; 密码:test123。使用root账号登录数据库，执行相应SQL语句设置权限（检测通过并还原成功后可撤销权限）。",
    ...
    "ERROR_USER_PASSWORD_MISSING"    => "密码缺失",
    ...
    "admin.plugin.closedError"       => "插件尚未启用，请联系管理员！",
    ...
    "admin.storage.errTimeout"       => "服务请求超时！",
    ...
    "admin.storage.ossKeyDesc"       => "Access Key ID，请在【控制台-Access Key管理】中创建或查看",
    "admin.storage.ossEndpoint"      => "Endpoint，如使用内网节点，需开启服务器中转",
    "admin.storage.cosKeyDesc"       => "Access Key ID，请在【控制台-访问管理-API秘钥管理】中创建或查看",
    "admin.storage.qiniuDomain"      => "七牛空间绑定的域名",
    "admin.storage.qiniuKeyDesc"     => "Access Key，请在【控制台-个人中心-密钥管理】中创建或查看",
    "admin.storage.qiniuSecretDesc"  => "Secret Key，获取方法同上",
    ...
    "admin.storage.awsKeyDesc"       => "Access Key ID，请在【控制台-您的安全凭证】中创建",
    "admin.storage.oosDomain"        => "天翼云空间绑定的域名",
    "admin.storage.oosKeyDesc"       => "Access Key ID，请在【控制台-Access Key管理】中创建",
    "admin.storage.obsKeyDesc"       => "Access Key ID，请在【控制台-我的凭证-API凭证】中创建或查看",
    "admin.storage.bosKeyDesc"       => "Access Key ID，请在【控制台-安全认证-Access Key】中创建或查看",
    "admin.storage.josKeyDesc"       => "Access Key ID，请在【控制台-Access Key管理】中创建或查看",
    "admin.storage.secretDesc"       => "Access Key Secret，获取方法同上",
    ...
    "admin.storage.ftpBsPathErr"     => "尝试使用 [0] 作为存储目录.",
    ...
    "admin.storage.minioErr404"      => "访问对象不存在，请检查Bucket是否正确。",
    "admin.storage.minioRgnDesc"     => "根据实际配置填写，未配置无需填写",
    "admin.storage.s3SignVer"        => "签名版本",
    "admin.storage.s3SignVerDesc"    => "身份验证签名版本",
    "admin.storage.s3FormUpload"     => "表单上传",
    "admin.storage.s3FormUploadDesc" => "部分存储服务不支持此功能，前端直传时10MB以下文件会上传失败，可关闭此项",
    "admin.storage.ioReset"          => "指定存储位置",
    "admin.storage.ioResetDesc"      => "为空则使用当前默认存储中, 仅影响修改后上传文件的默认存储位置",
    "admin.storage.groupDef"         => "默认存储",
    "admin.storage.groupLoc"         => "本地存储",
    "admin.storage.groupObj"         => "对象存储",
    "admin.storage.groupNet"         => "网络存储",
    "admin.storage.groupOth"         => "其它存储",
    ...
    "admin.install.dbWasSet"         => "系统数据库已配置，如需重置，可删除配置文件config/setting_user.php后重新安装！",
    ...
    "admin.install.envReqErr"        => "请求异常，请检查web环境！",
    "admin.install.pageError"        => "页面出现错误，请检查系统文件是否正常加载，是否受浏览器及其插件影响（推荐使用Chrome,Firefox等浏览器）",
    ...
    "admin.backup.open"              => "启用备份",
    "admin.backup.openDesc"          => "备份系统数据库及文件",
    ...
    "admin.backup.timeNote"          => "说明：系统仅保留最近7天，及每月1号的数据库备份。备份时间：",
    "admin.backup.recover"           => "数据恢复请联系服务商。",
    "admin.backup.optionTime"        => "为避免数据变更影响，请选择在非工作时间段进行",
    "admin.backup.optionLocation"    => "请新建一个独立存储专门用于文件备份",
    "admin.backup.optionTips1"       => "备份分为数据库和文件备份两部分，建议全部备份。",
    "admin.backup.optionTips2"       => "数据库备份：将数据库内容生成SQL文件，备份至目标存储（仅数据库时为系统默认存储）。",
    "admin.backup.optionTips3"       => "文件备份：将系统存储文件，按原存储路径增量备份至目标存储。",
    "admin.backup.optionTips4"       => "系统仅保留最近7天，及每月1号的数据库备份。",
    ...
    "admin.backup.freeBakDesc"       => "免费版仅支持备份数据库",
    ...
    "admin.backup.taskDbDesc"        => "自动备份系统数据库",
    "admin.backup.taskFileDesc"      => "自动备份系统文件",
    "admin.backup.addStoreHasFile"   => "该存储中包含系统数据，请先迁移或新增存储！",
    "admin.backup.title"             => "文件备份说明",
    "admin.backup.bakFileTip1"       => "文件备份为独立任务，其执行频率、进度等信息不跟随数据库备份，任务详情见 %s;",
    "admin.backup.bakFileTip2"       => "文件备份（复制）实时进度可在 %s 中查看；",
    "admin.backup.bakFileTip3"       => "如果备份失败，可在日志%s中查看详情；",
    "admin.backup.bakFileTip4"       => "造成备份失败的原因一般为存储连接异常（无法读取/写入文件）。为保障备份正常执行，请确保各存储能够正常连接。",
    "admin.backup.bakFileTask"       => "计划任务-数据备份（文件）",
    "admin.backup.full"              => "全量备份",
    "admin.backup.fullDesc"          => "从第1个文件开始备份",
    "admin.backup.increment"         => "增量备份",
    "admin.backup.incrementDesc"     => "在上次任务的基础上继续备份",
    "admin.backup.sameSkip"          => "（同名文件将忽略）",
    "admin.backup.clickDtl"          => "点击查看详情",
    "admin.backup.ifBakFile"         => "确定要进行文件备份吗？",
    "admin.restore.ifRecDb"          => "数据库还原将会更改当前系统数据，确定要执行吗？",
    "admin.restore.ifRecFile"        => "文件还原将会更改当前系统数据，确定要执行吗？",
    "admin.restore.fileRec"          => "文件还原",
    "admin.restore.importTips"       => "重要提醒",
    "admin.restore.recType"          => "还原内容",
    "admin.restore.recTypeDb"        => "数据库还原",
    "admin.restore.recTypeFile"      => "文件还原",
    "admin.restore.recFileDesc1"     => "文件还原是根据当前系统的文件记录将文件从备份存储复制到默认存储，实现系统物理文件的还原。",
    "admin.restore.recFileDesc2"     => "注意：还原中的复制依赖于当前数据库的文件记录，如果涉及系统重装，需要先进行数据库还原。",
    "admin.restore.recFileDesc3"     => "文件还原是一个耗时操作，尤其是数据量大、跨存储的情况下，执行过程中请耐心等待。",
    "admin.restore.bakPath"          => "备份目录",
    "admin.restore.bakDbPath"        => "数据库备份目录",
    "admin.restore.bakFilePath"      => "文件备份目录",
    "admin.restore.full"             => "全量还原",
    "admin.restore.fullDesc"         => "全量还原从第1个文件开始，否则在上次任务的基础上继续。已存在文件将忽略",
    "admin.restore.needVipDesc"      => "免费版仅支持数据库还原",
    "admin.restore.needVipTips"      => "当前版本不支持此操作，请升级到企业版",
    "admin.restore.bakEmpty"         => "所选备份目录为空",
    "admin.restore.noFileNeed"       => "系统没有需要还原的文件",
    "admin.restore.taskRepeat"       => "任务正在进行中，请勿重复操作",
...
post_max_size,需要重启)",
    ...
    "common.readWrite"               => "可读写",
    "common.noAuth"                  => "无权限",
    "common.site"                    => "站点",
    "common.ifDel"                   => "确定要删除吗？",
    "common.pageNotExists"           => "该页面不存在!",
    "common.pathNotExists"           => "该文档不存在！",
    "common.phyFileNotExists"        => "物理文件缺失或无法访问！",
    ...
    "common.copyright.formPowerBy"   => "haisum",
    ...
    "common.copyright.desc"          => "海诚云是业内领先的政务/企业私有云和在线文档管理系统，为个人网站、企业私有云部署、网络存储、在线文档管理、在线办公等提供安全可控，简便易用、可高度定制的私有云产品。采用windows风格界面、操作习惯，无需适应即可快速上手，支持几百种常用文件格式的在线预览、播放和编辑，环境友好，功能强大，是一款一经试用，就再也离不开的私有云产品。同时你也可以将此程序二次开发整合到你现有的系统。",
    ...
    "common.copyright.nameTitle"     => "海诚云",
    "common.copyright.nameDesc"      => "海诚云•资源管理器",
    "common.copyright.powerBy"       => "Powered by haisum",
    "common.copyright.metaKeywords"  => "haisum,KodExplorer,kod,kodCloud,webos,webIDE,php filemanage,filemanage,可道云,芒果云,文档管理系统,企业云盘,资源管理器,,在线文档,在线Office,在线办公,在线CAD预览,在线编辑,在线编辑器",
    ...
    "common.date.week"               => "本周",
    "common.date.weekNext"           => "下周",
    "common.date.weekPrev"           => "上周",
    "common.date.month"              => "本月",
    "common.date.monthNext"          => "下月",
    ...
    "explorer.wrtSetUserError"       => "系统配置文件(config/setting_user.php)没有写入权限！",
    ...
    "explorer.inputSearchWords"      => "输入关键词搜索",
    ...
    "explorer.groupAuthFrom"         => "权限来源",
    "explorer.groupAuthCopy"         => "复制组合",
    "explorer.groupAuthCopyDesc"     => "复制组合",
    ...
    "explorer.folderPass.add"        => "设置文件夹密码",
    "explorer.folderPass.edit"       => "编辑文件夹密码",
    "explorer.folderPass.clearAsk"   => "确定清除文件夹密码吗？",
    "explorer.folderPass.hasDesc"    => "已设置文件夹密码",
    "explorer.folderPass.pass"       => "访问密码",
    "explorer.folderPass.passRepeat" => "确认密码",
    "explorer.folderPass.desc"       => "描述说明",
    "explorer.folderPass.timeOutDesc" => "密码过期时间,不设置则代表一直有效",
    "explorer.folderPass.timeOut"    => "过期时间",
    "explorer.folderPass.btnReset"   => "重置密码",
    "explorer.folderPass.btnClear"   => "移除密码",
    "explorer.folderPass.tips"       => "文件夹需要密码访问,请输入密码后继续.",
    "explorer.folderPass.tipsHas"    => "子内容包含需要密码访问的文件夹,请进入并输入密码后继续.",
...
支持拼音、首字母模糊匹配",
    ...
    "explorer.upload.fopenError"     => "写入失败，检查目录读写权限",
    ...
    "explorer.search.optionTag"      => "用户/部门标签",
    ...
    "explorer.history.action"        => "历史版本操作",
    "explorer.history.remove"        => "历史版本删除",
    ...
    "explorer.share.linkToFast"      => "快速外链分享",
    "explorer.share.shareSystem"     => "系统分享",
    "explorer.share.shareSystemDesc" => "其他应用或插件创建的协作分享",
    ...
    "explorer.share.selfExit"        => "退出该协作",
    "explorer.share.selfExitConfirm" => "确定退出协作?,退出后将无法再访问该协作内容.",
    "explorer.shareOut.title"        => "对外联合分享",
    "explorer.shareOut.desc"         => "不同网盘站点之间相互分享内容",
    "explorer.shareOut.titlePath"    => "外部联合分享",
    "explorer.shareOut.titlePathDesc" => "外部站点分享给我的内容",
    "explorer.shareOut.sendDesc1"    => "接收端用户权为设置的权限,不受外链分享的权限影响",
    "explorer.shareOut.sendDesc2"    => "需要网盘主程序版本一致,且对方站点开启了对外联合分享接收功能",
    "explorer.shareOut.targetAdd"    => "添加分享对象",
    "explorer.shareOut.targetDel"    => "确定取消对该站点对象的分享",
    "explorer.shareOut.targetEdit"   => "编辑享对象",
    "explorer.shareOut.targetUrl"    => "分享站点",
    "explorer.shareOut.targetUrlDesc" => "分享到的站点服务器需要能够访问当前站点",
    "explorer.shareOut.targetName"   => "显示名称",
    "explorer.shareOut.targetNameDesc" => "用于显示分享对象的别名",
    "explorer.shareOut.targetAuth"   => "访问权限",
    "explorer.shareOut.targetUser"   => "分享对象",
    "explorer.shareOut.targetUserDesc1" => "用户账号/昵称/邮箱/手机号",
    "explorer.shareOut.targetUserDesc2" => "支持用户id指定,例如",
    "explorer.shareOut.targetUserDesc3" => "支持部门id指定,例如",
    "explorer.shareOut.siteAdd"      => "快捷添加",
    "explorer.shareOut.configSend"   => "允许分享到外部站点",
    "explorer.shareOut.configSendDesc" => "开启后,外链分享时支持分享到其他网盘站点指定账户,支持设定独立权限",
    "explorer.shareOut.configReceive" => "允许接收外部站点的分享",
    "explorer.shareOut.configReceiveDesc" => "开启后,外部站点可以推送分享到当前站点,关闭后将不再接收",
    "explorer.shareOut.siteSafe"     => "授信站点",
    "explorer.shareOut.siteSafeDesc1" => "用于对外联合分享时,可以获取授信站点的组织架构,进行快捷选择用户和部门",
    "explorer.shareOut.siteSafeDesc2" => "需要网盘程序版本一致,且对方站点开启了对外联合分享接收功能",
    "explorer.shareOut.siteSafeDel"  => "确定删除该授信站点",
    "explorer.shareOut.siteSafeAdd"  => "添加授信站点",
    "explorer.shareOut.siteSafeEdit" => "编辑授信站点",
    "explorer.shareOut.siteUrl"      => "站点url",
    "explorer.shareOut.siteUrlDesc"  => "对方网盘站点url,需要当前网盘站点服务器能够相互访问到",
    "explorer.shareOut.siteName"     => "站点名称",
    "explorer.shareOut.siteApiKey"   => "站点 apiKey",
    "explorer.shareOut.siteApiKeyDesc" => "对方站点的apiKey, 在授信站点的后台获取: 基础设置--外链分享--我的apiKey",
    "explorer.shareOut.siteApiKeySelf" => "当前站点的apiKey",
    "explorer.shareOut.siteApiKeySelfDesc1" => "此apiKey仅用于联合云分享,授信站点访问",
    "explorer.shareOut.errorNetwork" => "请求失败,请确认目标网盘url是否正确,并且是最新版",
    "explorer.shareOut.errorTitle"   => "对外联合分享错误",
    "explorer.shareOut.errorDisableShare" => "外链分享功能已被关闭,请联系管理员!",
    "explorer.shareOut.errorDisableSend" => "外链分享-未开启对外联合分享功能!",
    "explorer.shareOut.errorDisableReceive" => "外链分享-未开启对外联合分享功能!",
    "explorer.shareOut.errorApiKey"  => "站点apiKey不正确,请重新输入!",
    "explorer.shareOut.errorTarget"  => "分享目标对象不存在,请确认后再试!",
    "explorer.shareOut.errorCallLimit" => "请求过于频繁,请稍后再试!",
    "explorer.shareOut.errorShareNotExist" => "分享不存在或外部分享已被移除",
    "explorer.shareOut.errorShareAuth" => "您没有权限访问该外部分享!请联系分享发起站点管理员.",
    ...
    "explorer.auth.tabParentTips"    => "该文件夹有权限的用户或部门(继承自所有上层权限)",
    ...
    "explorer.rename.title"          => "可以多次添加,可拖拽添加(自动进行去重),选择命名方式快捷批处理.",
    ...
    "explorer.rename.typeReplaceReg" => "正则替换",
    ...
    "explorer.rename.allowExt"       => "是否替换扩展名",
    ...
    "explorer.tag.default2"          => "工作资料",
    "explorer.tag.default3"          => "个人资料",
    ...
    "explorer.secret.setUserDesc"    => "指定可以设置密级的用户(建议为对应部门的拥有者)",
    ...
    "explorer.secret.tips1"          => "仅限部门网盘下内容,上述指定用户才能设置密级(建议为文件夹拥有者)",
    ...
    "user.deregistNotAllow"          => "系统未开启注册，不支持注销操作，请联系管理员！",
    ...
    "log-event-history-remove"       => "删除了[1]的历史版本[2]",
    "log-event-history-rollback"     => "将[1]的历史版本[2]设为了当前版本",
    "log-event-history-clear"        => "删除了[1]的所有历史版本",
    "log.file.move"                  => "移动/复制",
    "log.file.fav"                   => "收藏夹操作",
