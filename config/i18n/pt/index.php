...
return array(
    ...
    "admin.userManage"               => "Central de contas",
    "admin.manage"                   => "Gerenciamento em segundo plano",
    "admin.pluginManage"             => "Gerenciamento de plug-in",
    "admin.emailDear"                => "Olá %s,",
    "admin.emailCodeText"            => "Você está verificando seu endereço de e-mail. O código de verificação para esta solicitação é o seguinte. Para garantir a segurança de sua conta, conclua a verificação a tempo.",
    ...
    "admin.menu.server"              => "Serviços e Equipamentos",
    ...
    "admin.server.base"              => "Status do serviço",
    "admin.server.server"            => "Serviços do Sistema",
    "admin.server.file"              => "Serviços de arquivo",
    "admin.server.net"               => "Rede e conectividade",
    ...
    "admin.setting.passwordErrorLockDesc" => "Se a senha estiver incorreta por 5 vezes consecutivas, a conta será bloqueada por 1 minuto e não terá permissão para fazer login. Após a abertura, pode efetivamente impedir que a senha seja quebrada por força bruta;",
    ...
    "admin.setting.passwordRuleStrongDesc" => "O comprimento não deve ser inferior a 6; deve conter números e letras inglesas",
    "admin.setting.passwordRuleStrongMoreDesc" => "O comprimento deve ser de pelo menos 8 caracteres; deve conter pelo menos 3 tipos de combinações de números, letras maiúsculas, letras minúsculas e caracteres especiais.",
...
<li> Intervalo de IP: correspondências de ip dentro do intervalo; por exemplo: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.dateFormat"       => "Formato de data",
    "admin.setting.dateFormatDesc"   => "Exibição do formato de hora ano-mês-dia, hora de modificação do arquivo, etc.",
    ...
    "admin.setting.emailType"        => "Tipo de caixa de correio",
    ...
    "admin.setting.emailHostDesc"    => "Servidor de caixa de correio, como: smtp.163.com, a porta pode ser personalizada (o padrão é 465)",
    ...
    "admin.setting.groupListChildNone" => "Não listado",
    "admin.setting.groupListChildShow" => "lista",
    "admin.setting.groupListChildTree" => "Apenas listagem de diretórios em árvore",
    ...
    "admin.setting.groupSpaceLimit"  => "Restrições de nível de disco de rede de departamento",
    "admin.setting.groupSpaceLimitTips" => "O nível além do departamento não exibe o disco de rede do departamento",
    "admin.setting.groupSpaceLimitLevel" => "Nível de disco de rede do departamento",
    "admin.setting.groupSpaceLimitLevelTips" => "Especifique o nível, o padrão é mais de 5 níveis e o disco de rede do departamento não será exibido, o mínimo é 2",
    ...
    "admin.setting.clearAction"      => "operação de sistema",
    "admin.setting.clearMemory"      => "Limpar cache",
    "admin.setting.clearMemoryDesc"  => "Ele limpará o cache redis, o log do sistema, carregará arquivos temporários e outros caches. Após a limpeza, o usuário conectado fará logout. Por favor, opere com cuidado",
    "admin.setting.clearImage"       => "Limpar miniaturas de imagens",
    "admin.setting.clearImageDesc"   => "A miniatura gerada pela imagem será apagada e será gerada automaticamente novamente após revisitar",
    "admin.setting.clearVideo"       => "Limpe o conteúdo da transcodificação de vídeo",
    "admin.setting.clearVideoDesc"   => "A capa do vídeo e os arquivos transcodificados serão apagados e serão gerados automaticamente novamente após revisitar, por favor, opere com cuidado",
    "admin.setting.clearPlugin"      => "Limpar cache do plug-in",
    "admin.setting.clearPluginDesc"  => "Todos os arquivos de cache temporários gerados por plug-ins serão limpos, incluindo capa de vídeo e transcodificação, por favor, opere com cuidado",
    "admin.setting.clearDB"          => "Limpeza de dados anormais do banco de dados",
    "admin.setting.clearDBDesc"      => "Os dados sujos gerados devido ao reinício inesperado do banco de dados serão limpos, por favor, opere com cuidado",
    ...
    "admin.setting.recDescInfo21"    => "Os dados do sistema podem ser restaurados gravando os dados de backup em um novo banco de dados e definindo-o como padrão do sistema.",
    "admin.setting.recDescInfo22"    => "Os novos parâmetros de configuração do banco de dados serão anexados ao arquivo de configuração do sistema config/setting_user.php. Se o sistema encontrar uma exceção após a restauração, você poderá remover a parte anexada do arquivo sem afetar os dados anteriores do sistema.",
    ...
    "admin.setting.recDescInfo32"    => "Por exemplo, se a configuração atual do banco de dados for: Usuário: test; Senha: test123, efetue login no banco de dados usando a conta root e execute a instrução SQL correspondente para definir permissões (as permissões podem ser revogadas após o teste ser aprovado e a restauração ser bem-sucedida).",
    ...
    "admin.setting.recDbFileErr"     => "O arquivo de biblioteca selecionado não corresponde ao sistema e um total de [0] arquivos de tabela de dados estão faltando, conforme a seguir:",
    "admin.setting.recDbExist"       => "O banco de dados não está vazio, especifique novamente ou execute novamente após limpá-lo!",
    ...
    "admin.group.removeBatch"        => "Excluir departamentos em lote",
    "admin.group.removeBatchDesc"    => "Vários departamentos podem ser selecionados para exclusão de lote, por favor, opere com cuidado!",
    "admin.group.removeSub"          => "excluir subdepartamento",
    "admin.group.removeSubDesc"      => "Depois de habilitada, todos os subdepartamentos serão excluídos ao mesmo tempo, caso contrário, apenas o departamento selecionado será excluído e os subdepartamentos passarão automaticamente a pertencer ao departamento pai.",
    ...
    "admin.group.nameErr"            => "O nome do departamento não pode conter",
    ...
    "admin.member.groupSwtichDesc"   => "Migrar usuários selecionados do departamento atual para o departamento de destino",
    "admin.group.setGroupOwner"      => "Configurar administrador de departamento",
    "admin.group.ownerAllowEditUser" => "Permitir edição de usuários",
    "admin.group.setGroupOwnerTips"  => "<b>Permissões do administrador do departamento:</b><br/><br/><li> O usuário tem permissões de proprietário neste departamento</li><li> Depois de permitir que os usuários editem esteja ativado, a função do usuário é definida como administrador do departamento por padrão. Ele pode entrar em segundo plano para editar usuários no departamento e editar o departamento e subdepartamentos.</li><li> Método de cancelamento: edite o usuário correspondente, altere a função para um usuário comum e modifique as permissões do departamento do usuário.</li>",
    ...
    "admin.member.importing"         => "Importando, aguarde...",
    "admin.member.importSuccess"     => "Importação completa",
    "admin.member.importFail"        => "Falha na importação",
    "admin.member.importFailDesc"    => "Sucesso: [1]; Falha: [2]",
    "admin.member.importName"        => "Conta de login (obrigatório, exclusivo)",
    "admin.member.importNickName"    => "Apelido (único)",
    "admin.member.importPwd"         => "Senha requerida)",
    "admin.member.importSex"         => "Gênero (Masculino-1, Feminino-0)",
    "admin.member.importPhone"       => "Número de celular (único)",
    "admin.member.importEmail"       => "E-mail (somente)",
    "admin.member.groupRemoveTips"   => "Após a exclusão, os arquivos do departamento serão movidos para a lixeira do sistema. Tem certeza de que deseja continuar?",
    "admin.member.memberRemoveTips"  => "Após a exclusão, os arquivos do usuário serão movidos para a lixeira do sistema. Tem certeza de que deseja continuar?",
    "admin.member.freeGroupRemoveTips" => "Após a exclusão, os arquivos do departamento também serão excluídos. Tem certeza de que deseja continuar?",
    "admin.member.freeMemberRemoveTips" => "Após a exclusão, os arquivos do usuário também serão excluídos. Tem certeza de que deseja continuar?",
    ...
    "admin.member.importDesc"        => "Um usuário por linha, caso já exista, será automaticamente ignorado.",
    ...
    "admin.member.authCopy"          => "Copiar permissões do departamento",
    "admin.member.authPaste"         => "Pasta de permissão do departamento",
    "admin.member.ifAuthPaste"       => "Tem certeza de que deseja definir as permissões de departamento copiadas para o usuário atual?",
    "admin.member.errEditSelfRole"   => "A modificação da própria função não é suportada",
    "admin.member.errEditAdminRole"  => "Você não tem permissão para modificar a função do administrador",
    "ERROR_USER_NOT_EXISTS"          => "O usuário não existe",
    "ERROR_USER_PASSWORD_ERROR"      => "Senha incorreta",
    "ERROR_USER_PASSWORD_MISSING"    => "Senha ausente",
    ...
    "admin.role.adminDesc"           => "Super administrador, tem direitos de gerenciamento de servidor; todas as configurações de arquivos e pastas são inválidas para este usuário!",
    "admin.role.read"                => "Ler",
    ...
    "admin.role.userAuth"            => "Definir permissões de usuário (funções de usuário, permissões de departamento)",
    ...
    "admin.authFrom.setUser"         => "Especificando permissões de usuário",
    ...
    "admin.authFrom.groupRoot"       => "diretório raiz do departamento",
    ...
    "admin.auth.removeAction"        => "Excluir/cortar/mover",
    ...
    "admin.plugin.typeBuy"           => "aplicações de valor agregado",
...
<li> Atualizar: Após baixar, carregue e descompacte para a pasta de nome do plug-in correspondente;</li>",
    ...
    "admin.plugin.closedError"       => "O plug-in não foi habilitado, entre em contato com o administrador!",
    ...
    "admin.storage.s3"               => "Armazenamento S3",
    ...
    "admin.storage.obs"              => "OBS da nuvem Huawei",
    "admin.storage.bos"              => "Nuvem Baidu BOS",
    "admin.storage.jos"              => "JD Nuvem OSS",
    ...
    "admin.storage.moveData"         => "Migrar dados",
    "admin.storage.delStore"         => "Desmontar armazenamento",
    "admin.storage.ifMove"           => "Este armazenamento contém [1] arquivos de armazenamento do sistema, que serão migrados para o armazenamento padrão atual. Deseja continuar?",
    "admin.storage.ifDel"            => "Tem certeza de que deseja desmontar o armazenamento atual?",
    "admin.storage.ifDelWithFile"    => "Este armazenamento contém [1] arquivos de disco de rede, que serão migrados para o armazenamento padrão atual quando excluídos. Deseja continuar?",
    ...
    "admin.storage.ifRmBakNow"       => "Este armazenamento contém dados de backup. Deseja desinstalá-lo diretamente?",
    "admin.storage.moveErr"          => "O armazenamento não pode ser conectado e a migração de dados não pode ser concluída.",
    "admin.storage.ifRmErrNow"       => "O armazenamento não pode ser conectado e a migração de dados não pode ser concluída. Desinstalar diretamente?",
    "admin.storage.errNoCnt"         => "%s arquivos físicos não existem ou estão inacessíveis",
    "admin.storage.errMoveCnt"       => "Falha ao mover %s arquivos",
    "admin.storage.errViewLog"       => "Existem %s no total. Por favor, verifique o registro para obter detalhes:",
    "admin.storage.errTimeout"       => "Tempo limite da solicitação de serviço esgotado!",
    "admin.storage.tryOrRmNow"       => "Você pode cancelar a nova tentativa ou desinstalar diretamente (os arquivos serão excluídos, proceda com cuidado!).",
    "admin.storage.add"              => "Adicionar novo armazenamento",
    "admin.storage.modify"           => "Modificar armazenamento",
    "admin.storage.remove"           => "Descarregar armazenamento",
    "admin.storage.move"             => "Migrar armazenamento",
    ...
    "admin.storage.ossKeyDesc"       => "ID da chave de acesso, crie ou visualize-o em [Gerenciamento de chave de acesso ao console]",
    "admin.storage.ossEndpoint"      => "Endpoint, se você usa um nó de intranet, precisa habilitar a transferência do servidor",
    "admin.storage.cosKeyDesc"       => "ID da chave de acesso, crie ou visualize-o em [Console-Access Management-API Key Management]",
    "admin.storage.qiniuDomain"      => "Nome de domínio vinculado pelo Qiniu Space",
    "admin.storage.qiniuKeyDesc"     => "Chave de acesso, crie ou visualize-a em [Console-Personal Center-Key Management]",
    "admin.storage.qiniuSecretDesc"  => "Chave secreta, o método de aquisição é o mesmo acima",
    "admin.storage.qnz0"             => "Leste da China - Zhejiang",
    "admin.storage.qnz02"            => "Leste da China - Zhejiang 2",
    "admin.storage.qnz1"             => "Norte da China - Hebei",
    "admin.storage.qnz2"             => "Sul da China - Guangdong",
    "admin.storage.qnna0"            => "América do Norte - Los Angeles",
    "admin.storage.qnas0"            => "Ásia-Pacífico - Cingapura",
    "admin.storage.qnas02"           => "Ásia-Pacífico - Seul",
    ...
    "admin.storage.oosKeyDesc"       => "ID da chave de acesso, crie-o em [Gerenciamento de chave de acesso ao console]",
    "admin.storage.obsKeyDesc"       => "ID da chave de acesso, crie ou visualize-o em [Console-My Credentials-API Credentials]",
    "admin.storage.bosKeyDesc"       => "ID da chave de acesso, crie ou visualize-o em [Console-Security Authentication-Access Key]",
    "admin.storage.josKeyDesc"       => "ID da chave de acesso, crie ou visualize-o em [Console-Access Key Management]",
    "admin.storage.secretDesc"       => "Chave de acesso secreta, o método de aquisição é o mesmo acima",
    "admin.storage.bdbj"             => "Norte da China-Pequim",
    "admin.storage.bdbd"             => "Norte da China-Baoding",
    "admin.storage.bdsu"             => "Leste da China-Suzhou",
    "admin.storage.bdgz"             => "Sul da China-Guangzhou",
    "admin.storage.bdcd"             => "Sudoeste-Chengdu",
    "admin.storage.bdhkg"            => "ChinaHong Kong",
    "admin.storage.bdfwh"            => "Huazhong Finance-Wuhan",
    "admin.storage.bdfsh"            => "Leste da China-Xangai",
    ...
    "admin.storage.ftpConnErr"       => "Não foi possível conectar ao servidor FTP:",
    "admin.storage.ftpLoginErr"      => "Falha ao fazer login no servidor FTP:",
    "admin.storage.ftpMkfileErr"     => "Falha ao criar novo arquivo, verifique as permissões de leitura e gravação!",
    "admin.storage.ftpBsPathErr"     => "Tente usar [0] como diretório de armazenamento.",
    "admin.storage.allowCover"       => "Permitir miniaturas de arquivos",
    "admin.storage.allowCoverDesc"   => "Vídeo, PDF, fluxograma e outros plug-ins geram miniaturas",
    ...
    "admin.storage.configError"      => "O parâmetro de configuração é anormal!",
    "admin.storage.sizePercent"      => "Proporção do arquivo do sistema:",
    "admin.storage.fileCount"        => "Número de arquivos:",
    "admin.storage.error"            => "Exceção de armazenamento",
    "admin.storage.errorTypeNull"    => "O tipo de armazenamento não está ativado",
    "admin.storage.errorPathNull"    => "O armazenamento não está disponível, verifique se o diretório de armazenamento é válido",
    "admin.storage.minioErrRgn"      => "Incompatibilidade de área de armazenamento.",
    "admin.storage.minioErr403"      => "Acesso negado, verifique os parâmetros de configuração e permissões de recursos.",
    "admin.storage.minioErr404"      => "O objeto de acesso não existe, verifique se o Bucket está correto.",
    "admin.storage.minioRgnDesc"     => "Preencha de acordo com a configuração real, não há necessidade de preencher se não estiver configurado",
    "admin.storage.s3SignVer"        => "Versão assinada",
    "admin.storage.s3SignVerDesc"    => "Versão assinada de autenticação",
    "admin.storage.s3FormUpload"     => "upload de formulário",
    "admin.storage.s3FormUploadDesc" => "Alguns serviços de armazenamento não suportam esta função. Arquivos com menos de 10 MB não serão carregados durante a transmissão direta de front-end.",
    "admin.storage.ioReset"          => "Especificar local de armazenamento",
    "admin.storage.ioResetDesc"      => "Se estiver vazio, o armazenamento padrão atual será usado, o que afetará somente o local de armazenamento padrão dos arquivos enviados após a modificação.",
    "admin.storage.groupDef"         => "Armazenamento padrão",
    "admin.storage.groupLoc"         => "Armazenamento local",
    "admin.storage.groupObj"         => "Armazenamento de objetos",
    "admin.storage.groupNet"         => "Armazenamento em rede",
    "admin.storage.groupOth"         => "Outro armazenamento",
    ...
    "admin.install.success"          => "Instalação bem sucedida!",
    "admin.install.error"            => "Instalação falhada!",
    "admin.install.dbWasSet"         => "O banco de dados do sistema foi configurado. Se precisar redefini-lo, você pode excluir o arquivo de configuração config/setting_user.php e reinstalá-lo!",
    "admin.install.errorRequest"     => "O sistema foi instalado e está proibido de ser executado novamente.",
    ...
    "admin.install.ifDelDbAuto"      => "Os dados já existem no banco de dados especificado [1]. Se você deseja excluir, adicione o parâmetro: --db-del 1",
    "admin.install.ifResetAuto"      => "Se precisar redefinir a senha do administrador, você pode adicionar parâmetros:",
    "admin.install.userOnWeb"        => "Acesse o disco de rede no navegador e conclua as configurações da conta de administrador.",
    ...
    "admin.install.dbError"          => "exceção de banco de dados",
    "admin.install.dbTableError"     => "Tabela de dados ausente ou anormal",
    ...
    "admin.install.phpVersionTips"   => "PHP5.3 e superior, recomendo php8.1",
    ...
    "admin.install.dbPortDesc"       => "A porta padrão é 3306, se você precisar personalizá-la, pode anexá-la, como: 127.0.0.1:3307",
    ...
    "admin.install.userSaveErr"      => "Falha na inicialização do sistema,",
    "admin.install.autoPwdTips"      => "Lembre-se da senha da sua conta:",
    "admin.install.pathErrDesc"      => "O caminho do programa não suporta símbolos especiais. Use letras e números em inglês tanto quanto possível.",
    "admin.install.envReqErr"        => "A solicitação é anormal, verifique o ambiente web!",
    "admin.install.pageError"        => "Há um erro na página Verifique se os arquivos do sistema estão carregando normalmente e se são afetados pelo navegador e seus plug-ins (recomenda-se usar Chrome, Firefox e outros navegadores)",
    "admin.install.resetPwdTips"     => "Por favor, preencha a senha da conta do administrador!",
    "admin.install.resetSysErr"      => "O sistema não foi instalado e não suporta esta operação!",
    "admin.install.dbSetOk"          => "Importação do banco de dados concluída!",
    "admin.install.userSetOk"        => "O administrador foi adicionado!",
    ...
    "admin.log.viewFile"             => "arquivo de visualização",
    ...
    "admin.log.switchUserGroup"      => "Migrar usuários para departamentos",
    ...
    "admin.backup.success"           => "Backup bem-sucedido",
    "admin.backup.fail"              => "Falha no backup",
    "admin.backup.complete"          => "Backup concluído",
    "admin.backup.db"                => "base de dados",
    "admin.backup.dbFile"            => "arquivo de banco de dados",
    "admin.backup.fileError"         => "Falha no backup de alguns arquivos",
    "admin.backup.checkLog"          => "Verifique o log de backup: data/temp/log/backup/date of the day__log.php",
    ...
    "admin.backup.open"              => "Habilitar backup",
    "admin.backup.openDesc"          => "Faça backup de bancos de dados e arquivos do sistema",
    ...
    "admin.backup.freqErr"           => "A operação é muito frequente!",
    "admin.backup.timeBeen"          => "Demorado",
    "admin.backup.timeTotal"         => "Tempo total",
    "admin.backup.backed"            => "Backup",
    "admin.backup.storage"           => "Armazenamento de backup",
    "admin.backup.ifSave"            => "Tem certeza de que deseja fazer um backup?",
    ...
    "admin.backup.timeNote"          => "Nota: O sistema mantém apenas os backups de banco de dados dos últimos 7 dias e do dia 1º de cada mês. Tempo de backup:",
    "admin.backup.recover"           => "Entre em contato com o provedor de serviços para recuperação de dados.",
    "admin.backup.optionTime"        => "Para evitar o impacto das alterações de dados, opte por realizar a operação fora do horário comercial.",
    "admin.backup.optionLocation"    => "Crie um novo armazenamento independente especificamente para backup de arquivos",
    "admin.backup.optionTips1"       => "O backup é dividido em duas partes: backup do banco de dados e backup dos arquivos. É recomendável fazer backup de ambos.",
    "admin.backup.optionTips2"       => "Backup do banco de dados: gere um arquivo SQL a partir do conteúdo do banco de dados e faça backup dele no armazenamento de destino (o armazenamento padrão do sistema somente para banco de dados).",
    ...
    "admin.backup.optionTips4"       => "O sistema mantém apenas os backups de banco de dados dos últimos 7 dias e do dia 1º de cada mês.",
    "admin.backup.needStorage"       => "O armazenamento de backup não pode estar vazio",
    "admin.backup.needNoDefault"     => "Não selecione o armazenamento padrão do sistema como local de backup de arquivos!",
    ...
    "admin.backup.freeBakDesc"       => "A versão gratuita suporta apenas backup de banco de dados",
    ...
    "admin.backup.taskDbDesc"        => "Fazer backup automático do banco de dados do sistema",
    "admin.backup.taskFileDesc"      => "Fazer backup automático dos arquivos do sistema",
    "admin.backup.addStoreHasFile"   => "Este armazenamento contém dados do sistema. Por favor, migre ou adicione novo armazenamento primeiro!",
    "admin.backup.title"             => "Instruções de backup de arquivo",
    "admin.backup.bakFileTip1"       => "O backup de arquivos é uma tarefa independente. Sua frequência de execução, progresso e outras informações não estão incluídas no backup do banco de dados. Para obter detalhes sobre a tarefa, consulte %s.",
    "admin.backup.bakFileTip2"       => "O progresso em tempo real do backup de arquivos (cópia) pode ser visualizado em %s;",
    "admin.backup.bakFileTip3"       => "Se o backup falhar, você pode visualizar os detalhes no log %s;",
    "admin.backup.bakFileTip4"       => "Falhas de backup geralmente são causadas por conexões de armazenamento anormais (incapacidade de ler ou gravar arquivos). Para garantir a execução normal do backup, certifique-se de que todos os dispositivos de armazenamento estejam conectados corretamente.",
    "admin.backup.bakFileTask"       => "Tarefas agendadas - Backup de dados (arquivo)",
    "admin.backup.full"              => "Backup completo",
    "admin.backup.fullDesc"          => "Comece a fazer backup a partir do primeiro arquivo",
    "admin.backup.increment"         => "Backup incremental",
    "admin.backup.incrementDesc"     => "Continue o backup com base na última tarefa",
    "admin.backup.sameSkip"          => "(Arquivos com o mesmo nome serão ignorados)",
    "admin.backup.clickDtl"          => "Clique para ver detalhes",
    "admin.backup.ifBakFile"         => "Tem certeza de que deseja fazer backup dos seus arquivos?",
    "admin.restore.ifRecDb"          => "A restauração do banco de dados alterará os dados atuais do sistema. Tem certeza de que deseja executá-la?",
    "admin.restore.ifRecFile"        => "A restauração de arquivos alterará os dados atuais do sistema. Tem certeza de que deseja executá-la?",
    "admin.restore.fileRec"          => "Restauração de arquivo",
    "admin.restore.importTips"       => "Lembrete importante",
    "admin.restore.recType"          => "Restaurar conteúdo",
    "admin.restore.recTypeDb"        => "Restauração de banco de dados",
    "admin.restore.recTypeFile"      => "Restauração de arquivo",
    "admin.restore.recFileDesc1"     => "A restauração de arquivos consiste em copiar arquivos do armazenamento de backup para o armazenamento padrão com base nos registros de arquivos do sistema atual para restaurar os arquivos físicos do sistema.",
    "admin.restore.recFileDesc2"     => "Observação: a cópia durante o processo de restauração depende dos registros de arquivo do banco de dados atual. Se envolver a reinstalação do sistema, você precisará restaurar o banco de dados primeiro.",
    "admin.restore.recFileDesc3"     => "A restauração de arquivos é uma operação demorada, especialmente quando o volume de dados é grande ou envolve armazenamento cruzado. Seja paciente durante a execução.",
    "admin.restore.bakPath"          => "Diretório de backup",
    "admin.restore.bakDbPath"        => "Diretório de backup do banco de dados",
    "admin.restore.bakFilePath"      => "Diretório de backup de arquivos",
    "admin.restore.full"             => "Restauração completa",
    "admin.restore.fullDesc"         => "Uma restauração completa começa a partir do primeiro arquivo; caso contrário, continuará com base na última tarefa. Os arquivos existentes serão ignorados.",
    "admin.restore.needVipDesc"      => "A versão gratuita suporta apenas restauração de banco de dados",
    "admin.restore.needVipTips"      => "A versão atual não oferece suporte a esta operação, atualize para a Enterprise Edition",
    "admin.restore.bakEmpty"         => "O diretório de backup selecionado está vazio",
    "admin.restore.noFileNeed"       => "O sistema não possui arquivos que precisam ser restaurados",
    "admin.restore.taskRepeat"       => "A tarefa está em andamento, por favor, não repita a operação",
    ...
    "admin.share.linkView"           => "Ver página de compartilhamento",
    "admin.share.target"             => "Objetos de colaboração",
    "admin.share.targetView"         => "Ver objetos de colaboração",
    "admin.share.targetTitle"        => "Departamentos ou usuários para compartilhamento colaborativo",
    "admin.share.errorInfo"          => "Compartilhar informações é anormal!",
 ...
 post_max_size, precisa reiniciar)",
    ...
    "admin.setting.downloadZipClient" => "Download compactado de front-end",
    "admin.setting.downloadZipClientDesc" => "Precisa ser capaz de vincular à rede externa, ou o site é https",
    "admin.setting.downloadZipLimit" => "Limite de tamanho de download compactado",
    "admin.setting.downloadZipLimitDesc" => "0 significa sem limite; para evitar o consumo excessivo de desempenho do servidor, o download do pacote é restrito quando a pasta é muito grande e é solicitado que o arquivo possa ser baixado diretamente pelo cliente do PC",
    "admin.setting.downloadZipLimitTips" => "O conteúdo compactado excede o limite do sistema, entre em contato com o administrador! Você pode baixar a pasta diretamente pelo cliente do PC sem compactação.",
    "admin.setting.dragDownload"     => "Arraste e solte na área de trabalho para baixar",
    "admin.setting.dragDownloadDesc" => "Suportado apenas pelo navegador do kernel Chrome do lado do PC (chrome edge 360 fast, etc.)",
    "admin.setting.dragDownloadZip"  => "Download de compactação de arrastar e soltar com seleção múltipla",
    "admin.setting.dragDownloadZipDesc" => "Suporte para download de seleção múltipla ou arrastar e soltar pasta, deve ser empacotado e compactado no servidor antes do download",
    "admin.setting.dragDownloadLimit" => "Arraste e solte o limite de tamanho do conteúdo",
    "admin.setting.dragDownloadLimitDesc" => "0 significa sem limite. O tamanho do conteúdo arrastado estará sujeito a esse limite. Como não há uma barra de progresso para arrastar e fazer download do Chrome no momento, ele não pode ser cancelado. Recomenda-se limitar o tamanho a 20 M.",
    "admin.setting.dragDownloadUrlTips" => "O URL é muito longo, reduza a seleção e tente novamente!",
    "admin.setting.dragDownloadOpenTips" => "Entre em contato com o administrador para habilitá-lo nas configurações em segundo plano!",
    "admin.setting.dragDownloadNotOpen" => "O download de arrastar e compactar não está ativado",
    "admin.setting.dragDownloadSizeTips" => "O tamanho do conteúdo arrastado excede o limite",
    "admin.setting.showFileSafe"     => "Segurança de acesso a arquivos",
    "admin.setting.showFileLink"     => "Exibição do link externo do arquivo",
    "admin.setting.showFileLinkDesc" => "Após o fechamento, as propriedades do arquivo não mostram mais links externos",
    "admin.setting.showFileMd5"      => "exibição de arquivo md5",
    "admin.setting.showFileMd5Desc"  => "Após o fechamento, as propriedades do arquivo não mostram mais o arquivo md5",
    "admin.setting.shareLinkAllow"   => "Ativar compartilhamento de link externo",
    "admin.setting.shareLinkAllowDesc" => "Após o fechamento, ele não oferecerá mais suporte ao compartilhamento de cadeia externa e o conteúdo compartilhado não será afetado",
    "admin.setting.shareLinkAllowTips" => "O sistema atual desativou o compartilhamento de link externo, entre em contato com o administrador!",
    "admin.setting.shareLinkPasswordAllowEmpty" => "O compartilhamento de cadeia externa permite que a senha fique vazia",
    "admin.setting.shareLinkPasswordAllowEmptyDesc" => "Após o fechamento, uma senha deve ser definida para compartilhamento de link externo; o conteúdo compartilhado não será afetado",
    "admin.setting.shareLinkAllowGuest" => "O compartilhamento de link externo permite que visitantes não logados acessem",
    "admin.setting.shareLinkAllowGuestDesc" => "Após o fechamento, você deve fazer login ao acessar links externos; o conteúdo compartilhado não será afetado",
    "admin.setting.shareLinkAllowEdit" => "O compartilhamento de link externo permite edição",
    "admin.setting.shareLinkAllowEditDesc" => "Depois de habilitá-lo, as configurações podem ser editadas ao compartilhar por meio de links externos. Outros podem editar e salvar arquivos diretamente e criar novos arquivos de upload por meio de compartilhamento de link externo.",
    "admin.setting.shareLinkUserDisableSkip" => "Impedir que usuários compartilhem links externos quando suas contas estiverem desativadas",
    "admin.setting.shareLinkUserDisableSkipDesc" => "Quando a conta do compartilhador de link externo for desativada, todo o compartilhamento de link externo do usuário ficará inacessível.",
    "admin.setting.shareLinkZip"     => "Download do pacote de compartilhamento de link externo",
    ...
    "admin.setting.fileHistoryMax"   => "Número de versões do histórico de arquivos",
    "admin.setting.fileHistoryMaxDesc" => "Recomenda-se 200. Se for 0, a versão do histórico do arquivo será fechada. Se for maior que 500, não haverá limite.",
    "common.----"                    => "----",
    "common.width"                   => "Ampla",
    "common.height"                  => "Alta",
    "common.test"                    => "Teste",
    ...
    "common.deleteBatch"             => "exclusão em lote",
    ...
    "common.readWrite"               => "Legível e gravável",
    "common.noAuth"                  => "Sem permissões",
    "common.site"                    => "Site",
    ...
    "common.phyFileNotExists"        => "Arquivos físicos estão faltando ou inacessíveis!",
    ...
    "common.env.errorVersion"        => "A versão do PHP não pode ser inferior a 5.3",
    ...
    "common.version.tipsHistory"     => "A versão gratuita suporta apenas 5 versões de histórico; compre um número ilimitado de versões licenciadas!",
    ...
    "common.copyright.name"          => "haisum",
    "common.copyright.nameTitle"     => "haisum",
    "common.copyright.nameDesc"      => "KodCloud • Explorer",
    "common.copyright.powerBy"       => "Powered by haisum",
    "common.copyright.metaKeywords"  => "haisum, KodExplorer, kod, kodCloud, webos, webIDE, php filemanage, gerenciador de arquivos, Kedao Cloud, Mango Cloud, Sistema de gerenciamento de documentos, Enterprise Cloud Disk, Explorer, documentos online, escritório online, escritório online, visualização CAD online, Editor online, editor online",
    "common.copyright.metaName"      => "haisum",
    "common.copyright.agreement"     => "acordo de serviço",
    "common.copyright.agreeSet"      => "Configurações do protocolo de serviço do sistema",
    "common.copyright.agreeOpen"     => "Se deve habilitar",
    "common.copyright.agreeDesc"     => "Depois de ativado, o link do contrato será exibido na página de login e o usuário precisa verificar se concorda antes de fazer login",
    "common.copyright.agreeAdd"      => "adicionar acordo",
    "common.copyright.agreeEdit"     => "acordo editorial",
    "common.copyright.agreeName"     => "nome do protocolo",
    "common.copyright.agreeFile"     => "documento de acordo",
    "common.copyright.agreeFileSelect" => "Selecionar arquivo de protocolo",
    "common.copyright.agreeFileDesc" => "Recomenda-se usar o arquivo de formato md",
    ...
    "common.date.tomorrow"           => "amanhã",
    "common.date.week"               => "essa semana",
    "common.date.weekNext"           => "próxima semana",
    "common.date.weekPrev"           => "semana passada",
    "common.date.month"              => "este mês",
    "common.date.monthNext"          => "próximo mês",
    "common.date.monthPrev"          => "mês passado",
    "common.date.day7"               => "últimos 7 dias",
    "common.date.day30"              => "Últimos 30 dias",
    "common.date.day90"              => "Últimos 90 dias",
    "common.date.day180"             => "Últimos 180 dias",
    ...
    "ERROR_DB_PWD"                   => "Acesso negado ao banco de dados: nome de usuário ou senha incorretos.",
    "ERROR_DB_TIMEOUT"               => "A conexão do banco de dados expirou, verifique se o endereço está correto.",
    "ERROR_DB_CONN_RFS"              => "Conexão de banco de dados recusada: informações de configuração incorretas ou serviço não iniciado.",
    "ERROR_DB_ADR"                   => "Erro de conexão do banco de dados, verifique se o endereço está correto.",
    "ERROR_DB_NOT_SUPPORT"           => "Tipo de banco de dados não suportado, verifique se o serviço ou arquivo de configuração correspondente está normal.",
    "ERROR_DB_XS_DENNIED"            => "Acesso ao banco de dados negado: privilégios insuficientes.",
    "ERROR_DB_NOT_EXIST"             => "O banco de dados não existe ou o nome errado foi especificado.",
    "explorer.----"                  => "----",
    ...
    "explorer.lockError"             => "Ocorreu um erro, o bloqueio simultâneo expirou",
    "explorer.lockErrorDesc"         => "Reduza a frequência de solicitações ou otimize a configuração relacionada à simultaneidade do servidor ou melhore a configuração do hardware do servidor;",
    ...
    "explorer.error"                 => "Operação falhou!",
    "explorer.complete"              => "Operação concluída!",
    ...
    "explorer.sysSetUserError"       => "O arquivo de configuração do sistema (config/setting_user.php) está anormal, entre em contato com o administrador!",
    "explorer.wrtSetUserError"       => "O arquivo de configuração do sistema (config/setting_user.php) não tem permissão de gravação!",
    ...
    "explorer.uploadTipsMore"        => "Muitos arquivos, é recomendável reduzir o número ou fazer o upload após a compactação!",
    ...
    "explorer.unzipRarTips"          => "O conteúdo do arquivo está danificado ou a análise do arquivo não é suportada. Recomenda-se usar o formato ZIP.",
    ...
    "explorer.inputSearchWords"      => "Insira palavras-chave para pesquisar",
    ...
    "explorer.search.optionGroup"    => "pesquisar subdepartamentos",
    "explorer.search.optionGroupDesc" => "Se você for o proprietário, pesquise o conteúdo dos subdepartamentos ao mesmo tempo em que pesquisa o diretório raiz do departamento",
    "explorer.search.optionGroupTips" => "e subdepartamentos",
    ...
    "explorer.groupAuthFrom"         => "Fonte de autorização",
    "explorer.groupAuthCopy"         => "Combinação de cópias",
    "explorer.groupAuthCopyDesc"     => "Combinação de cópias",
    ...
    "explorer.folderPass.add"        => "Definir senha da pasta",
    "explorer.folderPass.edit"       => "Editar senha da pasta",
    "explorer.folderPass.clearAsk"   => "Tem certeza de que deseja limpar a senha da pasta?",
    "explorer.folderPass.hasDesc"    => "Senha da pasta definida",
    "explorer.folderPass.pass"       => "senha de acesso",
    "explorer.folderPass.passRepeat" => "Confirme sua senha",
    "explorer.folderPass.desc"       => "Descrição",
    "explorer.folderPass.timeOutDesc" => "Tempo de expiração da senha, se não definido, significa que sempre será válida.",
    "explorer.folderPass.timeOut"    => "Prazo de validade",
    ...
    "explorer.appSelectMenu"         => "Definir como modo de abertura padrão",
    "explorer.appSelectMenuCancel"   => "Desativar como padrão aberto com",
    ...
    "explorer.toolbar.myGroupAllow"  => "Departamentos para os quais tenho autoridade",
    "explorer.toolbar.myGroupAllowDesc" => "caminho de acesso",
    ...
    "explorer.toolbar.photo"         => "álbum de foto",
    "explorer.photo.desc"            => "Classificação do álbum do usuário",
    "explorer.photo.group"           => "Agrupamento de álbuns",
    "explorer.photo.setting"         => "Configurações do álbum",
    "explorer.photo.pathRoot"        => "Diretório de digitalização do álbum",
    "explorer.photo.pathRootSelect"  => "Selecione uma pasta como o diretório raiz para a digitalização de imagens do álbum",
    "explorer.photo.fileType"        => "Especifique o tipo de arquivo",
    "explorer.photo.fileSize"        => "filtro de tamanho de arquivo",
    "explorer.photo.fileSizeDesc"    => "Filtre apenas arquivos maiores que essa configuração, se for 0, não há limite",
    "explorer.toolbar.folder"        => "álbum de catálogo",
    "explorer.toolbar.folderSelect"  => "Selecione uma pasta para exibir no modo de álbum",
 ...
 Suporte a correspondência pinyin e difusa da primeira letra",
    ...
    "explorer.pathGroup.shareGroup"  => "Espaço departamental",
    ...
    "explorer.pathGroup.shareSelf"   => "espaço pessoal",
    ...
    "explorer.file.containNow"       => "atualmente contém",
    "explorer.file.containAll"       => "contém o total",
    "explorer.file.containGet"       => "Obtenha o número e o tamanho total de todas as pastas de subarquivos",
    ...
    "explorer.file.listTypeGroup"    => "Modo de exibição e método de classificação",
    "explorer.file.listTypeKeep"     => "modo de exibição",
    "explorer.file.listTypeKeepDesc" => "Escolha um modo de visualização para cada pasta ou use o mesmo modo de visualização para todas as pastas",
    "explorer.file.listSortKeep"     => "ordenar por",
    "explorer.file.listSortKeepDesc" => "Configure a ordem de classificação das colunas para cada pasta ou use a mesma ordem para todas as pastas",
    "explorer.file.listViewKeep"     => "Funciona com uma única pasta",
    "explorer.file.listViewAll"      => "aplica-se a todas as pastas",
    "explorer.file.listViewReset"    => "restaurar ao padrão",
    ...
    "explorer.app.createLink"        => "Novo URL",
    ...
    "explorer.app.linkDragTips"      => "Você pode arrastar o link de URL para a área do arquivo para criar automaticamente um link de URL!",
    ...
    "explorer.fileLink.missTips"     => "O conteúdo apontado pelo atalho não existe ou foi excluído.",
    "explorer.fileLink.missFixed"    => "reparar",
    "explorer.fileLink.missRemove"   => "excluir",
    ...
    "explorer.upload.dragFolder"     => "Arraste e solte na pasta para fazer upload",
    ...
    "explorer.upload.errorPath"      => "O diretório de destino não existe!",
    ...
    "explorer.upload.fopenError"     => "Falha na gravação, verifique as permissões de leitura e gravação do diretório",
    ...
    "explorer.search.path"           => "Catálogo de pesquisa",
    "explorer.search.rootPath"       => "diretório raiz",
    ...
    "explorer.search.optionDesc"     => "Descrição do arquivo",
    "explorer.search.optionTag"      => "Rótulos de usuário/departamento",
    ...
    "explorer.history.detilAdd"      => "Adicionar impressão",
    "explorer.history.uploadNew"     => "Carregar nova versão",
    "explorer.history.diff"          => "Comparação de versões históricas",
    ...
    "explorer.history.delWarn"       => "Depois de excluído, ele não poderá ser recuperado. Tem certeza de que deseja realizar esta operação?",
    "explorer.history.changeEvent"   => "Troca de versão histórica",
    "explorer.history.action"        => "Operações de versão histórica",
    "explorer.history.remove"        => "Excluir versão histórica",
    "explorer.history.before"        => "Antes de",
    "explorer.history.after"         => "depois de",
    ...
    "explorer.share.linkToFast"      => "Compartilhamento rápido de links externos",
    "explorer.share.shareSystem"     => "Compartilhamento de sistema",
    "explorer.share.shareSystemDesc" => "Compartilhamento colaborativo criado por outros aplicativos ou plugins",
    ...
    "explorer.share.notDown"         => "Desativar downloads",
    ...
    "explorer.share.authWriteable"   => "Legível e gravável (editar, salvar, fazer upload, criar novo)",
    "explorer.share.pageType"        => "modo de exibição",
    "explorer.share.pageFolder"      => "modo de pasta",
    "explorer.share.pageDoc"         => "Padrão da base de conhecimento do documento",
    "explorer.share.pageDocDesc"     => "A pasta é exibida na forma de uma base de conhecimento e a pasta markdown pode ser compartilhada e publicada diretamente como uma base de conhecimento ou manual de ajuda.",
    "explorer.share.pageDocInfo"     => "Instruções de configuração da base de conhecimento",
    "explorer.share.pageDocMenu1"    => "Quando o diretório raiz compartilhado contém o arquivo '_sidebar.md', o arquivo será automaticamente exibido à esquerda como uma análise de diretório, a sintaxe é markdown;",
    "explorer.share.pageDocMenu2"    => "As referências de link são diretórios relativos à pasta compartilhada. A extensão '.md' pode ser omitida.",
    "explorer.share.pageDocMenu3"    => "As referências de link suportam o redirecionamento de links para outros arquivos md Prefixo do link +@+ link do arquivo md.",
    "explorer.share.pageDocMenu4"    => "Referência de efeito geral",
    "explorer.share.selfExit"        => "Sair desta colaboração",
    "explorer.share.selfExitConfirm" => "Tem certeza de que deseja sair da colaboração? Você não poderá mais acessar o conteúdo da colaboração após sair.",
    "explorer.shareOut.title"        => "Compartilhamento de juntas externas",
    "explorer.shareOut.desc"         => "Compartilhando conteúdo entre diferentes sites de disco de rede",
    "explorer.shareOut.titlePath"    => "Compartilhamento de juntas externas",
    "explorer.shareOut.titlePathDesc" => "Conteúdo compartilhado comigo por sites externos",
    "explorer.shareOut.sendDesc1"    => "Os direitos do usuário final receptor são os direitos definidos e não são afetados pelos direitos de compartilhamento de links externos.",
    "explorer.shareOut.sendDesc2"    => "A versão principal do programa do disco de rede deve ser consistente, e o outro site deve ter a função de compartilhamento conjunto externo habilitada.",
    "explorer.shareOut.targetAdd"    => "Adicione pessoas para compartilhar",
    "explorer.shareOut.targetDel"    => "Confirme para cancelar o compartilhamento deste objeto do site",
    "explorer.shareOut.targetEdit"   => "Editar objetos compartilhados",
    "explorer.shareOut.targetUrl"    => "Compartilhar Site",
    "explorer.shareOut.targetUrlDesc" => "O servidor do site compartilhado precisa ser capaz de acessar o site atual",
    "explorer.shareOut.targetName"   => "nome de exibição",
    "explorer.shareOut.targetNameDesc" => "Aliases usados para exibir objetos compartilhados",
    "explorer.shareOut.targetAuth"   => "Direitos de acesso",
    "explorer.shareOut.targetUser"   => "Compartilhe com",
    "explorer.shareOut.targetUserDesc1" => "Conta de usuário/apelido/endereço de e-mail/número de telefone celular",
    "explorer.shareOut.targetUserDesc2" => "Suporta especificação de ID de usuário, por exemplo",
    "explorer.shareOut.targetUserDesc3" => "Especificação de ID do departamento de suporte, por exemplo",
    "explorer.shareOut.siteAdd"      => "Adição rápida",
    "explorer.shareOut.configSend"   => "Permitir compartilhamento com sites externos",
    "explorer.shareOut.configSendDesc" => "Depois de ativado, ele oferece suporte ao compartilhamento com contas designadas em outros sites de disco de rede ao compartilhar links externos e oferece suporte à configuração de permissões independentes.",
    "explorer.shareOut.configReceive" => "Permitir compartilhamento de sites externos",
    "explorer.shareOut.configReceiveDesc" => "Após a abertura, sites externos podem ser enviados e compartilhados com o site atual. Após o fechamento, não serão mais recebidos.",
    "explorer.shareOut.siteSafe"     => "Site confiável",
    "explorer.shareOut.siteSafeDesc1" => "Quando usado para compartilhamento externo, você pode obter a estrutura organizacional do site confiável e selecionar rapidamente usuários e departamentos",
    "explorer.shareOut.siteSafeDesc2" => "A versão do programa do disco de rede deve ser consistente, e o outro site deve ter a função de compartilhamento e recebimento conjunto externo habilitada.",
    "explorer.shareOut.siteSafeDel"  => "Confirme para excluir o site confiável",
    "explorer.shareOut.siteSafeAdd"  => "Adicionar um site confiável",
    "explorer.shareOut.siteSafeEdit" => "Editar Site Confiável",
    "explorer.shareOut.siteUrl"      => "URL do site",
    "explorer.shareOut.siteUrlDesc"  => "O URL do site do disco de rede da outra parte requer que o servidor do site do disco de rede atual seja capaz de acessar um ao outro",
    "explorer.shareOut.siteName"     => "Nome do site",
    "explorer.shareOut.siteApiKey"   => "Chave de API do site",
    "explorer.shareOut.siteApiKeyDesc" => "A apiKey do site da outra parte pode ser obtida no plano de fundo do site confiável: Configurações básicas — Compartilhamento de link externo — Minha apiKey",
    "explorer.shareOut.siteApiKeySelf" => "A apiKey do site atual",
    "explorer.shareOut.siteApiKeySelfDesc1" => "Esta apiKey é usada apenas para compartilhamento conjunto de nuvem e acesso confiável ao site",
    "explorer.shareOut.errorNetwork" => "A solicitação falhou. Confirme se o URL do disco de rede de destino está correto e se a versão mais recente está correta.",
    "explorer.shareOut.errorTitle"   => "Erro de compartilhamento de articulação externa",
    "explorer.shareOut.errorDisableShare" => "A função de compartilhamento de links externos foi fechada. Entre em contato com o administrador!",
    "explorer.shareOut.errorDisableSend" => "Compartilhamento de link externo - a função de compartilhamento de conjunto externo não está habilitada!",
    "explorer.shareOut.errorDisableReceive" => "Compartilhamento de link externo - a função de compartilhamento de conjunto externo não está habilitada!",
    "explorer.shareOut.errorApiKey"  => "A apiKey do site está incorreta, digite novamente!",
    "explorer.shareOut.errorTarget"  => "O objeto de destino não existe. Confirme e tente novamente!",
    "explorer.shareOut.errorCallLimit" => "A solicitação é muito frequente, tente novamente mais tarde!",
    "explorer.shareOut.errorShareNotExist" => "O compartilhamento não existe ou o compartilhamento externo foi removido",
    "explorer.shareOut.errorShareAuth" => "Você não tem permissão para acessar este compartilhamento externo! Entre em contato com o administrador do site de origem do compartilhamento.",
    "explorer.shareDoc.menuUser"     => "Diretório personalizado",
    "explorer.shareDoc.menuTree"     => "diretório da árvore de pastas",
    ...
    "explorer.auth.showMore"         => "Detalhes da permissão",
    "explorer.auth.tabUser"          => "membro do departamento",
    "explorer.auth.tabChildren"      => "Permissões de subpasta",
    "explorer.auth.tabParentTips"    => "O usuário ou departamento que tem permissões para esta pasta (herdadas de todas as permissões de nível superior)",
    "explorer.auth.tabUserTips"      => "Permissões iniciais dos membros do departamento",
    "explorer.auth.tabChildrenTips"  => "Conteúdo com permissões definidas nesta pasta",
    "explorer.auth.resetUser"        => "Substituir a configuração desta permissão de usuário",
    "explorer.auth.resetUserBtn"     => "Substituir permissões",
    "explorer.auth.resetUserBtnTips" => "Substituir o usuário e todas as permissões de subpastas (pastas) nesta pasta",
    "explorer.auth.resetUserHeader"  => "A pasta de nível inferior contém o conteúdo que especifica as permissões do usuário e define todas as substituições para as permissões acima",
    "explorer.auth.resetUserContiner" => "Contém o conteúdo da permissão do usuário",
    "explorer.auth.resetUserEmpty1"  => "Não há conteúdo para o qual as permissões estejam definidas para este usuário, não há necessidade de substituir",
    "explorer.auth.resetUserEmpty2"  => "Todo o conteúdo filho herda as permissões de pasta do nível atual",
    "explorer.rename.mutil"          => "Renomeação de lotes",
    "explorer.rename.title"          => "Você pode adicionar várias vezes, arrastar e soltar (desduplicação automática) e escolher um método de nomenclatura para processamento rápido em lote.",
    ...
    "explorer.rename.typeReplaceReg" => "Substituição regular",
    ...
    "explorer.rename.allowExt"       => "Se deve substituir a extensão",
    ...
    "explorer.tag.remove"            => "Tem certeza de que deseja excluir esta tag?",
    ...
    "explorer.tag.default2"          => "Informações de trabalho",
    "explorer.tag.default3"          => "Dados pessoais",
    ...
    "explorer.panel.thumbClear"      => "limpar miniatura",
    "explorer.panel.thumbClearDesc"  => "Limpar miniaturas de arquivos, arte da capa para regenerar.",
    ...
    "explorer.safe.name"             => "Privacidade segura",
    "explorer.safe.desc"             => "Cofre privado, dando dupla proteção aos seus dados importantes.",
    "explorer.safe.userShow"         => "Exibição do diretório raiz do espaço pessoal",
    "explorer.safe.adminOpen"        => "Habilitar espaço pessoal-cofre privado",
    "explorer.safe.adminOpenDesc"    => "Após o fechamento, os desabilitados não poderão mais ser habilitados e os habilitados não serão afetados.",
    "explorer.safe.isNotOpen"        => "Cofre privado não aberto",
    "explorer.safe.isNotLogin"       => "Não logado no cofre privado",
    "explorer.safe.isLogin"          => "Conectado em cofre privado",
    "explorer.safe.open"             => "Ativar cofre privado",
    "explorer.safe.doOpen"           => "Ative agora",
    "explorer.safe.doOpenTips"       => "O endereço de e-mail não está vinculado, vincule o endereço de e-mail na central pessoal e tente novamente (para recuperação de senha)",
    "explorer.safe.doOpenSuccess"    => "O cofre privado foi ativado com sucesso!",
    "explorer.safe.doOpenOpend"      => "Ligadas",
    "explorer.safe.doLoginOk"        => "Entrei no cofre privado!",
    "explorer.safe.doCheckLimit"     => "Só é permitido enviar uma vez por minuto",
    "explorer.safe.sendMailTitle"    => "Senha privada de recuperação segura",
    "explorer.safe.sendMailTips"     => "O código de verificação foi enviado para seu e-mail",
    "explorer.safe.sendMailGet"      => "Por favor preencha o código de verificação após verificar",
    "explorer.safe.passwordChanged"  => "Redefinição de senha concluída.",
    "explorer.secret.title"          => "Gerenciamento de confidencialidade de documentos",
    "explorer.secret.isOpen"         => "Se deve habilitar",
    "explorer.secret.isOpenDesc"     => "Habilitar e desabilitar o gerenciamento do nível de segurança",
    "explorer.secret.setUser"        => "gerente secreto",
    "explorer.secret.setUserDesc"    => "Especifique o usuário que pode definir o nível de confidencialidade (é recomendável que seja o proprietário do departamento correspondente)",
    "explorer.secret.type"           => "Tipo de classificação",
    "explorer.secret.add"            => "Adicionar nível de segurança",
    "explorer.secret.edit"           => "editar nível de segurança",
    "explorer.secret.name"           => "Nome da classe",
    "explorer.secret.style"          => "estilo",
    "explorer.secret.auth"           => "Permissão de nível secreto",
    "explorer.secret.authHas"        => "As permissões confidenciais incluem",
    "explorer.secret.createUser"     => "normatizador",
    "explorer.secret.folderAt"       => "pasta confidencial",
    ...
    "user.fileShowDesc"              => "Mostrar introdução da pasta",
    "user.fileShowDescTips"          => "modo somente ícone",
    "user.fileShowRename"            => "Mostrar botão renomear",
    "user.fileShowRenameTips"        => "Exibir um botão de renomeação quando o mouse estiver sobre um arquivo",
    "user.fileOpenClick"             => "Abra o arquivo (pasta) da seguinte forma",
    "user.fileOpenClick.dbclick"     => "Abrir com duplo clique",
    "user.fileOpenClick.click"       => "Abra clicando",
    "user.viewSetting"               => "Mostrar opções",
    ...
    "user.rootName"                  => "Configure uma conta de administrador",
    ...
    "user.logoutTrigger"             => "Sua conta já foi acessada em outro dispositivo, tente novamente mais tarde.",
    "user.loginState.name"           => "dispositivo on-line",
    "user.loginState.current"        => "dispositivo atual",
    "user.loginState.logout"         => "forçar sair",
    "user.loginState.logoutDesc"     => "Tem certeza de que deseja forçar o encerramento deste dispositivo?",
    ...
    "user.inputName"                 => "Por favor insira o nome de usuário",
    ...
    "user.registNotAllow"            => "O sistema não está aberto para inscrições, entre em contato com o administrador!",
    "user.deregistNotAllow"          => "O sistema não habilitou o registro e não suporta operações de logout. Entre em contato com o administrador!",
    ...
    "user.agreementDesc"             => "Ter lido e concordado com o seguinte acordo:",
    "user.agreementDgDesc"           => "Para melhor proteger seus direitos e interesses, leia e concorde com o seguinte acordo:",
    "user.menuBarAutoHide"           => "O menu esquerdo mostra e esconde automaticamente",
    "user.menuBarAutoHideDesc"       => "Após a abertura, o menu esquerdo fica oculto por padrão e será exibido quando o mouse for movido lentamente para o lado esquerdo e será automaticamente oculto quando for movido para fora",
    ...
    "log-type-fileDownload"          => "⇬ Fazer download do arquivo",
    "log-event-fileDownload"         => "baixou o arquivo",
    "log-event-fileDownload-item"    => "baixado [1]",
    "log-event-fileDownload-more"    => "[1] arquivo baixado",
    ...
    "log-event-edit"                 => "atualizou o arquivo",
    "log-event-edit-item"            => "Edição atualizada [1]",
    "log-event-edit-more"            => "Editar [1] arquivos atualizados",
    ...
    "log-event-history-remove"       => "Excluída a versão histórica [2] de [1]",
    "log-event-history-rollback"     => "Defina a versão histórica [2] de [1] como a versão atual",
    "log-event-history-clear"        => "Todas as versões históricas de [1] foram removidas",
    ...
    "meta.user_sourceCover"          => "Capa do documento",
    ...
    "explorer.filter.shareCopyLimit" => "O número de arquivos a serem despejados excede o limite; o número máximo de arquivos que você pode despejar é:",
    "explorer.filter.shareSizeLimit" => "O tamanho do arquivo compartilhado excede o limite; o máximo que você pode compartilhar é:",
    "explorer.filter.unzipSizeLimit" => "O tamanho do arquivo descompactado excede o limite; o máximo que você pode descompactar é:",
    "explorer.filter.zipSizeLimit"   => "O tamanho do arquivo compactado excede o limite; seus documentos compactados máximos:",
    "explorer.filter.uploadSizeLimit" => "O tamanho do upload excede o limite; o máximo que você pode fazer upload é:"
);