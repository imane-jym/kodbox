...
return array(
    ...
    "admin.menu.server"              => "Услуги и оборудование",
    ...
    "admin.server.base"              => "Статус обслуживания",
    "admin.server.server"            => "Системные службы",
    "admin.server.file"              => "Файловые службы",
    "admin.server.net"               => "Сеть и связь",
    ...
    "admin.setting.passwordRuleStrongDesc" => "Длина не должна быть меньше 6; должна содержать цифры и английские буквы.",
    "admin.setting.passwordRuleStrongMoreDesc" => "Длина пароля должна быть не менее 8 символов; пароль должен содержать не менее 3 типов комбинаций цифр, заглавных букв, строчных букв и специальных символов.",
...
<li> Диапазон IP-адресов: IP соответствует диапазону; например: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.recDescInfo21"    => "Системные данные можно восстановить, записав резервную копию данных в новую базу данных и установив ее в качестве системной базы данных по умолчанию.",
    "admin.setting.recDescInfo22"    => "Новые параметры конфигурации базы данных будут добавлены в системный файл конфигурации config/setting_user.php. Если после восстановления система столкнётся с исключением, вы можете удалить добавленную часть файла, не затрагивая предыдущие системные данные.",
    ...
    "admin.setting.recDescInfo32"    => "Например, если текущая конфигурация базы данных: Пользователь: test; Пароль: test123, войдите в базу данных, используя учетную запись root, и выполните соответствующий оператор SQL, чтобы установить разрешения (разрешения могут быть отозваны после успешного прохождения теста и восстановления).",
    ...
    "ERROR_USER_PASSWORD_MISSING"    => "Отсутствует пароль",
    ...
    "admin.authFrom.setUser"         => "Указание прав пользователя",
...
<li> Обновление: после загрузки загрузите и разархивируйте в папку с именем соответствующего плагина;</li>",
    ...
    "admin.storage.errTimeout"       => "Запрос на обслуживание истек!",
    ...
    "admin.storage.groupDef"         => "Хранилище по умолчанию",
    "admin.storage.groupLoc"         => "Локальное хранилище",
    "admin.storage.groupObj"         => "Хранение объектов",
    "admin.storage.groupNet"         => "Сетевое хранилище",
    "admin.storage.groupOth"         => "Другое хранилище",
    ...
    "admin.backup.openDesc"          => "Резервное копирование системных баз данных и файлов",
    ...
    "admin.backup.ifSave"            => "Вы уверены, что хотите создать резервную копию?",
    ...
    "admin.backup.optionTime"        => "Чтобы избежать последствий изменения данных, пожалуйста, выберите проведение операции в нерабочее время.",
    "admin.backup.optionLocation"    => "Пожалуйста, создайте новое независимое хранилище специально для резервного копирования файлов.",
    "admin.backup.optionTips1"       => "Резервная копия состоит из двух частей: базы данных и файлов. Рекомендуется создать резервную копию обеих.",
    "admin.backup.optionTips2"       => "Резервное копирование базы данных: создание файла SQL из содержимого базы данных и его резервное копирование в целевое хранилище (системное хранилище по умолчанию только для базы данных).",
    ...
    "admin.backup.needNoDefault"     => "Не выбирайте системное хранилище по умолчанию в качестве места хранения резервных копий файлов!",
    ...
    "admin.backup.freeBakDesc"       => "Бесплатная версия поддерживает только резервное копирование базы данных.",
    ...
    "admin.backup.taskDbDesc"        => "Автоматически создавать резервную копию базы данных системы",
    "admin.backup.taskFileDesc"      => "Автоматически создавать резервные копии системных файлов",
    "admin.backup.addStoreHasFile"   => "Это хранилище содержит системные данные. Сначала выполните миграцию или добавьте новое хранилище!",
    "admin.backup.title"             => "Инструкции по резервному копированию файлов",
    "admin.backup.bakFileTip1"       => "Резервное копирование файлов — это независимая задача. Частота её выполнения, ход выполнения и другая информация не включаются в резервное копирование базы данных. Подробности задачи см. в разделе %s.",
    "admin.backup.bakFileTip2"       => "Ход процесса резервного копирования (копирования) файлов в реальном времени можно просмотреть в %s;",
    "admin.backup.bakFileTip3"       => "Если резервное копирование не удалось, вы можете просмотреть подробности в журнале %s;",
    "admin.backup.bakFileTip4"       => "Сбои резервного копирования обычно вызваны неисправным подключением к хранилищу (невозможность чтения или записи файлов). Для обеспечения корректного выполнения резервного копирования убедитесь, что все устройства хранения подключены правильно.",
    "admin.backup.bakFileTask"       => "Запланированные задачи — Резервное копирование данных (файл)",
    "admin.backup.full"              => "Полное резервное копирование",
    "admin.backup.fullDesc"          => "Начать резервное копирование с первого файла",
    "admin.backup.increment"         => "Инкрементное резервное копирование",
    "admin.backup.incrementDesc"     => "Продолжить резервное копирование на основе последней задачи",
    "admin.backup.sameSkip"          => "(Файлы с одинаковыми именами будут игнорироваться)",
    "admin.backup.clickDtl"          => "Нажмите, чтобы просмотреть подробности",
    "admin.backup.ifBakFile"         => "Вы уверены, что хотите создать резервную копию своих файлов?",
    "admin.restore.ifRecDb"          => "Восстановление базы данных изменит текущие системные данные. Вы уверены, что хотите выполнить это?",
    "admin.restore.ifRecFile"        => "Восстановление файлов изменит текущие системные данные. Вы уверены, что хотите выполнить это?",
    "admin.restore.fileRec"          => "Восстановление файлов",
    "admin.restore.importTips"       => "Важное напоминание",
    "admin.restore.recType"          => "Восстановить контент",
    "admin.restore.recTypeDb"        => "Восстановление базы данных",
    "admin.restore.recTypeFile"      => "Восстановление файлов",
    "admin.restore.recFileDesc1"     => "Восстановление файлов заключается в копировании файлов из резервного хранилища в хранилище по умолчанию на основе текущих записей файлов системы для восстановления физических файлов системы.",
    "admin.restore.recFileDesc2"     => "Примечание: Копирование в процессе восстановления зависит от файловых записей текущей базы данных. Если это предполагает переустановку системы, сначала необходимо восстановить базу данных.",
    "admin.restore.recFileDesc3"     => "Восстановление файлов — это трудоёмкая операция, особенно если объём данных большой или они находятся на разных хранилищах. Пожалуйста, будьте терпеливы во время выполнения.",
    "admin.restore.bakPath"          => "Резервный каталог",
    "admin.restore.bakDbPath"        => "Каталог резервных копий базы данных",
    "admin.restore.bakFilePath"      => "Каталог резервных копий файлов",
    "admin.restore.full"             => "Полное восстановление",
    "admin.restore.fullDesc"         => "Полное восстановление начинается с первого файла, в противном случае оно будет продолжено с последней задачи. Существующие файлы будут проигнорированы.",
    "admin.restore.needVipDesc"      => "Бесплатная версия поддерживает только восстановление базы данных.",
    "admin.restore.needVipTips"      => "Текущая версия не поддерживает эту операцию, пожалуйста, обновитесь до Enterprise Edition.",
    "admin.restore.bakEmpty"         => "Выбранный каталог резервного копирования пуст",
    "admin.restore.noFileNeed"       => "В системе нет файлов, требующих восстановления.",
    "admin.restore.taskRepeat"       => "Задача находится в процессе выполнения, пожалуйста, не повторяйте операцию.",
 ...
 post_max_size, нужно перезагрузить)",
    ...
    "common.isOpen"                  => "Функция включена?",
    ...
    "common.readWrite"               => "Доступно для чтения и записи",
    "common.noAuth"                  => "Нет разрешений",
    "common.site"                    => "Сайт",
    ...
    "common.copyright.metaKeywords"  => "haisum, KodExplorer, kod, kodCloud, webos, webIDE, php filemanage, filemanage, Kedao Cloud, Mango Cloud, система управления документами, корпоративный облачный диск, проводник, онлайн-документы, онлайн-офис, онлайн-офис, онлайн-просмотр CAD, Онлайн редактор, онлайн редактор",
    ...
    "explorer.wrtSetUserError"       => "Файл конфигурации системы (config/setting_user.php) не имеет разрешения на запись!",
    ...
    "explorer.groupAuthFrom"         => "Источник авторизации",
    "explorer.groupAuthCopy"         => "Скопировать комбинацию",
    "explorer.groupAuthCopyDesc"     => "Скопировать комбинацию",
 ...
 Поддержка пиньинь, нечеткое соответствие первой буквы",
    ...
    "explorer.share.linkToFast"      => "Быстрый внешний обмен ссылками",
    "explorer.share.shareSystem"     => "Совместное использование системы",
    "explorer.share.shareSystemDesc" => "Совместный доступ к файлам, созданным другими приложениями или плагинами",
    ...
    "explorer.share.selfExit"        => "Выйти из этого сотрудничества",
    "explorer.share.selfExitConfirm" => "Вы уверены, что хотите выйти из совместной работы? После выхода вы больше не сможете получить доступ к контенту совместной работы.",
    "explorer.shareOut.title"        => "Внешнее совместное использование",
    "explorer.shareOut.desc"         => "Обмен контентом между различными сетевыми дисковыми площадками",
    "explorer.shareOut.titlePath"    => "Внешнее совместное использование",
    "explorer.shareOut.titlePathDesc" => "Контент, предоставленный мне внешними сайтами",
    "explorer.shareOut.sendDesc1"    => "Права конечного пользователя, получающего информацию, являются установленными правами и не зависят от прав на внешний доступ к ссылкам.",
    "explorer.shareOut.sendDesc2"    => "Основная версия программы сетевого диска должна быть согласована, а на другом сайте должна быть включена функция внешнего совместного доступа.",
    "explorer.shareOut.targetAdd"    => "Добавьте людей, с которыми можно поделиться",
    "explorer.shareOut.targetDel"    => "Подтвердите отмену совместного использования этого объекта сайта",
    "explorer.shareOut.targetEdit"   => "Редактировать общие объекты",
    "explorer.shareOut.targetUrl"    => "Поделиться сайтом",
    "explorer.shareOut.targetUrlDesc" => "Сервер общего сайта должен иметь доступ к текущему сайту.",
    "explorer.shareOut.targetName"   => "отображаемое имя",
    "explorer.shareOut.targetNameDesc" => "Псевдонимы, используемые для отображения общих объектов",
    "explorer.shareOut.targetAuth"   => "Права доступа",
    "explorer.shareOut.targetUser"   => "Поделиться с",
    "explorer.shareOut.targetUserDesc1" => "Учетная запись пользователя/никнейм/адрес электронной почты/номер мобильного телефона",
    "explorer.shareOut.targetUserDesc2" => "Поддерживает указание идентификатора пользователя, например",
    "explorer.shareOut.targetUserDesc3" => "Например, спецификация идентификатора отдела поддержки",
    "explorer.shareOut.siteAdd"      => "Быстрое добавление",
    "explorer.shareOut.configSend"   => "Разрешить обмен данными с внешними сайтами",
    "explorer.shareOut.configSendDesc" => "После включения он поддерживает общий доступ к назначенным учетным записям на других сетевых дисках при предоставлении общего доступа к внешним ссылкам, а также поддерживает настройку независимых разрешений.",
    "explorer.shareOut.configReceive" => "Разрешить обмен с внешних сайтов",
    "explorer.shareOut.configReceiveDesc" => "После открытия внешние сайты могут отправлять и делиться контентом на текущий сайт. После закрытия он больше не будет приниматься.",
    "explorer.shareOut.siteSafe"     => "Доверенный сайт",
    "explorer.shareOut.siteSafeDesc1" => "При использовании для внешнего совместного доступа вы можете получить организационную структуру доверенного сайта и быстро выбрать пользователей и отделы.",
    "explorer.shareOut.siteSafeDesc2" => "Версия программы сетевого диска должна быть согласованной, а на другом сайте должна быть включена функция внешнего совместного доступа и получения.",
    "explorer.shareOut.siteSafeDel"  => "Подтвердите удаление доверенного сайта.",
    "explorer.shareOut.siteSafeAdd"  => "Добавить доверенный сайт",
    "explorer.shareOut.siteSafeEdit" => "Редактировать доверенный сайт",
    "explorer.shareOut.siteUrl"      => "URL-адрес сайта",
    "explorer.shareOut.siteUrlDesc"  => "URL-адрес сайта сетевого диска другой стороны требует, чтобы текущий сервер сайта сетевого диска имел возможность доступа друг к другу.",
    "explorer.shareOut.siteName"     => "Название сайта",
    "explorer.shareOut.siteApiKey"   => "Сайт API-ключ",
    "explorer.shareOut.siteApiKeyDesc" => "API-ключ чужого сайта можно получить в фоновом режиме доверенного сайта: Основные настройки -- Общий доступ по внешней ссылке -- Мой API-ключ.",
    "explorer.shareOut.siteApiKeySelf" => "API-ключ текущего сайта",
    "explorer.shareOut.siteApiKeySelfDesc1" => "Этот API-ключ используется только для совместного использования облака и доступа к доверенным сайтам.",
    "explorer.shareOut.errorNetwork" => "Запрос не выполнен. Проверьте правильность URL-адреса целевого сетевого диска и актуальность версии.",
    "explorer.shareOut.errorTitle"   => "Ошибка внешнего совместного использования",
    "explorer.shareOut.errorDisableShare" => "Функция внешнего обмена ссылками закрыта, пожалуйста, свяжитесь с администратором!",
    "explorer.shareOut.errorDisableSend" => "Функция внешнего совместного доступа по ссылке не включена!",
    "explorer.shareOut.errorDisableReceive" => "Функция внешнего совместного доступа по ссылке не включена!",
    "explorer.shareOut.errorApiKey"  => "Неверный API-ключ сайта, введите его повторно!",
    "explorer.shareOut.errorTarget"  => "Целевой объект не существует. Пожалуйста, подтвердите и попробуйте ещё раз!",
    "explorer.shareOut.errorCallLimit" => "Запрос слишком частый, попробуйте еще раз позже!",
    "explorer.shareOut.errorShareNotExist" => "Общий ресурс не существует или внешний общий ресурс был удален.",
    "explorer.shareOut.errorShareAuth" => "У вас нет разрешения на доступ к этому внешнему ресурсу! Обратитесь к администратору сайта, на котором был создан этот ресурс.",
    ...
    "explorer.auth.tabParentTips"    => "Пользователь или отдел, имеющий разрешения для этой папки (унаследованные от всех разрешений верхнего уровня)",
    ...
    "explorer.tag.default2"          => "Информация о работе",
    "explorer.tag.default3"          => "Персональные данные",
    ...
    "user.registNotAllow"            => "Система закрыта для регистрации, обратитесь к администратору!",
    "user.deregistNotAllow"          => "Система не поддерживает регистрацию и выход из системы. Обратитесь к администратору!",
