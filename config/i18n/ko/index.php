...
<li> 업데이트 : 다운로드 후 해당 플러그인 이름 폴더에 업로드하고 압축을 풉니 다.</li>",
 ...
 post_max_size, 다시 시작해야 함)",
    ...
    "common.copyright.desc"          => "haisum는 유명한 웹 문서 관리 시스템으로, 이전에는 KodExplorer로 알려져 있었기 때문에 서버에서 웹 사이트를 관리 할뿐만 아니라 내부 문서 관리 또는 공유에 사용할 수 있습니다. Ftp 대신 webIDE로 직접 개발할 수도 있습니다. 동시에이 프로그램의 2 차 개발을 기존 시스템에 통합 할 수 있습니다.",
    ...
    "common.copyright.metaKeywords"  => "haisum, KodExplorer, kod, kodCloud, webos, webIDE, php 파일 관리, 파일 관리, Kedao Cloud, 망고 클라우드, 문서 관리 시스템, 엔터프라이즈 클라우드 디스크, 탐색기, 온라인 문서, 온라인 사무실, 온라인 사무실, 온라인 CAD 미리보기, 온라인 편집자, 온라인 편집자",
