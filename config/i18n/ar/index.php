...
return array(
    ...
    "admin.menu.server"              => "الخدمات والمعدات",
    ...
    "admin.server.base"              => "حالة الخدمة",
    "admin.server.server"            => "خدمات النظام",
    "admin.server.file"              => "خدمات الملفات",
    "admin.server.net"               => "الشبكة والاتصال",
    ...
    "admin.setting.passwordRuleStrongDesc" => "يجب ألا يقل الطول عن 6 ويجب أن يحتوي على أرقام وحروف إنجليزية",
    "admin.setting.passwordRuleStrongMoreDesc" => "يجب أن يكون الطول 8 أحرف على الأقل؛ ويجب أن يحتوي على 3 أنواع على الأقل من مجموعات الأرقام والأحرف الكبيرة والأحرف الصغيرة والأحرف الخاصة.",
...
<li> نطاق IP: تطابق IP ضمن النطاق ؛ على سبيل المثال: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.emailType"        => "نوع صندوق البريد",
    ...
    "admin.setting.recDescInfo21"    => "يمكن استعادة بيانات النظام عن طريق كتابة بيانات النسخ الاحتياطي إلى قاعدة بيانات جديدة وتعيينها كإعداد افتراضي للنظام.",
    "admin.setting.recDescInfo22"    => "سيتم إضافة معلمات تكوين قاعدة البيانات الجديدة إلى ملف تكوين النظام config/setting_user.php. إذا واجه النظام استثناءً بعد الاستعادة، يمكنك حذف الجزء المُضاف من الملف دون التأثير على بيانات النظام السابقة.",
    ...
    "admin.setting.recDescInfo32"    => "على سبيل المثال، إذا كان تكوين قاعدة البيانات الحالي هو: المستخدم: test؛ كلمة المرور: test123، قم بتسجيل الدخول إلى قاعدة البيانات باستخدام حساب الجذر وقم بتنفيذ عبارة SQL المقابلة لتعيين الأذونات (يمكن إلغاء الأذونات بعد اجتياز الاختبار ونجاح الاستعادة).",
    ...
    "ERROR_USER_PASSWORD_MISSING"    => "كلمة المرور مفقودة",
    ...
    "admin.authFrom.setUser"         => "تحديد أذونات المستخدم",
...
<li> تحديث: بعد التنزيل والتحميل وفك الضغط إلى مجلد اسم المكون الإضافي المقابل ؛</li>",
    ...
    "admin.plugin.closedError"       => "لم يتم تمكين المكون الإضافي، يرجى الاتصال بالمسؤول!",
    ...
    "admin.storage.errNoCnt"         => "الملفات الفعلية %s غير موجودة أو لا يمكن الوصول إليها",
    ...
    "admin.storage.errTimeout"       => "انتهت مهلة طلب الخدمة!",
    "admin.storage.tryOrRmNow"       => "يمكنك إلغاء إعادة المحاولة، أو إلغاء التثبيت مباشرة (سيتم حذف الملفات، يرجى المتابعة بحذر!).",
    ...
    "admin.storage.oosKeyDesc"       => "معرف مفتاح الوصول، يرجى إنشائه في [Console-Access Key Management]",
    ...
    "admin.storage.ftpBsPathErr"     => "حاول استخدام [0] كدليل تخزين.",
    ...
    "admin.storage.s3SignVer"        => "النسخة الموقعة",
    "admin.storage.s3SignVerDesc"    => "نسخة موقعة من المصادقة",
    "admin.storage.s3FormUpload"     => "تحميل النموذج",
    "admin.storage.s3FormUploadDesc" => "بعض خدمات التخزين لا تدعم هذه الوظيفة. سوف يفشل تحميل الملفات التي يقل حجمها عن 10 ميجابايت أثناء النقل المباشر للواجهة الأمامية. يمكنك إيقاف تشغيل هذه الميزة.",
    "admin.storage.ioReset"          => "تحديد موقع التخزين",
    "admin.storage.ioResetDesc"      => "إذا كان فارغًا، فسيتم استخدام التخزين الافتراضي الحالي، مما يؤثر فقط على موقع التخزين الافتراضي للملفات التي تم تحميلها بعد التعديل.",
    "admin.storage.groupDef"         => "التخزين الافتراضي",
    "admin.storage.groupLoc"         => "التخزين المحلي",
    "admin.storage.groupObj"         => "تخزين الكائنات",
    "admin.storage.groupNet"         => "تخزين الشبكة",
    "admin.storage.groupOth"         => "تخزين آخر",
    ...
    "admin.backup.open"              => "تمكين النسخ الاحتياطي",
    "admin.backup.openDesc"          => "النسخ الاحتياطي لقواعد بيانات النظام والملفات",
    ...
    "admin.backup.ifSave"            => "هل أنت متأكد أنك تريد عمل نسخة احتياطية؟",
    ...
    "admin.backup.optionTime"        => "لتجنب تأثير تغييرات البيانات، يرجى اختيار إجراء العملية أثناء ساعات غير العمل.",
    "admin.backup.optionLocation"    => "يرجى إنشاء وحدة تخزين مستقلة جديدة خصيصًا للنسخ الاحتياطي للملفات",
    "admin.backup.optionTips1"       => "ينقسم النسخ الاحتياطي إلى قسمين: قاعدة البيانات والملفات. يُنصح بنسخ كليهما احتياطيًا.",
    "admin.backup.optionTips2"       => "نسخ احتياطي لقاعدة البيانات: إنشاء ملف SQL من محتوى قاعدة البيانات والنسخ الاحتياطي له إلى وحدة التخزين المستهدفة (وحدة التخزين الافتراضية للنظام لقاعدة البيانات فقط).",
    ...
    "admin.backup.needNoDefault"     => "لا تقم باختيار تخزين النظام الافتراضي كموقع للنسخ الاحتياطي للملفات!",
    ...
    "admin.backup.freeBakDesc"       => "الإصدار المجاني يدعم النسخ الاحتياطي لقاعدة البيانات فقط",
    ...
    "admin.backup.taskDbDesc"        => "النسخ الاحتياطي لقاعدة بيانات النظام تلقائيًا",
    "admin.backup.taskFileDesc"      => "النسخ الاحتياطي التلقائي لملفات النظام",
    "admin.backup.addStoreHasFile"   => "تحتوي وحدة التخزين هذه على بيانات النظام، يرجى الترحيل أو إضافة وحدة تخزين جديدة أولاً!",
    "admin.backup.title"             => "تعليمات النسخ الاحتياطي للملفات",
    "admin.backup.bakFileTip1"       => "النسخ الاحتياطي للملفات مهمة مستقلة. لا يُدرج تكرار تنفيذها وتقدمها وأي معلومات أخرى في النسخ الاحتياطي لقاعدة البيانات. لمزيد من التفاصيل، راجع %s.",
    "admin.backup.bakFileTip2"       => "من الممكن عرض التقدم في الوقت الفعلي لعملية النسخ الاحتياطي للملفات (النسخ) في %s؛",
    "admin.backup.bakFileTip3"       => "إذا فشل النسخ الاحتياطي، يمكنك عرض التفاصيل في السجل %s؛",
    "admin.backup.bakFileTip4"       => "عادةً ما تحدث أعطال النسخ الاحتياطي بسبب خلل في اتصال وحدة التخزين (عدم القدرة على قراءة أو كتابة الملفات). لضمان تنفيذ النسخ الاحتياطي بشكل سليم، يُرجى التأكد من توصيل جميع أجهزة التخزين بشكل صحيح.",
    "admin.backup.bakFileTask"       => "المهام المجدولة - النسخ الاحتياطي للبيانات (ملف)",
    "admin.backup.full"              => "النسخ الاحتياطي الكامل",
    "admin.backup.fullDesc"          => "ابدأ النسخ الاحتياطي من الملف الأول",
    "admin.backup.increment"         => "النسخ الاحتياطي التدريجي",
    "admin.backup.incrementDesc"     => "متابعة النسخ الاحتياطي بناءً على المهمة الأخيرة",
    "admin.backup.sameSkip"          => "(سيتم تجاهل الملفات التي تحمل نفس الاسم)",
    "admin.backup.clickDtl"          => "انقر لعرض التفاصيل",
    "admin.backup.ifBakFile"         => "هل أنت متأكد أنك تريد عمل نسخة احتياطية لملفاتك؟",
    "admin.restore.ifRecDb"          => "ستؤدي استعادة قاعدة البيانات إلى تغيير بيانات النظام الحالية. هل أنت متأكد من رغبتك في تنفيذها؟",
    "admin.restore.ifRecFile"        => "ستؤدي استعادة الملف إلى تغيير بيانات النظام الحالية. هل أنت متأكد من رغبتك في تنفيذها؟",
    "admin.restore.fileRec"          => "استعادة الملف",
    "admin.restore.importTips"       => "تذكير هام",
    "admin.restore.recType"          => "استعادة المحتوى",
    "admin.restore.recTypeDb"        => "استعادة قاعدة البيانات",
    "admin.restore.recTypeFile"      => "استعادة الملف",
    "admin.restore.recFileDesc1"     => "استعادة الملفات هي نسخ الملفات من وحدة تخزين النسخ الاحتياطي إلى وحدة التخزين الافتراضية استنادًا إلى سجلات ملفات النظام الحالية لاستعادة الملفات المادية للنظام.",
    "admin.restore.recFileDesc2"     => "ملاحظة: يعتمد النسخ أثناء عملية الاستعادة على سجلات ملفات قاعدة البيانات الحالية. إذا تطلب الأمر إعادة تثبيت النظام، فيجب استعادة قاعدة البيانات أولًا.",
    "admin.restore.recFileDesc3"     => "استعادة الملفات عملية تستغرق وقتًا طويلاً، خاصةً عندما يكون حجم البيانات كبيرًا أو متعدد التخزين. يُرجى التحلي بالصبر أثناء التنفيذ.",
    "admin.restore.bakPath"          => "دليل النسخ الاحتياطي",
    "admin.restore.bakDbPath"        => "دليل النسخ الاحتياطي لقاعدة البيانات",
    "admin.restore.bakFilePath"      => "دليل النسخ الاحتياطي للملفات",
    "admin.restore.full"             => "استعادة كاملة",
    "admin.restore.fullDesc"         => "تبدأ عملية الاستعادة الكاملة من الملف الأول، وإلا فستستمر بناءً على آخر مهمة. سيتم تجاهل الملفات الموجودة.",
    "admin.restore.needVipDesc"      => "الإصدار المجاني يدعم استعادة قاعدة البيانات فقط",
    "admin.restore.needVipTips"      => "الإصدار الحالي لا يدعم هذه العملية، يرجى الترقية إلى إصدار Enterprise",
    "admin.restore.bakEmpty"         => "دليل النسخ الاحتياطي المحدد فارغ",
    "admin.restore.noFileNeed"       => "لا يوجد في النظام ملفات تحتاج إلى استعادتها",
    "admin.restore.taskRepeat"       => "المهمة قيد التنفيذ، يرجى عدم تكرار العملية",
 ...
 post_max_size ، تحتاج إلى إعادة التشغيل)",
    ...
    "common.readWrite"               => "قابلة للقراءة والكتابة",
    "common.noAuth"                  => "لا يوجد أذونات",
    "common.site"                    => "موقع",
    "common.ifDel"                   => "هل أنت متأكد أنك تريد الحذف؟",
    "common.pageNotExists"           => "هذه الصفحة غير موجودة!",
    "common.pathNotExists"           => "المستند غير موجود!",
    "common.phyFileNotExists"        => "الملفات المادية مفقودة أو لا يمكن الوصول إليها!",
    ...
    "common.copyright.metaKeywords"  => "haisum ، KodExplorer ، kod ، kodCloud ، webos ، webide ، php filemanage ، filemanage ، Kedao Cloud ، Mango Cloud ، نظام إدارة المستندات ، Enterprise Cloud Disk ، Explorer ، المستندات عبر الإنترنت ، Office Online ، Office Online ، Online CAD Preview ، محرر على الإنترنت ، محرر على الإنترنت",
    ...
    "common.date.tomorrow"           => "غداً",
    "common.date.week"               => ".هذا الاسبوع",
    "common.date.weekNext"           => "الأسبوع المقبل",
    "common.date.weekPrev"           => "الأسبوع الماضي",
    "common.date.month"              => "هذا الشهر",
    "common.date.monthNext"          => "الشهر المقبل",
    "common.date.monthPrev"          => "الشهر الماضي",
    "common.date.day7"               => "آخر 7 أيام",
    "common.date.day30"              => "آخر 30 يومًا",
    "common.date.day90"              => "آخر 90 يومًا",
    "common.date.day180"             => "آخر 180 يومًا",
    ...
    "explorer.complete"              => "اكتملت العملية!",
    ...
    "explorer.wrtSetUserError"       => "ملف تكوين النظام (config/setting_user.php) لا يحتوي على إذن الكتابة!",
    ...
    "explorer.groupAuthFrom"         => "مصدر التفويض",
    "explorer.groupAuthCopy"         => "نسخة مركبة",
    "explorer.groupAuthCopyDesc"     => "نسخة مركبة",
    ...
    "explorer.folderPass.add"        => "تعيين كلمة مرور المجلد",
    "explorer.folderPass.edit"       => "تحرير كلمة مرور المجلد",
    "explorer.folderPass.clearAsk"   => "هل أنت متأكد أنك تريد مسح كلمة مرور المجلد؟",
    "explorer.folderPass.hasDesc"    => "تعيين كلمة مرور المجلد",
    "explorer.folderPass.pass"       => "كلمة مرور الوصول",
    "explorer.folderPass.passRepeat" => "تأكيد كلمة المرور",
    "explorer.folderPass.desc"       => "وصف",
    "explorer.folderPass.timeOutDesc" => "وقت انتهاء صلاحية كلمة المرور، إذا لم يتم تعيينه، فهذا يعني أنها ستكون صالحة دائمًا.",
    "explorer.folderPass.timeOut"    => "وقت انتهاء الصلاحية",
 ...
 دعم بينيين ، مطابقة غامضة للحرف الأول",
    ...
    "explorer.upload.fopenError"     => "فشلت الكتابة، تحقق من أذونات القراءة والكتابة في الدليل",
    ...
    "explorer.search.path"           => "كتالوج البحث",
    "explorer.search.rootPath"       => "الدليل الجذر",
    ...
    "explorer.search.optionDesc"     => "وصف الملف",
    "explorer.search.optionTag"      => "تسميات المستخدم/القسم",
    ...
    "explorer.history.action"        => "عمليات النسخة التاريخية",
    "explorer.history.remove"        => "حذف النسخة التاريخية",
    ...
    "explorer.share.linkToFast"      => "مشاركة الروابط الخارجية السريعة",
    "explorer.share.shareSystem"     => "مشاركة النظام",
    "explorer.share.shareSystemDesc" => "المشاركة التعاونية التي تم إنشاؤها بواسطة تطبيقات أو مكونات إضافية أخرى",
    ...
    "explorer.share.selfExit"        => "الخروج من هذا التعاون",
    "explorer.share.selfExitConfirm" => "هل أنت متأكد من رغبتك في إنهاء التعاون؟ لن تتمكن من الوصول إلى محتوى التعاون بعد الخروج.",
    "explorer.shareOut.title"        => "مشاركة المفصل الخارجي",
    "explorer.shareOut.desc"         => "مشاركة المحتوى بين مواقع أقراص الشبكة المختلفة",
    "explorer.shareOut.titlePath"    => "المشاركة الخارجية المشتركة",
    "explorer.shareOut.titlePathDesc" => "المحتوى الذي تمت مشاركته معي من قبل المواقع الخارجية",
    "explorer.shareOut.sendDesc1"    => "حقوق المستخدم النهائي المتلقي هي الحقوق المحددة ولا تتأثر بحقوق مشاركة الارتباط الخارجي.",
    "explorer.shareOut.sendDesc2"    => "يجب أن يكون إصدار البرنامج الرئيسي للقرص الشبكي متسقًا، ويجب تمكين وظيفة المشاركة والاستقبال الخارجية في الموقع الآخر.",
    "explorer.shareOut.targetAdd"    => "أضف الأشخاص للمشاركة معهم",
    "explorer.shareOut.targetDel"    => "تأكيد إلغاء مشاركة كائن هذا الموقع",
    "explorer.shareOut.targetEdit"   => "تحرير الكائنات المشتركة",
    "explorer.shareOut.targetUrl"    => "مشاركة الموقع",
    "explorer.shareOut.targetUrlDesc" => "يجب أن يكون خادم الموقع المشترك قادرًا على الوصول إلى الموقع الحالي",
    "explorer.shareOut.targetName"   => "اسم العرض",
    "explorer.shareOut.targetNameDesc" => "الأسماء المستعارة المستخدمة لعرض الكائنات المشتركة",
    "explorer.shareOut.targetAuth"   => "حقوق الوصول",
    "explorer.shareOut.targetUser"   => "شارك مع",
    "explorer.shareOut.targetUserDesc1" => "حساب المستخدم/الاسم المستعار/عنوان البريد الإلكتروني/رقم الهاتف المحمول",
    "explorer.shareOut.targetUserDesc2" => "يدعم مواصفات معرف المستخدم، على سبيل المثال",
    "explorer.shareOut.targetUserDesc3" => "مواصفات معرف قسم الدعم، على سبيل المثال",
    "explorer.shareOut.siteAdd"      => "إضافة سريعة",
    "explorer.shareOut.configSend"   => "السماح بالمشاركة مع المواقع الخارجية",
    "explorer.shareOut.configSendDesc" => "بعد تشغيله، يمكن مشاركة الروابط الخارجية مع حسابات محددة على مواقع أقراص الشبكة الأخرى، ويمكن تعيين أذونات مستقلة.",
    "explorer.shareOut.configReceive" => "السماح بالمشاركة من المواقع الخارجية",
    "explorer.shareOut.configReceiveDesc" => "بعد الفتح، يُمكن للمواقع الخارجية الدفع والمشاركة إلى الموقع الحالي. بعد الإغلاق، لن يتم استلامها.",
    "explorer.shareOut.siteSafe"     => "موقع موثوق",
    "explorer.shareOut.siteSafeDesc1" => "عند استخدامه للمشاركة الخارجية المشتركة، يمكنك الحصول على الهيكل التنظيمي للموقع الموثوق به وتحديد المستخدمين والأقسام بسرعة",
    "explorer.shareOut.siteSafeDesc2" => "يجب أن يكون إصدار برنامج القرص الشبكي متسقًا، ويجب تمكين وظيفة مشاركة المفصل الخارجي في الموقع الآخر.",
    "explorer.shareOut.siteSafeDel"  => "تأكيد حذف الموقع الموثوق به",
    "explorer.shareOut.siteSafeAdd"  => "أضف موقعًا موثوقًا به",
    "explorer.shareOut.siteSafeEdit" => "تعديل الموقع الموثوق به",
    "explorer.shareOut.siteUrl"      => "عنوان الموقع",
    "explorer.shareOut.siteUrlDesc"  => "يتطلب عنوان URL لموقع قرص الشبكة الخاص بالطرف الآخر أن يتمكن خادم موقع قرص الشبكة الحالي من الوصول إلى بعضهما البعض",
    "explorer.shareOut.siteName"     => "اسم الموقع",
    "explorer.shareOut.siteApiKey"   => "مفتاح API للموقع",
    "explorer.shareOut.siteApiKeyDesc" => "يمكن الحصول على apiKey لموقع الطرف الآخر في خلفية الموقع الموثوق به: الإعدادات الأساسية - مشاركة الروابط الخارجية - apiKey الخاص بي",
    "explorer.shareOut.siteApiKeySelf" => "مفتاح API للموقع الحالي",
    "explorer.shareOut.siteApiKeySelfDesc1" => "يتم استخدام هذا المفتاح API فقط للمشاركة السحابية المشتركة والوصول إلى الموقع الموثوق به",
    "explorer.shareOut.errorNetwork" => "فشل الطلب. يُرجى التأكد من صحة عنوان URL لقرص الشبكة المستهدف وتحديث الإصدار الأحدث.",
    "explorer.shareOut.errorTitle"   => "خطأ في مشاركة المفصل الخارجي",
    "explorer.shareOut.errorDisableShare" => "تم إغلاق وظيفة مشاركة الروابط الخارجية، يرجى الاتصال بالمسؤول!",
    "explorer.shareOut.errorDisableSend" => "مشاركة الروابط الخارجية-وظيفة المشاركة المشتركة الخارجية غير مفعلة!",
    "explorer.shareOut.errorDisableReceive" => "مشاركة الروابط الخارجية-وظيفة المشاركة المشتركة الخارجية غير مفعلة!",
    "explorer.shareOut.errorApiKey"  => "مفتاح API الخاص بالموقع غير صحيح، يرجى إعادة الإدخال!",
    "explorer.shareOut.errorTarget"  => "الهدف غير موجود. يُرجى التأكيد والمحاولة مجددًا!",
    "explorer.shareOut.errorCallLimit" => "الطلب متكرر جدًا، يرجى المحاولة مرة أخرى لاحقًا!",
    "explorer.shareOut.errorShareNotExist" => "المشاركة غير موجودة أو تمت إزالة المشاركة الخارجية",
    "explorer.shareOut.errorShareAuth" => "ليس لديك إذن بالوصول إلى هذه المشاركة الخارجية! يُرجى التواصل مع مسؤول الموقع الذي صدرت منه المشاركة.",
    ...
    "explorer.auth.tabParentTips"    => "المستخدم أو القسم الذي لديه أذونات لهذا المجلد (موروث من جميع الأذونات ذات المستوى الأعلى)",
    ...
    "explorer.rename.title"          => "يمكنك الإضافة عدة مرات، والسحب والإسقاط (إلغاء البيانات المكررة تلقائيًا)، واختيار طريقة تسمية لمعالجة الدفعات السريعة.",
    ...
    "explorer.rename.typeReplaceReg" => "استبدال منتظم",
    ...
    "explorer.rename.allowExt"       => "ما إذا كان سيتم استبدال الامتداد",
    ...
    "explorer.tag.default2"          => "معلومات العمل",
    "explorer.tag.default3"          => "البيانات الشخصية",
    ...
    "explorer.secret.setUserDesc"    => "حدد المستخدم الذي يمكنه تعيين مستوى السرية (يوصى بأن يكون مالك القسم المعني)",
    ...
    "explorer.secret.tips1"          => "يمكن فقط تعيين المحتوى الموجود في قرص شبكة القسم بواسطة المستخدمين المعينين المذكورين أعلاه (يوصى بأن يكونوا مالك المجلد)",
    ...
    "user.registNotAllow"            => "النظام غير مفتوح للتسجيل، يرجى التواصل مع المشرف!",
    "user.deregistNotAllow"          => "لم يُفعّل النظام التسجيل ولا يدعم تسجيل الخروج. يُرجى التواصل مع المسؤول!",
    ...
    "log-event-history-remove"       => "تم حذف النسخة التاريخية [2] من [1]",
    "log-event-history-rollback"     => "قم بتعيين الإصدار التاريخي [2] من [1] كإصدار حالي",
    "log-event-history-clear"        => "تمت إزالة جميع الإصدارات التاريخية من [1]",
